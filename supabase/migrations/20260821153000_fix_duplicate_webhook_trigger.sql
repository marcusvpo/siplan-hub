-- Migration: Remover disparo duplicado de webhook na RPC register_knowledge_version
-- O webhook agora é disparado unicamente pelo Database Webhook Trigger (n8n_openai_vector_webhook_trigger)
...
BEGIN
  ...
  -- Inserir registro de versão (isso dispara automaticamente o trigger n8n_openai_vector_webhook_trigger UMA ÚNICA VEZ)
