...
function SuggestionDialog({ id, onClose, returnFocus }: { id: string; onClose: () => void; returnFocus: { current: HTMLButtonElement | null } }) {
  ...
  return createPortal(<div className="orion-blog-module"><dialog id={id} ref={dialog} className="suggestion-dialog" aria-labelledby={title} aria-describedby={success ? undefined : help}
