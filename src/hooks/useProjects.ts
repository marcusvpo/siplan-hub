    ...
    queryFn: async () => {
      ...
      return data.map((proj: Record<string, any>) => {
        ...
        const tempProject: ProjectV2 = {
          ...
          // Integração 0800
          TituloChamado: proj.TituloChamado as string | undefined,
          descricaotramite: proj.descricaotramite as string | undefined,
          ResponsavelAtividade: proj.ResponsavelAtividade as string | undefined,
          EtapasProjeto: proj.EtapasProjeto as string | undefined,
          healthScore: "ok",
