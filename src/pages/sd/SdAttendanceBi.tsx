      ...
      {query.isLoading ? (
        ...
        <>
          <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
            ...
            <MetricCard label="Média por lançamento" value={formatMinutes(metrics.average_entry_minutes)} detail={`${importedShare}% vindo do 0800`} icon={<Activity />} />
            <MetricCard label="Cobertura de categoria" value={`${classificationCoverage}%`} detail="chamados com natureza identificada" icon={<Bug />} />
          </div>
          ...
          <div className="grid gap-2 lg:grid-cols-3">
            <ChartCard title="Distribuição por produto" subtitle="Participação no total de horas" compact>
              <ResponsiveContainer width="100%" height="100%" minWidth={0}>
                <PieChart>
                  <Pie data={productChart} dataKey="value" nameKey="name" cx="50%" cy="46%" innerRadius={44} outerRadius={72} paddingAngle={2}>
