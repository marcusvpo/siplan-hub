    ...
    <div className="h-[100dvh] flex flex-col bg-slate-100/70 dark:bg-neutral-950 text-foreground font-sans overflow-hidden">
      ...
      <header className="sticky top-0 z-40 w-full border-b bg-white/95 dark:bg-neutral-900/95 backdrop-blur-md shadow-xs shrink-0">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 py-2.5 flex items-center justify-between gap-3">
          {/* Left: Sidebar Toggle + Avatar + Title + Cartório */}
          <div className="flex items-center gap-2.5 min-w-0">
            ...
            <Button
              ...
              className="hidden md:flex h-8 w-8 rounded-lg text-muted-foreground hover:text-foreground shrink-0"
              title={sidebarOpen ? "Ocultar histórico" : "Exibir histórico de conversas"}
            >
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="flex-1 flex flex-col h-full overflow-hidden bg-slate-100/50 dark:bg-neutral-950/50">
          <main className="flex-1 overflow-y-auto p-3 sm:p-4 flex flex-col justify-between max-w-4xl w-full mx-auto">
            {/* Messages List Area */}
            <div className="space-y-4 mb-4">
              {/* Welcome Screen when 0 messages in current session */}
              {messages.length === 0 && !isLoadingHistory && (
                <div className="py-6 sm:py-10 space-y-6 animate-in fade-in-50 duration-300">
                  <div className="text-center space-y-3">
                    <div className="relative mx-auto inline-block">
                      <div className="h-16 w-16 rounded-3xl bg-gradient-to-tr from-rose-600 via-rose-500 to-rose-400 flex items-center justify-center text-white shadow-xl shadow-rose-600/25">
                        <Bot className="h-8 w-8" />
                      </div>
                      <span className="absolute bottom-0 right-0 h-4 w-4 rounded-full bg-emerald-500 border-2 border-white dark:border-neutral-900 shadow-sm" />
                    </div>

                    <h1 className="text-lg sm:text-2xl font-bold text-slate-900 dark:text-slate-50 tracking-tight">
                      Especialista Virtual · Orion TN
                    </h1>

                    {/* Humanized, friendly welcome message with "cartório" */}
                    <div className="p-4 rounded-2xl bg-white dark:bg-neutral-900 border border-rose-100 dark:border-rose-950/60 shadow-xs max-w-xl mx-auto text-left">
                      <p className="text-xs sm:text-sm text-foreground leading-relaxed">
                        Olá! 👋 Que bom ter você por aqui. Eu sou o seu especialista virtual da <strong>Siplan</strong> para o pós-implantação.
                      </p>
                      <p className="text-xs sm:text-sm text-foreground leading-relaxed mt-2">
                        Estou à disposição para tirar qualquer dúvida, te guiar no passo a passo das rotinas, geração de atos e navegação do sistema <strong>Orion TN</strong> no cartório <strong>{projectInfo.client_name}</strong>.
                      </p>
                      <p className="text-xs sm:text-sm text-rose-600 dark:text-rose-400 font-semibold mt-2">
                  ...
                  <div className="space-y-2">
                    <p className="text-[11px] font-semibold text-muted-foreground uppercase tracking-wider text-center">
                      Perguntas frequentes e sugestões rápidas
                    </p>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                      {QUICK_PROMPTS.map((q) => (
                        <button
                          ...
                          className="p-3.5 rounded-2xl border border-slate-200/90 dark:border-neutral-800 bg-white dark:bg-neutral-900 hover:border-rose-400 dark:hover:border-rose-700 hover:bg-rose-50/50 dark:hover:bg-rose-950/20 text-left transition-all group shadow-xs hover:shadow-md cursor-pointer"
                        >
                          <div className="flex items-center gap-2">
                            <span className="flex h-6 w-6 rounded-lg bg-rose-100 dark:bg-rose-950/60 text-rose-600 dark:text-rose-400 items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
            ...
            <div className="sticky bottom-0 z-20 bg-white/95 dark:bg-neutral-900/95 backdrop-blur-md rounded-2xl border border-slate-200 dark:border-neutral-800 shadow-lg p-2.5 transition-all mt-auto">
