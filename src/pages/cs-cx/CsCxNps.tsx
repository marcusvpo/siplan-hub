...
import { Frown, Meh, Pencil, Plus, RefreshCw, Search, Smile, Star, Trash2, TriangleAlert, Upload } from "lucide-react";
...
export default function CsCxNps() {
  ...
  async function handleImport() {
    ...
    try {
      const parsed = parseNpsCsv(await importFile.text(), office.name);
