...
import { CalendarDays, ChevronLeft, ChevronRight, Contact, Database, MoreHorizontal, Pencil, Plus, RefreshCw, Search, Trash2, TriangleAlert } from "lucide-react";
...
export default function CsCxContacts() {
  ...
  return <div className="container mx-auto max-w-[1600px] space-y-4 px-4 py-4 lg:px-6">
    ...
    <Card><CardContent className="space-y-3 p-3">
      <div className="grid gap-2 lg:grid-cols-[minmax(260px,1fr)_210px_180px_145px_145px]">
