                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                    {filteredItems.map((item, index) => {
                        ...
                        return (
                            ...
                            >
                                <Card
                                    className="cursor-pointer overflow-hidden border border-border/60 dark:border-white/5 transition-all duration-300 hover:scale-[1.02] hover:border-primary/50 hover:shadow-xl hover:shadow-black/10 dark:hover:shadow-white/10 group bg-card/60 backdrop-blur-sm shadow-sm h-full"
