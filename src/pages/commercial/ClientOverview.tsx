      ...
      <Card className="max-w-md w-full">
        <CardContent className="pt-6 text-center space-y-4">
          ...
          <p className="text-muted-foreground">
            ...
            tabelas <code className="bg-muted px-1 rounded">clients</code>, 
            <code className="bg-muted px-1 rounded">client_contacts</code> e 
            <code className="bg-muted px-1 rounded">commercial_notes</code> no banco de dados.
          </p>
