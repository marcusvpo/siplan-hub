    ...
    <div className="flex flex-col items-center justify-center min-h-[60vh] space-y-6 animate-in fade-in duration-500">
      <Card className="max-w-md w-full">
        <CardContent className="pt-6 text-center space-y-4">
          ...
          <h1 className="text-2xl font-bold">Contatos & Clientes</h1>
          
          <p className="text-muted-foreground">
            Esta funcionalidade está em desenvolvimento e requer a criação das 
            tabelas <code className="bg-muted px-1 rounded">clients</code> e 
            <code className="bg-muted px-1 rounded">client_contacts</code> no banco de dados.
          </p>
