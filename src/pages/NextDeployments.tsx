  ...
  return (
    <div className="space-y-5 pb-10">
      ...
      <motion.div
        ...
        className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 pb-3 border-b border-slate-200 dark:border-slate-800"
      >
        ...
        <div className="px-3 py-1 bg-white dark:bg-slate-900 rounded-full border border-slate-200 dark:border-slate-800 shadow-sm text-xs font-semibold text-slate-600 dark:text-slate-300">
      ...
      >
        ...
        <div className="flex items-center gap-1.5">
          ...
          <Select value={filterDeployer} onValueChange={setFilterDeployer}>
            ...
            <SelectContent>
              <SelectItem value="all" className="text-xs">Todos os Implantadores</SelectItem>
