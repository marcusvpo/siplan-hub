...
export const PERMISSION_RESOURCES: PermissionResourceDef[] = [
  ...
  { resource: "reports", label: "Relatórios", category: "Relatórios & Arquivos", actions: ["view", "export"] },
  ...
  { resource: "calendar_projects", label: "Calendário de Projetos", category: "Calendário", actions: ["view", "edit"] },
  { resource: "calendar_analysts", label: "Agenda dos Analistas", category: "Calendário", actions: ["view", "edit"] },

  // Comercial
  { resource: "menu_comercial", label: "Menu Comercial", category: "Comercial", actions: ["view"] },
  { resource: "commercial_customers", label: "Painel de Clientes", category: "Comercial", actions: ["view", "edit"] },
  { resource: "commercial_blockers", label: "Bloqueios", category: "Comercial", actions: ["view", "create", "edit", "delete"] },
  { resource: "commercial_contacts", label: "Contatos", category: "Comercial", actions: ["view", "create", "edit", "delete"] },
  { resource: "commercial_deployment_forms", label: "Form. Nova Implantação", category: "Comercial", actions: ["view", "create", "edit"] },
  { resource: "commercial_checklists", label: "Checklist do Cliente", category: "Comercial", actions: ["view", "edit"] },
  ...
  { resource: "conversion_home", label: "Gestão de Atividades", category: "Conversão", actions: ["view", "edit"] },
  { resource: "conversion_engines", label: "Motores de Conversão", category: "Conversão", actions: ["view", "manage"] },
  ...
  { resource: "implantadores_aderencia_finalizadas", label: "Aderências Finalizadas", category: "Implantadores", actions: ["view"] },
  ...
  { resource: "implantadores_transicao", label: "Documento de Transição", category: "Implantadores", actions: ["view", "edit"] },
  ...
  { resource: "orion_export", label: "Orion - Exportação XML", category: "Modelos Editor OrionTN", actions: ["execute"] },
  ...
  { resource: "users", label: "Admin - Usuários", category: "Administração", actions: ["view", "manage"] },
  { resource: "teams", label: "Admin - Configurações do Time", category: "Administração", actions: ["view", "manage"] },
  { resource: "roles", label: "Admin - Perfis de Acesso", category: "Administração", actions: ["view", "manage"] },
  { resource: "vacations", label: "Admin - Férias", category: "Administração", actions: ["view", "manage"] },
  { resource: "settings", label: "Admin - Saúde dos Projetos", category: "Administração", actions: ["view", "manage"] },
  { resource: "storage", label: "Admin - Armazenamento", category: "Administração", actions: ["view", "manage"] },
  { resource: "inactive_users", label: "Admin - Usuários Inativos", category: "Administração", actions: ["view", "manage"] },
  { resource: "audit_logs", label: "Admin - Logs de Auditoria", category: "Administração", actions: ["view", "export"] },
];
