...
const PRESETS = [
  {
    ...
    order: ["priorities", "agenda", "board", "insights", "projects", "conversion", "shortcuts", "copilot"] as MyDayWidgetId[],
    layout: { priorities: "full", agenda: "half", board: "full", insights: "half", projects: "full" } as Partial<MyDayPreferences["widgetLayout"]>,
  },
  {
    id: "manager",
    label: "Gestão",
    ...
    order: ["priorities", "insights", "projects", "agenda", "board", "conversion", "copilot", "shortcuts"] as MyDayWidgetId[],
  ...
  },
  {
    ...
    icon: CalendarRange,
    order: ["agenda", "priorities", "board", "shortcuts", "projects", "insights", "conversion", "copilot"] as MyDayWidgetId[],
    layout: { agenda: "full", priorities: "full", shortcuts: "full" } as Partial<MyDayPreferences["widgetLayout"]>,
  },
  {
    id: "kanban",
    label: "Foco no quadro",
    description: "Kanban e agenda primeiro",
    icon: Columns3,
    order: ["board", "agenda", "priorities", "shortcuts", "projects", "insights", "conversion", "copilot"] as MyDayWidgetId[],
    layout: { board: "full", agenda: "half", priorities: "half" } as Partial<MyDayPreferences["widgetLayout"]>,
  },
] as const;
