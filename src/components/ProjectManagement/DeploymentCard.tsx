...
export function DeploymentCard({
  ...
  return (
    <motion.div
      ...
      className={`group relative w-full min-h-[250px] rounded-2xl border shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden flex flex-col ${
        isInProgress
    ...
    >
          ...
          <div className="flex flex-col items-start gap-1.5">
            ...
            <div className="flex flex-wrap items-center gap-1.5">
              {isInProgress ? (
                ...
                <Badge
                  className="bg-slate-800 dark:bg-slate-700 text-white dark:text-slate-100 border border-slate-700 dark:border-slate-600 text-[10px] font-extrabold uppercase tracking-wider px-2 py-0.5 shadow-sm flex items-center gap-1"
                >
      ...
      <div className="px-4 space-y-2 z-10 flex-1">
        ...
        <div className="pt-2 border-t border-slate-100 dark:border-slate-800/80 flex items-center gap-2.5">
          ...
          <div className="min-w-0 flex-1">
            ...
            <span className="text-xs font-bold text-slate-900 dark:text-white truncate block" title={responsibleName}>
              {responsibleName}
            </span>
          </div>
        </div>
      ...
      <div className="mt-auto relative">
        ...
        <div className="px-4 py-2.5 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between z-10 relative bg-white/50 dark:bg-slate-900/50 backdrop-blur-sm">
