                ...
                <Table>
                  <TableHeader className="bg-muted/30 sticky top-0 z-10">
                    <TableRow className="hover:bg-transparent">
                      <TableHead className="w-[280px] text-[10px] uppercase font-black tracking-widest text-muted-foreground/70">Cliente</TableHead>
                      ...
                      <TableHead className="text-[10px] uppercase font-black tracking-widest text-muted-foreground/70 text-center">Última Atualização (UAT)</TableHead>
