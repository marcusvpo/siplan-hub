    ...
    return (
      <Dialog open onOpenChange={(o) => !o && cancelRecording()}>
        ...
        >
          ...
          <div
            ref={captionRef}
            className="min-h-[24rem] max-h-[65vh] overflow-y-auto rounded-md border border-neutral-200 dark:border-neutral-800 bg-neutral-50 dark:bg-neutral-950/40 p-5 text-lg leading-relaxed whitespace-pre-wrap"
          >
            {liveText ? (
              <>
                {liveText}
