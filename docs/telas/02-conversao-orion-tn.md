...
- **Gerar em lote:** cada cabeçalho de categoria (coluna enviados) tem **"Gerar todos"** (`handleGenerateCategory`), que enfileira de uma vez todos os arquivos da categoria sem job ativo (enfileiramento silencioso + 1 toast-resumo).
