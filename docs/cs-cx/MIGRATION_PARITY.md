...
| NPS | respostas, importação, classificação, estatísticas, histórico, reatribuição, questionários, links públicos, webhook, exclusão e PDF | em migração; fluxo legado preservado e formulário nativo implementado com editor de questionários, convite individual de uso único, validade, cancelamento, snapshot, resposta sem login e gravação automática; homologação humana pendente |
