...
## Corpus Check
- 890 files · ~1,020,657 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5750 nodes · 12943 edges · 398 communities (302 shown, 96 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 177 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0f4922b5`
...
## Communities (398 total, 96 thin omitted)
...
Cohesion: 0.14
Nodes (19): getEditorContent(), ObservationsWithAI(), ObservationsWithAIProps, obsTextLen(), walkText(), ImplementationPhaseForm(), fmt(), getSpeechRecognition() (+11 more)
...
Cohesion: 0.09
Nodes (28): TimeEntryDialogProps, DropdownMenuCheckboxItem, useDebounce(), db, normalizeEntry(), SaveSdTimeEntryInput, SdTimeBulkImportRequestRow, SdTimeBulkImportResult (+20 more)

### Community 7 - "Project Stage Forms & Models"
Cohesion: 0.10
Nodes (30): AiRichTextField(), AiRichTextFieldProps, messageOf(), RichTextEditor(), RichTextEditorProps, AiTextImprovementJob, mapJob(), useAiTextImprovement() (+22 more)
...
Cohesion: 0.08
Nodes (48): dateFormatter, formatLastActivity(), integerFormatter, PosAiVisitorAnalytics(), PosAiVisitorAnalyticsProps, usdFormatter, MarkdownTiptapEditor(), EditableCell() (+40 more)
...
Cohesion: 0.12
Nodes (21): data, OverviewChart(), ProjectStatusChart(), formatAction(), RecentActivity(), Chamado0800TabProps, Avatar, AvatarFallback (+13 more)

### Community 18 - "App Sidebar & Protected Route"
Cohesion: 0.11
Nodes (27): NOTIFICATION_TYPE_ICONS, NotificationBell(), FeedbackPromptModal(), FeedbackPromptModalProps, PosChatHistorySidebar(), PosChatMessageContent(), PosChatThemeMenu(), PosChatVisitorDialog() (+19 more)
...
Cohesion: 0.07
Nodes (51): NpsQuestionnairesPanel(), NpsThemePreview(), QUESTION_TYPES, questionTypeLabel(), RadioGroup, RadioGroupItem, CreateNpsInvitationInput, currentUser() (+43 more)
...
Cohesion: 0.11
Nodes (23): DashboardTable(), DashboardTableProps, HealthBadge(), HealthBadgeProps, PipelineStatus(), PipelineStatusProps, ProjectDetailsModal(), ButtonProps (+15 more)

### Community 26 - "Project Transformers & Stages"
Cohesion: 0.17
Nodes (21): ArticleNavigator(), ArticleNavigatorProps, BunnyVideoModalProps, CreateRoutineModalProps, RestoreVersionModal(), RestoreVersionModalProps, SavePublishModal(), SavePublishModalProps (+13 more)

### Community 27 - "use-toast Reducer"
Cohesion: 0.08
Nodes (31): ProjectDetailsModalProps, WorkloadChartProps, DeploymentDetailsDialogProps, ProjectHeaderFormProps, PosAiAssistantSectionProps, ProjectCardV3(), ProjectCardV3Props, ProjectModalProps (+23 more)

### Community 28 - "Project Modal & Kanban"
Cohesion: 0.11
Nodes (22): CS_CX_REQUEST_STATUSES, CsCxOfficeProduct, CsCxOfficeResponsible, CsCxProductResponsible, CsCxRequestInput, CsCxRequestStatus, CsCxRequestStatusConfig, CsCxRequestStatusHistoryEntry (+14 more)
...
Cohesion: 0.10
Nodes (23): AutocompleteInput(), mapJob(), useDtcAiJobs(), useTeamMembers(), useTimeline(), TeamManagement(), ALL_SYSTEMS, DTCData (+15 more)

### Community 35 - "Post Observations Editor"
Cohesion: 0.06
Nodes (54): RequirePermission(), RequirePermissionProps, AppSidebar(), UserProfileDrawer(), ModeToggle(), formatStepTime(), ModelosEditorWorkspace(), ModelosMetrics() (+46 more)
...
Cohesion: 0.06
Nodes (61): EnvironmentScreenshotsProps, StageCardProps, AdherenceStageFormProps, EnvironmentStageFormProps, ImplementationStageFormProps, PhaseFormProps, InfraStageFormProps, ModelosEditorWorkspaceProps (+53 more)
...
Cohesion: 0.07
Nodes (35): CompactQueueCard(), CompactQueueCardProps, STATUS_COLORS, STATUS_LABELS, ConversionPostDrawer(), ConversionPostFeed(), ConversionPostFeedProps, formatPostDate() (+27 more)
...
Cohesion: 0.08
Nodes (40): err(), CustomImageUploadWidget(), normalizeChamadoStatus(), STATUS_BY_KEY, assertProcessoVendaRunActive(), cancelActiveRequestWhenSuperseded(), cancelProcessoVendaRun(), claimProcessoVendaRequest() (+32 more)
...
Cohesion: 0.08
Nodes (31): AdherenceQuestionField(), AdherenceQuestionValue, ArrayFieldTemplateItem, checkHasAdherenceQuestions(), CustomArrayFieldTemplate(), CustomCheckboxWidget(), customFields, CustomFieldTemplate() (+23 more)
...
Cohesion: 0.07
Nodes (29): ChartEmptyState(), ChartEmptyStateProps, DashboardKPI(), DashboardKPIProps, DashboardReport(), DashboardReportProps, KPICard(), ProjectDistributionChart() (+21 more)
...
Cohesion: 0.11
Nodes (22): NewProjectDialog(), DeploymentDetailsDialog(), ProjectModal(), ProjectTagsLegendDialog(), Progress, ScrollArea, usePermissions(), useProjectsV2() (+14 more)
...
Cohesion: 0.18
Nodes (21): emptyInterval(), TimeEntryDialog(), useDeleteSdTimeEntry(), useMySdTimeEntries(), useSaveSdTimeEntry(), entryMinutes(), entryStartMinutes(), formatMinutes() (+13 more)
...
### Community 184 - "Login"
Cohesion: 0.20
Nodes (18): SearchableClientOption, SearchableClientSelectProps, CsCxMultiSelect(), CsCxMultiSelectOption, CsCxMultiSelectProps, OfficeFilterCombobox(), AutocompleteInputProps, Command (+10 more)
...
Cohesion: 0.08
Nodes (28): Action, ActionType, actionTypes, addToRemoveQueue(), dispatch(), genId(), listeners, memoryState (+20 more)
...
Cohesion: 0.19
Nodes (12): groupByOffice(), buildCsCxRegistryOfficesReport(), localIsoDate(), printCsCxRegistryOfficesReport(), CsCxRegistryOffices(), DataError(), errorMessage(), formatDate() (+4 more)
...
Cohesion: 0.08
Nodes (30): ACTION_ORDER, CsCxAccessPanel(), MenuItem, menuItems, ACTION_LABELS, getActionLabel(), getResourceCategory(), getResourceLabel() (+22 more)
...
Cohesion: 0.12
Nodes (20): CsCxOfficeRoutine, ActionBadge(), actionLabel(), CsCxOfficeRoutineSummary, CsCxRoutines(), formatDate(), formatDateTime(), getRoutineProductOptions() (+12 more)
...
Cohesion: 0.36
Nodes (7): StageCard(), EnvironmentStageForm(), text(), check(), generateDeploymentTemplate(), v(), yn()
...
Cohesion: 0.08
Nodes (41): ConversionIssuesTab(), ConversionIssuesTabProps, PRIORITIES, STATUSES, AdvancedFilters(), AdvancedFiltersProps, DeploymentCard(), DeploymentCardProps (+33 more)
...
Cohesion: 0.40
Nodes (5): react, AdherenceImpactSummary(), getImpactedItems(), ImplementerSelector(), ProjectSelector()
...
Cohesion: 0.27
Nodes (8): CsCxRoutineModel, decodeRoutineObservations(), encodeRoutineObservations(), formatRoutineObservations(), normalizeRoutineObservations(), formatObservationHistory(), models, routines
...
Cohesion: 0.15
Nodes (23): ArticleMetadataCard(), ArticleMetadataCardProps, BunnyVideoModal(), UnsavedChangesDialog(), UnsavedChangesDialogProps, CollapsibleFieldSection(), CollapsibleFieldSectionProps, EnvironmentScreenshots() (+15 more)

### Community 351 - "ImplementerCharts.tsx"
Cohesion: 0.14
Nodes (23): jspdf, TicketsAiAnalysisProps, TicketsSlaAnalysisProps, TicketsSlaSectorAnalysisProps, Chamado0800DetailDialogProps, ChamadosSearchFilters, ChamadosCatalog, getChamadosProductLabel() (+15 more)
...
Cohesion: 0.11
Nodes (36): StatusFilter, ConversionPostDrawerProps, STATUS_LABELS, EMPTY_PROFILE, UserProfileDrawerProps, CustomTheme, RoadmapManager(), RoadmapManagerProps (+28 more)

### Community 356 - "4. Homologação de Conversões"
Cohesion: 0.05
Nodes (32): copyText(), formatDate(), NpsInvitationsPanel(), Chamado0800Tab(), EditProjectTab(), FilesTab(), LogsTab(), Skeleton() (+24 more)

### Community 359 - "cs-cx-routines-report.test.ts"
Cohesion: 0.23
Nodes (12): CsCxAppointment, decodeAppointmentObservations(), encodeAppointmentObservations(), formatAppointmentObservations(), normalizeAppointmentObservations(), APPOINTMENT_STATUS_LABELS, APPOINTMENT_TYPE_LABELS, formatDate() (+4 more)
...
Cohesion: 0.08
Nodes (29): BunnyVideoPlayer(), BunnyVideoPlayerProps, formatBunnyEmbedUrl(), PosChatHistorySidebarProps, Block, extractBunnyVideoFromLine(), isBunnyStreamUrl(), parseBlocks() (+21 more)
...
Cohesion: 0.07
Nodes (41): ProjectStatusChartProps, STATUS_LABELS, AdminSettings(), STAGE_LABELS, KPICardProps, AdherenceGapCard(), AdherenceGapCardProps, HealthDistribution() (+33 more)
...
Cohesion: 0.08
Nodes (41): PosAiChatLinksManager(), PosAiChatLinksManagerProps, initials(), PAGE_SIZE_OPTIONS, PosAiChatUsersManager(), PosAiChatUsersManagerProps, VisitorActionResult, SearchableClientSelect() (+33 more)
...
## Knowledge Gaps
- **2668 isolated node(s):** `{ chromium, firefox, webkit }`, `name`, `version`, `description`, `author` (+2663 more)
...
- **Why does `err()` connect `chamadosSync.ts` to `Conversion Post Feed & Drawer`, `Main Layout & Theme Toggle`, `Post Observations Editor`, `DeploymentFormFields.tsx`, `index.ts`, `VM Worker Job Queue`, `Theme Provider`, `LogsTab.tsx`, `GEMINI.md`, `Adherence Form Renderer`, `useTeams.ts`, `processJob.ts`, `Improve-Text AI Jobs`, `App Sidebar & Protected Route`, `Página 404 (Not Found)`, `ProjectCardV3.tsx`, `package.json`, `pos-chat-visitor-dialog.test.tsx`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `cn()` connect `usePublicChecklist.ts` to `Conversion Post Feed & Drawer`, `FormRenderer.tsx`, `Project Stage Forms & Models`, `Calendar Grid & Drag-Drop`, `GEMINI.md`, `Adherence Form Renderer`, `Sidebar Components`, `Dashboard Table & Pagination`, `StageStatus`, `App Sidebar & Protected Route`, `useAuth`, `ImplementerPhaseMetrics.tsx`, `Deployment Form Fields`, `Project Transformers & Stages`, `use-toast Reducer`, `Main Layout & Theme Toggle`, `5. Contatos & Clientes`, `Post Observations Editor`, `Theme Provider`, `LogsTab.tsx`, `chamadosSync.ts`, `Página 404 (Not Found)`, `Toggle Component`, `Agenda dos Analistas`, `Calendário (Planejamento Visual)`, `AuthContext.tsx`, `Login`, `CopilotChat.tsx`, `ImplementerReportTab.tsx`, `DeploymentFormFields.tsx`, `useCsCxNpsSurveys.ts`, `RolesManagement.tsx`, `sheet.tsx`, `PostObservations`, `formatLogDetails`, `usePosPanorama.ts`, `AdminSettings.tsx`, `CsCxReports`, `4. Homologação de Conversões`, `🗄️ Configuração Local do Supabase (Ambiente de Desenvolvimento)`, `useCsCxAccess.ts`, `Página 404 (Not Found)`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `dependencies` connect `Auth Context` to `PostObservations`, `usePosAiAdminAnalytics.ts`, `Próximas Implantações`, `sonner.tsx`, `cs-cx-engagement-permissions.test.tsx`, `ImplementerCharts.tsx`?**
