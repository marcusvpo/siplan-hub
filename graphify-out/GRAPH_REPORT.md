...
Cohesion: 0.14
Nodes (17): clamp(), FloatingCopilot(), maxWidth(), ArticleMetadataCard(), ArticleNavigator(), SavePublishModal(), UnsavedChangesDialog(), VersionHistoryDrawer() (+9 more)
...
Cohesion: 0.08
Nodes (27): RequirePermission(), RequirePermissionProps, ACTION_ORDER, CsCxAccessPanel(), ContextualHeaderAction, getContextualHeaderAction(), matchesPath(), MenuItem (+19 more)
...
Cohesion: 0.19
Nodes (10): formatAction(), RecentActivity(), useAdminStats(), useStorageStats(), useAuditLogs(), AdminDashboard(), SystemStorage(), AdminStats (+2 more)
...
Cohesion: 0.06
Nodes (31): Breadcrumbs(), FloatingCopilot, MainLayout(), MainLayoutProps, NotificationBell(), Sidebar, SidebarContent, SidebarContext (+23 more)
...
Cohesion: 0.08
Nodes (33): AttentionRow, ContactAttentionDashboardProps, CS_CX_REQUEST_STATUSES, CsCxOfficeProduct, CsCxOfficeResponsible, CsCxProductResponsible, CsCxRegistryOffice, CsCxRequest (+25 more)
...
Cohesion: 0.07
Nodes (40): SummaryCard(), DashboardTableProps, HealthBadge(), HealthBadgeProps, KPICard(), KPICardProps, PipelineStatus(), PipelineStatusProps (+32 more)
...
Cohesion: 0.10
Nodes (23): NOTIFICATION_TYPE_ICONS, PosSaudeBadge(), RoadmapManager(), Chamado0800Tab(), LogsTab(), Badge(), BadgeProps, badgeVariants (+15 more)
...
Cohesion: 0.09
Nodes (31): data, OverviewChart(), ProjectStatusChart(), ProjectStatusChartProps, STATUS_LABELS, STAGE_LABELS, RestoreVersionModal(), VersionDetailModal() (+23 more)

### Community 27 - "Deployment Form Fields"
Cohesion: 0.14
Nodes (11): DeploymentFormFields(), formatPhone(), Props, DeploymentFormRecord, checklists, forms, {
...
Cohesion: 0.04
Nodes (48): CriticalAlertsProps, ProjectDetailsModalProps, DeploymentCard(), DeploymentCardProps, DeploymentDetailsDialog(), DeploymentDetailsDialogProps, project, ProjectHeaderForm() (+40 more)
...
Cohesion: 0.07
Nodes (53): AdherenceStageFormProps, EnvironmentStageFormProps, InfraStageFormProps, ProjectRow, ConversionEngineRow, Json, Tables, TablesInsert (+45 more)

### Community 38 - "ai Routine Generator Service"
Cohesion: 0.06
Nodes (53): PAGE_SIZE_OPTIONS, STAGE_OPTIONS, EMPTY_PROFILE, BunnyVideoModal(), UnsavedChangesDialogProps, EditableCellProps, StatusType, ReportsFiltersProps (+45 more)
...
Cohesion: 0.15
Nodes (16): ArticleMetadataCardProps, ArticleNavigatorProps, BunnyVideoModalProps, CreateRoutineModalProps, RestoreVersionModalProps, SavePublishModalProps, VersionDetailModalProps, VersionHistoryDrawerProps (+8 more)

### Community 41 - "Implementer Phase1 Fichas"
Cohesion: 0.06
Nodes (50): react, CustomImageUploadWidget(), AppSidebar(), UserProfileDrawer(), ModeToggle(), FilesTab(), GeneralInfoTab(), ProtectedRoute() (+42 more)

### Community 42 - "Project Modal"
Cohesion: 0.05
Nodes (33): convertVisualToUISchema(), VisualQuestionBuilder(), VisualQuestionBuilderProps, Switch, Action, ActionType, actionTypes, listeners (+25 more)
...
Cohesion: 0.23
Nodes (15): SearchableClientOption, SearchableClientSelectProps, CsCxMultiSelectOption, CsCxMultiSelectProps, ProjectSelectorProps, Command, CommandDialogProps, CommandEmpty (+7 more)

### Community 46 - "pos chat history sidebar.test"
Cohesion: 0.10
Nodes (37): Chamado0800DetailDialog(), fmtDateBr(), fmtDateTimeBr(), formatTicketDuration(), statusBadgeClass(), PostChamados0800(), PostChamados0800Props, PosAiAssistantSection() (+29 more)
...
Cohesion: 0.07
Nodes (51): AdminListPager(), AdminListPagerProps, dateFormatter, formatLastActivity(), integerFormatter, PosAiVisitorAnalytics(), usdFormatter, AttentionFilter (+43 more)
...
Cohesion: 0.31
Nodes (13): useKnowledgeBase(), computeTextDiff(), formatBackupFilePath(), deleteArticleFromDocument(), insertNewArticleIntoDocument(), normalizeMarkdown(), parseArticleFrontmatter(), parseMasterDocument() (+5 more)

### Community 68 - "package e relacionados"
Cohesion: 0.06
Nodes (51): emptyInterval(), TimeEntryDialog(), db, EMPTY_BI, normalizeBiData(), SdAttendanceBiBreakdown, SdAttendanceBiData, SdAttendanceBiFilters (+43 more)
...
Cohesion: 0.15
Nodes (11): ConversionEngineItem, CreateConversionEngineInput, EngineKPIs, EngineSpecialty, EngineStatus, UpdateConversionEngineInput, ConversionEngineInsert, ConversionEngineUpdate (+3 more)

### Community 82 - "cs-cx-nps-xlsx.ts"
Cohesion: 0.19
Nodes (10): ImplementerHeaderBanner(), ImplementerKPIs(), ImplementerKPIsProps, ImplementerPDFExport(), ImplementerPDFExportProps, ImplementerPhaseMetrics(), ImplementerReportTab(), ImplementerSignaturesBlock() (+2 more)
...
Cohesion: 0.12
Nodes (27): SolutionDetailsProps, SolutionForm(), SolutionFormProps, formatDate(), HighlightedText(), SolutionCard(), SolutionCardProps, SolutionsSearch() (+19 more)
...
Cohesion: 0.18
Nodes (16): TicketsAiAnalysisProps, TicketsSlaAnalysisProps, TicketsSlaSectorAnalysisProps, Chamado0800DetailDialogProps, ChamadosSearchFilters, ChamadosCatalog, getChamadosProductLabel(), ChamadosReportFilters (+8 more)
...
Cohesion: 0.17
Nodes (14): CopilotChat(), CopilotChatProps, fmtDateTime(), linkifyProjects(), loadSaved(), SUGESTOES, renderInline(), renderLink() (+6 more)
...
Cohesion: 0.06
Nodes (40): ChartEmptyState(), ChartEmptyStateProps, CriticalAlerts(), DashboardKPI(), DashboardKPIProps, DashboardReport(), DashboardReportProps, DashboardTable() (+32 more)
...
Cohesion: 0.13
Nodes (18): CompactQueueCard(), CompactQueueCardProps, STATUS_COLORS, STATUS_LABELS, ConversionPostDrawer(), NewPostForm(), ProjectInfo, ProjectInfoSection() (+10 more)

### Community 109 - "sidebar-empty-groups.test.tsx"
Cohesion: 0.11
Nodes (19): NewProjectDialog(), AdvancedFilters(), ProjectGrid(), ProjectTagsLegendDialog(), useProjectsList(), userProjectsListTransform(), normalizeText(), Analytics() (+11 more)
...
Cohesion: 0.33
Nodes (5): lifecycleMigration, migration, root, specialtyMigration, types
...
Cohesion: 0.08
Nodes (35): ProjectModal(), AlertTitle, AutocompleteInput(), AutocompleteInputProps, fmt(), getSpeechRecognition(), pickMimeType(), VoiceDictationButton() (+27 more)
...
Cohesion: 0.11
Nodes (45): SYSTEM_TYPES, ConversionIssuesTab(), ConversionIssuesTabProps, PRIORITIES, STATUSES, ConversionPostDrawerProps, STATUS_LABELS, MarkdownTiptapEditorProps (+37 more)
...
Cohesion: 0.12
Nodes (26): lexical, AiRichTextField(), messageOf(), RichTextEditor(), RichTextEditorProps, appendPlainTextToLexicalJson(), hasRichTextContent(), LexicalNode (+18 more)
...
Cohesion: 0.07
Nodes (39): CollapsibleFieldSection(), CollapsibleFieldSectionProps, getEditorContent(), ObservationsWithAI(), ObservationsWithAIProps, obsTextLen(), walkText(), StageCard() (+31 more)
...
Cohesion: 0.38
Nodes (6): ImplementerHeaderBannerProps, getInitials(), ImplementerProfileCard(), ImplementerProfileCardProps, ImplementerSelectorProps, ImplementerProfile
...
Cohesion: 0.16
Nodes (14): PosAiChatLinksManager(), PosAiChatLinksManagerProps, StatusFilter, PosAiChatUsersManagerProps, PosAiChatLink, ErrorLike, getErrorMessage(), CHAT_PAGE_SIZE_OPTIONS (+6 more)
...
### Community 178 - "sd-solutions-search.test.tsx"
Cohesion: 0.40
Nodes (4): families, serviceMocks, solutions, systems
...
Cohesion: 0.08
Nodes (47): STATUS_COLORS, TicketsAiAnalysis(), tooltipStyle, truncate(), ChamadoReportRow, createChamadosSearchQuery(), fetchAllChamados(), fetchAllChamadosForReport() (+39 more)
...
Cohesion: 0.12
Nodes (29): errorCode(), FamiliesManager(), DeleteTarget, errorCode(), systemNameCollator, SystemsManager(), createSdFamily(), createSdRoutine() (+21 more)
...
Cohesion: 0.09
Nodes (63): AREA_STAGE_OUTCOME, AreaJourneyRow(), formatDateTime(), matchesSlaCardFilter(), SLA_FILTER_LABELS, SlaCardFilter, SlaCheckpointCell(), TicketSlaRow() (+55 more)
...
- **Why does `text()` connect `useDebounce` to `sd solutions`, `CsCxNpsResponse`, `require-permission.test.tsx`, `Cs Cx Requests`, `Post Observations`, `filter Store`, `process Copilot Job`, `Implementer Phase1 Fichas`, `process Dtc Job`, `run Skill`, `cs cx experience pdf`, `sd-solutions-search.test.tsx`?**
