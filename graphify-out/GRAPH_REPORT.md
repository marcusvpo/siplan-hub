...
## Corpus Check
- 779 files · ~946,457 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4215 nodes · 11585 edges · 269 communities (217 shown, 52 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 126 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4f5edbc2`
...
- Cs Cx Routines
- Conversion Issues Tab
- 06 calendario analytics relatorios
- contextual Header Action
- MODELO DE DADOS
- 05 administracao
- 05 administracao
- sonner e relacionados
- 06 calendario analytics relatorios
- run Skill
- migrate cs cx
- Tickets Sla Info Dialog
...
- README e relacionados
- rls invariants.test
- pagination e relacionados
- Commercial Contacts.mobile.test
- tickets ai analytics
- Sd Attendance Bi
- Conversion Post Feed
- sd attachments
- predictability utils
...
- tickets sla report pdf
- Auth Context Value
- sd solutions
- use Cs Cx Experience
- 06 calendario analytics relatorios
- cs cx routines report
- index e relacionados
- process Copilot Job
- process Dtc Job
- editor e relacionados
- sd e relacionados
- 06 calendario analytics relatorios
...
- select e relacionados
- dialog e relacionados
- MIGRATION PARITY
...
- use Cs Cx Access
- 03 comercial
- Commercial Customers.mobile.test
- 03 comercial
...
Cohesion: 0.10
Nodes (18): ADMIN_SECTIONS, AdminSection, CatalogKind, CsCxAdmin(), DeleteTarget, EMPTY_CATALOG, EMPTY_ITEM, EMPTY_MODEL (+10 more)
...
Cohesion: 0.27
Nodes (10): NOTIFICATION_TYPE_ICONS, NotificationBell(), DropdownMenuContent, DropdownMenuItem, DropdownMenuLabel, DropdownMenuRadioItem, DropdownMenuSeparator, DropdownMenuSubContent (+2 more)
...
Cohesion: 0.09
Nodes (22): DayDroppableZone(), CompactQueueCard(), SummaryCard(), ChartEmptyState(), ChartEmptyStateProps, SortableThumb(), EditableCell(), ModelosMetrics() (+14 more)

### Community 7 - "Visual Question Builder"
Cohesion: 0.11
Nodes (26): ConversionIssuesTab(), ConversionPostDrawer(), ConversionPostDrawerProps, STATUS_LABELS, HealthDistribution(), StatusDistribution(), TabsContent, TabsList (+18 more)

### Community 8 - "use Sd Time Tracking"
Cohesion: 0.14
Nodes (19): VersionHistoryDrawer(), CollapsibleFieldSection(), CollapsibleFieldSectionProps, StageCard(), ConversionStageForm(), EnvironmentStageForm(), ImplementationPhaseForm(), ImplementationStageForm() (+11 more)
...
Cohesion: 0.17
Nodes (23): CalendarControls(), CalendarGrid(), CalendarGridProps, CalendarLegend(), DraggableTeamMember(), DraggableTeamMemberProps, CalendarEventPill(), CalendarEventPillProps (+15 more)
...
Cohesion: 0.09
Nodes (25): AppSidebar(), Sidebar, SidebarContent, SidebarContext, SidebarFooter, SidebarGroup, SidebarGroupAction, SidebarGroupContent (+17 more)
...
Cohesion: 0.09
Nodes (26): useIsMobile(), CsCxRequest, CsCxRequestInput, CsCxRequestStatusConfig, CsCxRequestUpdate, EXECUTION_STATUSES, formatDate(), formatDateTime() (+18 more)
...
Cohesion: 0.05
Nodes (33): CriticalAlertsProps, DashboardReport(), DashboardReportProps, DashboardTableProps, PipelineStatusProps, ProjectDetailsModalProps, ProjectDistributionChartProps, StatusChartProps (+25 more)
...
Cohesion: 0.10
Nodes (27): fmt(), getSpeechRecognition(), pickMimeType(), VoiceDictationButton(), VoiceDictationButtonProps, mapJob(), useDtcAiJobs(), useTimeline() (+19 more)
...
Cohesion: 0.16
Nodes (23): emptyInterval(), TimeEntryDialog(), useDeleteSdTimeEntry(), useImportSdTimeEntries(), useMySdTimeEntries(), useSaveSdTimeEntry(), entryMinutes(), entryStartMinutes() (+15 more)

### Community 26 - "card e relacionados"
Cohesion: 0.10
Nodes (34): ProjectStatusChartProps, STATUS_LABELS, STAGE_LABELS, CriticalAlerts(), KPICardProps, ProjectDistributionChart(), StatusChart(), getProjectTimelineDates() (+26 more)

### Community 27 - "Deployment Form Fields"
Cohesion: 0.11
Nodes (20): DeploymentFormFields(), formatPhone(), Props, UserProfileDrawer(), ProtectedRoute(), useAuth(), DeploymentFormRecord, useDeploymentForms() (+12 more)

### Community 28 - "use Cs Cx Core"
Cohesion: 0.14
Nodes (19): CS_CX_REQUEST_STATUSES, CsCxOfficeProduct, CsCxOfficeResponsible, CsCxProductResponsible, CsCxRequestStatus, CsCxRequestStatusHistoryEntry, CsCxResponsibleProfile, db (+11 more)
...
Cohesion: 0.08
Nodes (34): AdherenceStageFormProps, EnvironmentStageFormProps, InfraStageFormProps, ModelosEditorWorkspaceProps, ProjectRow, AdherenceStageV2, AuditEntry, BlockingReason (+26 more)

### Community 38 - "ai Routine Generator Service"
Cohesion: 0.14
Nodes (23): ArticleMetadataCardProps, BunnyVideoModal(), UnsavedChangesDialogProps, PosChatHistorySidebar(), PosChatHistorySidebarProps, StatusType, AiRichTextFieldProps, AlertDialogAction (+15 more)

### Community 39 - "filter Store"
Cohesion: 0.17
Nodes (12): NewProjectDialog(), AdvancedFilters(), ProjectGrid(), ProjectTagsLegendDialog(), useConversionQueue(), useProjectsList(), userProjectsListTransform(), normalizeText() (+4 more)
...
Cohesion: 0.17
Nodes (16): PosAiChatLinksManager(), PosAiChatLinksManagerProps, initials(), PAGE_SIZE_OPTIONS, PosAiChatUsersManager(), PosAiChatUsersManagerProps, VisitorActionResult, PosAiChatLink (+8 more)

### Community 42 - "Project Modal"
Cohesion: 0.16
Nodes (10): copyText(), formatDate(), NpsInvitationsPanel(), NpsQuestionnairesPanel(), QUESTION_TYPES, questionTypeLabel(), canAccessCsCxRecord(), CsCxOwnedResource (+2 more)
...
Cohesion: 0.24
Nodes (17): SearchableClientOption, SearchableClientSelectProps, CsCxMultiSelectOption, CsCxMultiSelectProps, AutocompleteInput(), AutocompleteInputProps, Command, CommandDialogProps (+9 more)

### Community 46 - "pos chat history sidebar.test"
Cohesion: 0.10
Nodes (35): Bloco, escapeHtml(), MarkdownLite(), markdownLiteToHtml(), parseBlocos(), renderInline(), Chamado0800DetailDialog(), fmtDateBr() (+27 more)

### Community 47 - "Families Manager"
Cohesion: 0.17
Nodes (19): errorCode(), FamiliesManager(), SolutionForm(), SolutionsSearch(), groupSdSolutionsByFamily(), attachmentStorageName(), createSdFamily(), createSdSolution() (+11 more)

### Community 48 - "Cs Cx Appointments"
Cohesion: 0.08
Nodes (45): dateFormatter, formatLastActivity(), integerFormatter, PosAiVisitorAnalytics(), PosAiVisitorAnalyticsProps, usdFormatter, MarkdownTiptapEditor(), EditableCellProps (+37 more)

### Community 58 - "sd time"
Cohesion: 0.14
Nodes (15): data, OverviewChart(), ProjectStatusChart(), formatAction(), RecentActivity(), STATUS_COLORS, STATUS_LABELS, Avatar (+7 more)
...
Cohesion: 0.06
Nodes (54): InfraStageForm(), FallbackChecklistFormProps, Toast, ToastAction, ToastActionElement, ToastClose, ToastDescription, ToastProps (+46 more)

### Community 62 - "use Sd Attendance Bi"
Cohesion: 0.04
Nodes (59): MarkdownTiptapEditorProps, ImplementerAllCartoriosTable(), ChartTooltipProps, healthColors, healthLabels, ImplementerCharts(), ImplementerChartsProps, statusColors (+51 more)

### Community 63 - "FUNCIONALIDADE COPILOTO"
Cohesion: 0.21
Nodes (10): ChecklistEditorProps, SYSTEM_TYPES, convertVisualToJSONSchema(), convertVisualToUISchema(), parseJSONSchemaToVisual(), VisualQuestion, VisualQuestionBuilder(), VisualQuestionBuilderProps (+2 more)
...
Cohesion: 0.12
Nodes (37): ArticleMetadataCard(), ArticleNavigator(), ArticleNavigatorProps, BunnyVideoModalProps, CreateRoutineModal(), CreateRoutineModalProps, SavePublishModal(), SavePublishModalProps (+29 more)

### Community 68 - "package e relacionados"
Cohesion: 0.09
Nodes (26): TimeEntryDialogProps, DropdownMenuCheckboxItem, db, normalizeEntry(), SaveSdTimeEntryInput, SdTimeBulkImportRequestRow, SdTimeBulkImportResult, SdTimeEntry (+18 more)
...
Cohesion: 0.10
Nodes (32): getEditorContent(), ObservationsWithAI(), ObservationsWithAIProps, obsTextLen(), walkText(), AiTarget, Block, blockTextLen() (+24 more)
...
Cohesion: 0.10
Nodes (18): DashboardKPI(), DashboardKPIProps, KPICard(), Breadcrumbs(), DeploymentDetailsDialog(), project, Skeleton(), useKPIs() (+10 more)
...
Cohesion: 0.12
Nodes (26): ChecklistEditor(), AdherenceStageForm(), AdherenceGapCard(), AdherenceGapCardProps, IndividualProjectReport(), FormTemplate, NewTemplateInput, useActiveTemplate() (+18 more)

### Community 88 - "1. Gestão de Atividades — Fila de Conversão"
Cohesion: 0.21
Nodes (13): CsCxAppointment, decodeAppointmentObservations(), encodeAppointmentObservations(), formatAppointmentObservations(), normalizeAppointmentObservations(), APPOINTMENT_STATUS_LABELS, APPOINTMENT_TYPE_LABELS, formatDate() (+5 more)
...
Cohesion: 0.29
Nodes (11): DeleteTarget, errorCode(), systemNameCollator, SystemsManager(), createSdRoutine(), createSdSystem(), deleteSdRoutine(), deleteSdSystem() (+3 more)
...
Cohesion: 0.16
Nodes (13): ProjectHeaderForm(), ProjectHeaderFormProps, Chamado0800Tab(), EditProjectTab(), GeneralInfoTab(), TabProps, StepsTab(), useDebounce() (+5 more)
...
Cohesion: 0.27
Nodes (9): AdvancedFiltersProps, defaultFilters, FilterState, FilterStore, HealthFilter, SavedFilter, SortOrder, StageFilter (+1 more)
...
Cohesion: 0.52
Nodes (5): DEFAULT_NPS_QUESTIONS, DEFAULT_NPS_THEME, publicNpsAssetUrl(), validateNpsQuestionnaire(), validateNpsTheme()
...
Cohesion: 0.15
Nodes (18): FeedbackPromptModal(), FeedbackPromptModalProps, formatPosChatTranscript(), PosChatMessage, ProjectPublicInfo, safeTranscriptFilename(), SessionActionResult, usePosAiChat() (+10 more)
...
Cohesion: 0.10
Nodes (29): AiRichTextField(), messageOf(), RichTextEditor(), RichTextEditorProps, AiTextImprovementJob, mapJob(), useAiTextImprovement(), generateCsCxContactsPdf() (+21 more)
...
Cohesion: 0.17
Nodes (19): formatDate(), HighlightedText(), SolutionCard(), filterSdSolutions(), normalizedTextMap(), normalizeSdSearch(), SD_SOLUTION_STATUS, SdHighlightedPart (+11 more)
...
Cohesion: 0.08
Nodes (23): 1. Home (Hub de Navegação), 3. Quadro Kanban, 5. Detalhes do Projeto, Componentes principais, Componentes principais, Componentes principais, Dados e Hooks, Dados e Hooks (+15 more)

### Community 153 - "01 nucleo dashboard projetos"
Cohesion: 0.29
...
Cohesion: 0.10
Nodes (26): SearchableClientSelect(), emptyPage(), fetchPosAiChatConversationsPage(), PosAiConversationGroup, PosAiConversationMessage, PosAiConversationPage, PosAiConversationPageParams, PosAiVisitorOption (+18 more)
...
Cohesion: 0.08
Nodes (29): CsCxMultiSelect(), OfficeFilterCombobox(), decodeRoutineObservations(), encodeRoutineObservations(), formatRoutineObservations(), normalizeRoutineObservations(), ActionBadge(), actionLabel() (+21 more)

### Community 182 - "Conversion Issues Tab"
Cohesion: 0.12
Nodes (15): CompactQueueCardProps, ProjectInfo, ProjectInfoSection(), ProjectInfoSectionProps, ConversionStageFormProps, ConversionEngineItem, EngineKPIs, EngineStatus (+7 more)
...
### Community 186 - "contextual Header Action"
Cohesion: 0.25
...
### Community 216 - "sonner e relacionados"
Cohesion: 0.50
...
### Community 272 - "Tickets Sla Info Dialog"
Cohesion: 0.11
Nodes (16): jspdf, PosSaudeBadge(), ParecerPosJob, ChamadoPanorama, JanelaPos, PosPanoramaData, PosSaude, ProjetoPos (+8 more)

### Community 295 - "pagination e relacionados"
Cohesion: 0.10
Nodes (23): DashboardTable(), HealthBadge(), HealthBadgeProps, PipelineStatus(), ProjectDetailsModal(), ButtonProps, buttonVariants, Calendar() (+15 more)
...
Cohesion: 0.17
Nodes (21): STATUS_COLORS, TicketsAiAnalysis(), TicketsAiAnalysisProps, tooltipStyle, truncate(), ChamadoReportRow, ChamadosSearchFilters, hashFilterKey() (+13 more)

### Community 298 - "Sd Attendance Bi"
Cohesion: 0.13
Nodes (11): Progress, Column, KanbanStatus, AttendanceBiTab, minutesToHours(), PIE_COLORS, SD_GROUPS, SdAttendanceBi() (+3 more)

### Community 299 - "Conversion Post Feed"
Cohesion: 0.16
...
### Community 303 - "predictability utils"
Cohesion: 0.19
Nodes (14): StageCardProps, project, ProjectCardV3(), BottleneckIssue, getBottleneckColor(), getBottleneckIcon(), getDaysStuck(), getSeverity() (+6 more)
...
### Community 317 - "tickets sla report pdf"
Cohesion: 0.13
Nodes (25): TicketsSlaAnalysisProps, formatChamadosProductLabel(), getChamadosProductLabel(), ChamadosReportFilters, formatDate(), generateChamadosReportPdf(), localIsoDate(), summarizeClients() (+17 more)

### Community 318 - "Auth Context Value"
Cohesion: 0.17
Nodes (9): RoadmapManager(), usePermissions(), AdminLayout(), CsCxOverview(), Implantadores(), ModuleOverview(), Solutions(), { signOut, logActivity } (+1 more)
...
### Community 323 - "cs cx routines report"
Cohesion: 0.20
Nodes (19): CsCxOfficeRoutine, CsCxRoutineModel, generateCsCxPdfReport(), buildCsCxRoutinesWorkbook(), buildRoutineReportAnalytics(), formatDateTime(), generateCsCxRoutinePdf(), generateCsCxRoutinesPdf() (+11 more)
...
### Community 330 - "editor e relacionados"
Cohesion: 0.14
...
Cohesion: 0.10
Nodes (22): SolutionDetailsProps, SolutionFormProps, SolutionCardProps, SolutionsSearchProps, SdFamilyGroup, families, serviceMocks, solutions (+14 more)
...
### Community 338 - "Nps Survey Management"
Cohesion: 0.20
...
### Community 346 - "06 calendario analytics relatorios"
Cohesion: 0.29
...
### Community 358 - "select e relacionados"
Cohesion: 0.08
Nodes (46): StatusFilter, ProjectModal(), CustomTheme, RoadmapManagerProps, RoadmapSettings, ReportsFiltersProps, FamiliesManagerProps, nameCollator (+38 more)

### Community 359 - "dialog e relacionados"
Cohesion: 0.09
Nodes (41): ConversionIssuesTabProps, PRIORITIES, STATUSES, EMPTY_PROFILE, RestoreVersionModal(), RestoreVersionModalProps, VersionDetailModal(), VersionDetailModalProps (+33 more)
...
### Community 375 - "Pos Chat Message Content"
Cohesion: 0.26
...
### Community 403 - "01 nucleo dashboard projetos"
Cohesion: 0.29
...
Cohesion: 0.08
Nodes (21): LogsTab(), DEFAULT_HEALTH_SETTINGS, ProjectHealthSettings, useAdminStats(), AccessData, CsCxAccessCandidate, CsCxAccessProfile, CsCxAccessUser (+13 more)

### Community 420 - "03 comercial"
Cohesion: 0.29
...
## Knowledge Gaps
- **1678 isolated node(s):** `envPath`, `envContent`, `env`, `supabase`, `$schema` (+1673 more)
...
- **Why does `cn()` connect `infra validation` to `Form Renderer`, `cs cx nps analytics`, `Post Observations`, `Visual Question Builder`, `use Sd Time Tracking`, `Pwa Status`, `Contact Attention Dashboard`, `sidebar e relacionados`, `use Chamados0800`, `Orion TNDashboard`, `Tickets Sla Info Dialog`, `Transicao Placeholder`, `card e relacionados`, `Deployment Form Fields`, `Nps Analytics`, `sheet e relacionados`, `use Copilot`, `use Cs Cx Access`, `use Pos Ai Chat Conversations`, `ai Routine Generator Service`, `pagination e relacionados`, `filter Store`, `knowledge e relacionados`, `Project Modal`, `Conversion Post Feed`, `Sd Attendance Bi`, `command e relacionados`, `pos chat history sidebar.test`, `predictability utils`, `Cs Cx Appointments`, `Cs Cx Routines`, `sd time`, `toast e relacionados`, `use Sd Attendance Bi`, `FUNCIONALIDADE COPILOTO`, `Auth Context Value`, `07 telas publicas autenticacao`, `team e relacionados`, `editor e relacionados`, `PostObservations`, `cs-cx-nps-xlsx.ts`, `Nps Survey Management`, `tickets sla`, `Project Adherence Form`, `useTheme`, `useHomologationEvents.ts`, `require-permission.test.tsx`, `select e relacionados`, `dialog e relacionados`, `chart.tsx`?**
  _High betweenness centrality (0.074) - this node is a cross-community bridge._
- **Why does `text()` connect `run Skill` to `sd solutions`, `use Copilot`, `cs cx routines report`, `Cs Cx Requests`, `Post Observations`, `use Sd Time Tracking`, `process Copilot Job`, `process Dtc Job`, `PostObservations`, `Transicao Placeholder`, `Deployment Form Fields`, `tickets sla report pdf`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `Button` connect `select e relacionados` to `use Cs Cx Routines`, `Form Renderer`, `cs cx nps analytics`, `permissions e relacionados`, `Cs Cx Requests`, `Post Observations`, `Visual Question Builder`, `use Sd Time Tracking`, `Pwa Status`, `Contact Attention Dashboard`, `sidebar e relacionados`, `use Chamados0800`, `Orion TNDashboard`, `theme context`, `Transicao Placeholder`, `sd solutions`, `card e relacionados`, `Deployment Form Fields`, `Nps Analytics`, `sheet e relacionados`, `use Copilot`, `Project V2`, `ai Routine Generator Service`, `pagination e relacionados`, `knowledge e relacionados`, `Implementer Phase1 Fichas`, `Project Modal`, `Conversion Post Feed`, `tickets ai analytics`, `command e relacionados`, `filter Store`, `pos chat history sidebar.test`, `Cs Cx Appointments`, `sd attachments`, `Sd Attendance Bi`, `Cs Cx Routines`, `sd time`, `contextual Header Action`, `use Sd Attendance Bi`, `FUNCIONALIDADE COPILOTO`, `sd solutions`, `Auth Context Value`, `use Pos Ai Chat Conversations`, `07 telas publicas autenticacao`, `package e relacionados`, `chamados date range`, `team e relacionados`, `editor e relacionados`, `PwaStatus.tsx`, `PostObservations`, `Nps Survey Management`, `tickets sla`, `ImplementerCharts.tsx`, `Project Adherence Form`, `3. Dashboard — Modelos Editor`, `useHomologationEvents.ts`, `codexModelSkill.ts`, `require-permission.test.tsx`, `dialog e relacionados`, `cs cx core permissions.test`?**
