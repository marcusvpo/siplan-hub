...
## Corpus Check
- 547 files · ~745,980 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3975 nodes · 7580 edges · 308 communities (237 shown, 71 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 86 edges (avg confidence: 0.66)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `78c74f4b`
...
## Communities (308 total, 71 thin omitted)
...
Cohesion: 0.10
Nodes (25): err(), jszip, ModelosEditorWorkspace(), normalizeModelName(), pairKeyFor(), useConversionEngines(), useConversionIssues(), useConversionQueue() (+17 more)
...
Cohesion: 0.07
Nodes (51): data, OverviewChart(), ProjectStatusChart(), ProjectStatusChartProps, STATUS_LABELS, formatAction(), RecentActivity(), AdminSettings() (+43 more)
...
Cohesion: 0.07
Nodes (45): CalendarControls(), CalendarGrid(), CalendarGridProps, DayDroppableZone(), CalendarLegend(), DraggableTeamMember(), DraggableTeamMemberProps, CalendarEventPill() (+37 more)
...
Cohesion: 0.13
Nodes (13): DEFAULT_HEALTH_SETTINGS, ProjectHealthSettings, useStorageStats(), Client, Contact, Project, ConversionEngineItem, EngineKPIs (+5 more)

### Community 13 - "Sidebar Components"
Cohesion: 0.05
Nodes (44): clamp(), FloatingCopilot(), maxWidth(), Breadcrumbs(), MainLayout(), MainLayoutProps, SheetContent, SheetContentProps (+36 more)
...
Cohesion: 0.08
Nodes (37): ConversionPostDrawer(), ConversionPostDrawerProps, STATUS_LABELS, NOTIFICATION_TYPE_ICONS, NotificationBell(), AdvancedFilters(), AdvancedFiltersProps, AdherenceGapCard() (+29 more)

### Community 17 - "Dashboard Table & Pagination"
Cohesion: 0.15
Nodes (18): DashboardTable(), DashboardTableProps, HealthBadge(), ButtonProps, buttonVariants, Pagination(), PaginationContent, PaginationEllipsis() (+10 more)
...
Cohesion: 0.20
Nodes (11): DashboardKPI(), DashboardKPIProps, DashboardReport(), DashboardReportProps, ProjectDetailsModal(), ProjectDistributionChart(), StatusChart(), WorkloadChart() (+3 more)
...
Cohesion: 0.10
Nodes (40): ConversionIssuesTabProps, PRIORITIES, STATUSES, UserProfileDrawerProps, EnvironmentScreenshots(), sanitize(), fmtDate(), PostChamados0800() (+32 more)
...
Cohesion: 0.14
Nodes (25): jspdf, AiTarget, Block, blockTextLen(), blockToPlain(), escapeHtml(), fmtDate(), inlineHtml() (+17 more)

### Community 28 - "Project Modal & Kanban"
Cohesion: 0.14
Nodes (24): CollapsibleFieldSection(), CollapsibleFieldSectionProps, getEditorContent(), ObservationsWithAI(), ObservationsWithAIProps, obsTextLen(), walkText(), ConversionStageForm() (+16 more)

### Community 29 - "Commercial/Public Checklists"
Cohesion: 0.14
Nodes (29): Table, TableBody, TableCaption, TableCell, TableFooter, TableHead, TableHeader, TableRow (+21 more)

### Community 30 - "Commercial Page & Hooks"
Cohesion: 0.39
Nodes (6): ProjectCardV3(), ProjectCardV3Props, Progress, getBottleneckColor(), getBottleneckIcon(), getStageReadiness()
...
Cohesion: 0.29
Nodes (9): StageCardProps, BottleneckIssue, getDaysStuck(), getSeverity(), identifyBottleneck(), identifyBottlenecks(), ProjectBottleneck, StageReadiness (+1 more)
...
Cohesion: 0.22
Nodes (11): ModeToggle(), CardFooter, useTheme(), useToast(), useVacations(), Vacation, VacationInput, CopilotAccess() (+3 more)
...
Cohesion: 0.07
Nodes (43): AppSidebar(), UserProfileDrawer(), NewProjectDialog(), ProjectHeaderForm(), ProjectHeaderFormProps, ProjectGrid(), ProjectModal(), RoadmapManager() (+35 more)
...
Cohesion: 0.12
Nodes (36): STAGE_OPTIONS, COLORS, FONT_SIZES, DeploymentCard(), DeploymentDetailsDialog(), ReportsFilters(), ReportsFiltersProps, AutocompleteInput() (+28 more)
...
Cohesion: 0.17
Nodes (12): ChartEmptyState(), ChartEmptyStateProps, ProjectDistributionChartProps, StatusChartProps, WorkloadChartProps, ChartConfig, ChartContainer, ChartContext (+4 more)
...
Cohesion: 0.16
Nodes (18): AdherenceStageForm(), AdherenceStageFormProps, FormTemplate, NewTemplateInput, useActiveTemplate(), useProjectDetails(), ProjectFormResponse, UpsertResponseInput (+10 more)

### Community 141 - "Coleta Pública de Infraestrutura"
Cohesion: 0.24
Nodes (10): DeploymentFormFields(), Props, StageCard(), ImplementationPhaseForm(), DeploymentFormRecord, check(), DeploymentFormData, generateDeploymentTemplate() (+2 more)
...
### Community 184 - "Login"
Cohesion: 0.22
Nodes (15): bucketNatureza(), Diagnostico, diasEntre(), montarDiagnostico(), PosImplantacaoTab(), PosImplantacaoTabProps, Chamado0800, Chamados0800Result (+7 more)
...
Cohesion: 0.27
Nodes (8): Alert, AlertDescription, AlertTitle, alertVariants, Switch, useTeamMembers(), TeamManagement(), TeamMember
...
## Knowledge Gaps
- **2166 isolated node(s):** `{ chromium, firefox, webkit }`, `name`, `version`, `description`, `author` (+2161 more)
...
- **Why does `cn()` connect `Calendar Grid & Drag-Drop` to `Conversion Post Feed & Drawer`, `FormRenderer.tsx`, `Checklist & Visual Question Builder`, `Charts, KPI & Reports`, `Coleta Pública de Infraestrutura`, `Sidebar Components`, `Custom Widgets & Sheet`, `Dashboard Table & Pagination`, `Commercial & Conversion Hooks`, `Distribution/Workload Charts`, `Project Transformers & Stages`, `use-toast Reducer`, `Project Modal & Kanban`, `Commercial/Public Checklists`, `Commercial Page & Hooks`, `Main Layout & Theme Toggle`, `Post Observations Editor`, `Admin Stats & RBAC Hooks`, `ProtectedRoute.tsx`, `Deployment Template & Stage Forms`, `CopilotChat`, `Health Badge & Pipeline Status`, `Roadmap Page`, `PipelineStatus.tsx`, `usePublicChecklist.ts`, `Login`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `dependencies` connect `Auth Context` to `Conversion Post Feed & Drawer`, `FormRenderer.tsx`, `ProjectV2`, `DeploymentFormFields.tsx`, `package.json`, `use-toast Reducer`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `err()` connect `Conversion Post Feed & Drawer` to `Main Layout & Theme Toggle`, `VM Worker Job Queue`, `FormRenderer.tsx`, `Notification Bell & Dropdown`, `Health Badge & Pipeline Status`, `LogsTab.tsx`, `Calendar Grid & Drag-Drop`, `Sidebar Components`, `Improve-Text AI Jobs`, `SimpleMarkdown.tsx`, `useHomologationEvents.ts`, `use-toast Reducer`?**
