...
## Corpus Check
- 910 files · ~1,034,430 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5843 nodes · 13143 edges · 412 communities (315 shown, 97 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 185 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7dea04f0`
...
## Communities (412 total, 97 thin omitted)

### Community 0 - "Conversion Issues & Post Forms"
Cohesion: 0.08
Nodes (30): CsCxProduct, CsCxRoutineCategory, CsCxRoutineHistory, CsCxRoutineItemConfig, CsCxRoutineLink, CsCxRoutineLinkModel, CsCxRoutineModelItem, CsCxRoutineType (+22 more)

### Community 1 - "Conversion Post Feed & Drawer"
Cohesion: 0.09
Nodes (19): useCsCxRegistryOffices(), answerLabel(), CLASS_LABELS, CsCxNps(), formatDate(), formatDateOnly(), messageOf(), normalizeOfficeName() (+11 more)

### Community 2 - "App Routes & Pages"
Cohesion: 0.03
Nodes (74): AderenciasFinalizadas, AdminDashboard, AdminLayout, AdminSettings, AgendaAnalistas, Analytics, AuditLogPage, Calendar (+66 more)
...
Cohesion: 0.16
Nodes (10): Breadcrumbs(), ContextualHeaderAction, getContextualHeaderAction(), matchesPath(), MainLayout(), MainLayoutProps, SidebarProvider, SidebarTrigger (+2 more)
...
Cohesion: 0.21
Nodes (6): appointmentContactName(), appointmentOfficeName(), AppointmentTable(), formatDateTime(), STATUS_LABELS, TYPE_LABELS

### Community 8 - "Charts, KPI & Reports"
Cohesion: 0.08
Nodes (34): BenchmarkPos, Chamados0800Result, ChamadosClientOption, createChamadosSearchQuery(), fetchUltimosTramites(), isProcessoVendaSyncSupersededError(), mapChamado0800(), mapChamadoTramite() (+26 more)
...
Cohesion: 0.09
Nodes (28): jspdf, Bloco, escapeHtml(), MarkdownLite(), markdownLiteToHtml(), parseBlocos(), renderInline(), PosSaudeBadge() (+20 more)
...
Cohesion: 0.14
Nodes (18): formatAction(), RecentActivity(), useAdminStats(), useStorageStats(), useAuditLogs(), useTeams(), AdminDashboard(), actionLabels (+10 more)
...
Cohesion: 0.17
Nodes (22): NpsQuestionnairesPanel(), NpsThemePreview(), QUESTION_TYPES, questionTypeLabel(), darkenNpsThemeColor(), isHexColor(), newNpsQuestion(), normalizeNpsTheme() (+14 more)
...
Cohesion: 0.09
Nodes (33): errorCode(), FamiliesManager(), SolutionForm(), errorCode(), SystemsManager(), attachmentStorageName(), createSdFamily(), createSdRoutine() (+25 more)

### Community 26 - "Project Transformers & Stages"
Cohesion: 0.08
Nodes (46): PAGE_SIZE_OPTIONS, dateFormatter, integerFormatter, usdFormatter, AttentionFilter, AttentionStatus, STATUS_META, COLORS (+38 more)

### Community 27 - "use-toast Reducer"
Cohesion: 0.06
Nodes (44): CriticalAlertsProps, DashboardReport(), DashboardReportProps, ProjectDetailsModalProps, DeploymentCard(), DeploymentCardProps, DeploymentDetailsDialogProps, ProjectHeaderForm() (+36 more)

### Community 28 - "Project Modal & Kanban"
Cohesion: 0.09
Nodes (27): AttentionRow, ContactAttentionDashboardProps, CS_CX_REQUEST_STATUSES, CsCxOfficeProduct, CsCxOfficeResponsible, CsCxProductResponsible, CsCxRegistryOffice, CsCxRequestInput (+19 more)
...
Cohesion: 0.12
Nodes (25): NpsAnalyticsPanelProps, CsCxProduct, CsCxNpsResponse, buildNpsAiSource(), buildNpsAnalytics(), compact(), EMPTY_NPS_FILTERS, filterNpsResponses() (+17 more)
...
Cohesion: 0.13
Nodes (12): ChecklistEditor(), ChecklistEditorProps, convertVisualToJSONSchema(), convertVisualToUISchema(), parseJSONSchemaToVisual(), VisualQuestion, FormTemplate, NewTemplateInput (+4 more)
...
Cohesion: 0.07
Nodes (30): EnvironmentScreenshotsProps, AdherenceStageFormProps, ProjectRow, mocks, AdherenceStageV2, BlockingReason, ChecklistItem, ClientSatisfaction (+22 more)
...
Cohesion: 0.09
Nodes (19): VisualQuestionBuilder(), VisualQuestionBuilderProps, ImplementationStageForm(), ImplementationStageFormProps, PhaseFormProps, CustomTheme, RoadmapManagerProps, RoadmapSettings (+11 more)

### Community 40 - "Deployment Template & Stage Forms"
Cohesion: 0.13
Nodes (14): ModeToggle(), PosChatThemeMenu(), initialState, Theme, ThemeProviderContext, ThemeProviderState, ThemeProvider(), ThemeProviderProps (+6 more)
...
Cohesion: 0.10
Nodes (15): NewPostForm(), STAGE_OPTIONS, Textarea, TextareaProps, emptyForm, EXECUTION_STATUSES, FALLBACK_STATUS_CONFIGS, NEUTRAL_STATUS_STYLES (+7 more)
...
Cohesion: 0.08
Nodes (24): 1.1. Subseção: Cartão detalhado da Minha Fila (`MyQueueDetailedCard`), 1. Gestão de Atividades — Fila de Conversão, 2. Motores de Conversão, 3. Dashboard — Modelos Editor, Componentes principais, Componentes principais, Componentes principais, Dados e Hooks (+16 more)
...
Cohesion: 0.15
Nodes (23): TicketsAiAnalysisProps, TicketsSlaAnalysisProps, TicketsSlaSectorAnalysisProps, Chamado0800DetailDialogProps, ChamadosSearchFilters, ChamadosCatalog, formatChamadosProductLabel(), getChamadosProductLabel() (+15 more)
...
Cohesion: 0.13
Nodes (27): Chamado0800DetailDialog(), fmtDateBr(), fmtDateTimeBr(), formatTicketDuration(), statusBadgeClass(), PostChamados0800(), PostChamados0800Props, PosAiAssistantSection() (+19 more)
...
Cohesion: 0.08
Nodes (25): 5. Contatos & Clientes, 6. Formulários de Implantação, 7. Checklists de Implantação, Acesso ao grupo, Componentes principais, Componentes principais, Componentes principais, Dados e Hooks (+17 more)
...
Cohesion: 0.05
Nodes (61): StageCardProps, EnvironmentStageForm(), EnvironmentStageFormProps, FilesTab(), AccordionContent, AccordionItem, AccordionTrigger, Checkbox (+53 more)
...
### Community 184 - "Login"
Cohesion: 0.08
Nodes (30): ConversionIssuesTab(), NewProjectDialog(), AdvancedFilters(), ProjectGrid(), ProjectTagsLegendDialog(), useConversionEngines(), useConversionIssues(), useConversionQueue() (+22 more)
...
Cohesion: 0.08
Nodes (26): SummaryCard(), KPICard(), KPICardProps, SortableThumb(), EditableCell(), formatStepTime(), ProgressBody(), CommandShortcut() (+18 more)
...
Cohesion: 0.08
Nodes (41): EMPTY_PROFILE, BunnyVideoModal(), UnsavedChangesDialogProps, ObservationsWithAIProps, AiTarget, Block, PostObservationsProps, PostReportMeta (+33 more)
...
Cohesion: 0.26
Nodes (16): useProjectDetails(), ProjectDetails(), AuditEntry, ProjectTramite, calculateHealthScore(), formatDateForDB(), mapAdherenceStage(), mapConversionStage() (+8 more)
...
Cohesion: 0.18
Nodes (14): AppSidebar(), UserProfileDrawer(), Sidebar, SidebarContext, useSidebar(), useAuth(), CopilotAccess, CopilotJob (+6 more)
...
Cohesion: 0.17
Nodes (9): PwaInstallContext, PwaInstallContextValue, usePwaInstall(), PwaInstallButton(), PwaInstallButtonProps, PwaInstallDialog(), PwaInstallDialogProps, mobileViewportListeners (+1 more)
...
Cohesion: 0.10
Nodes (34): CsCxRequest, CsCxAppointment, APPOINTMENT_STATUS_LABELS, APPOINTMENT_TYPE_LABELS, formatDate(), formatDateTime(), generateCsCxAppointmentsPdf(), generateCsCxContactsPdf() (+26 more)

### Community 307 - "useSdAttendanceBi.ts"
Cohesion: 0.23
Nodes (14): project, ProjectCardV3(), ProjectCardV3Props, StepsTab(), BottleneckIssue, getBottleneckColor(), getBottleneckIcon(), getDaysStuck() (+6 more)
...
Cohesion: 0.29
Nodes (11): storage, BeforeInstallPromptEvent, isIosDevice(), isMobileViewport(), isPublicExperience(), isRunningStandalone(), PUBLIC_EXPERIENCE_PATHS, PwaProvider() (+3 more)
...
Cohesion: 0.07
Nodes (50): SearchableClientSelectProps, CsCxMultiSelectOption, CsCxMultiSelectProps, AttentionChartItem, DatedNpsAxisTickProps, DISTRIBUTION_COLORS, ExpandedNpsChart, NpsDrilldown (+42 more)
...
Cohesion: 0.17
Nodes (14): ImplementerAllCartoriosTableProps, ImplementerReportTab(), ImplementerStageAnalysisProps, daysBetween(), DetailedInvolvement, fmtDateShort(), generateProjectBullets(), implantationTypeLabels (+6 more)
...
Cohesion: 0.14
Nodes (6): ConversionKPIs, UseConversionQueueOptions, ActivityLogger, LogAction, LogActionPayload, LogDetails
...
Cohesion: 0.20
Nodes (9): formatLastActivity(), PosAiVisitorAnalytics(), PosAiVisitorAnalyticsProps, EMPTY_DATA, PosAiVisitorAnalyticsData, PosAiVisitorAnalyticsKpis, PosAiVisitorAnalyticsSector, PosAiVisitorAnalyticsUser (+1 more)

### Community 334 - "v"
Cohesion: 0.11
Nodes (16): DeploymentFormFields(), formatPhone(), Props, VersionHistoryDrawer(), DeploymentDetailsDialog(), StageCard(), ConversionStageForm(), ImplementationPhaseForm() (+8 more)
...
Cohesion: 0.07
Nodes (24): DEFAULT_HEALTH_SETTINGS, ProjectHealthSettings, AiTextImprovementJob, mapJob(), useAiTextImprovement(), ConversionEngineItem, EngineKPIs, EngineStatus (+16 more)
...
Cohesion: 0.25
Nodes (12): AdherenceStageForm(), useActiveTemplate(), ProjectFormResponse, UpsertResponseInput, useProjectFormResponse(), useUpsertFormResponse(), extractUrlsFromValue(), getGeneralFields() (+4 more)
...
Cohesion: 0.09
Nodes (47): StatusFilter, CompactQueueCard(), STATUS_COLORS, STATUS_LABELS, ConversionIssuesTabProps, PRIORITIES, STATUSES, ConversionPostDrawerProps (+39 more)
...
Cohesion: 0.16
Nodes (12): PosAiChatLinksManager(), SearchableClientOption, SearchableClientSelect(), ErrorLike, getErrorMessage(), CHAT_PAGE_SIZE_OPTIONS, ClearConversationsResult, CreateLinkResult (+4 more)
...
Cohesion: 0.25
Nodes (8): auditSpec(), key(), parseLegacyJson(), requiredMap(), AdminSettings(), useAdminSettings(), validateForm(), NextDeployments()
...
Cohesion: 0.33
Nodes (6): CsCxRequests(), DataError(), errorMessage(), formatDate(), formatDateTime(), RequestTable()

### Community 400 - "useDebounce"
Cohesion: 0.50
...
Cohesion: 0.07
Nodes (41): ProjectStatusChart(), ProjectStatusChartProps, STATUS_LABELS, STAGE_LABELS, SYSTEM_TYPES, CsCxMultiSelect(), ProjectModal(), FallbackChecklistForm() (+33 more)
...
Cohesion: 0.08
Nodes (34): getEditorContent(), ObservationsWithAI(), obsTextLen(), walkText(), ModelosEditorWorkspace(), normalizeModelName(), pairKeyFor(), fmt() (+26 more)

## Knowledge Gaps
- **2699 isolated node(s):** `{ chromium, firefox, webkit }`, `name`, `version`, `description`, `author` (+2694 more)
...
- **Why does `err()` connect `Agenda dos Analistas` to `Checklist & Visual Question Builder`, `Notification Bell & Dropdown`, `GEMINI.md`, `Adherence Form Renderer`, `ImplementerPDFExport.tsx`, `Project Transformers & Stages`, `cs-cx-admin-permissions.test.tsx`, `LogsTab.tsx`, `Health Badge & Pipeline Status`, `chamadosSync.ts`, `usePublicChecklist.ts`, `CsCxRegistryOffices.tsx`, `Improve-Text AI Jobs`, `FallbackChecklistForm.tsx`, `Login`, `package.json`, `index.ts`, `v`, `SimpleMarkdown.tsx`, `pos-chat-visitor-dialog.test.tsx`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `cn()` connect `RolesManagement.tsx` to `Conversion Post Feed & Drawer`, `VM Worker Job Queue`, `Checklist & Visual Question Builder`, `Project Stage Forms & Models`, `Charts, KPI & Reports`, `Notification Bell & Dropdown`, `Calendar Grid & Drag-Drop`, `GEMINI.md`, `Adherence Form Renderer`, `Sidebar Components`, `7. Checklists de Implantação`, `StageStatus`, `App Sidebar & Protected Route`, `useAuth`, `Project Transformers & Stages`, `use-toast Reducer`, `cs-cx-admin-permissions.test.tsx`, `5. Contatos & Clientes`, `ProtectedRoute.tsx`, `Roadmap Page`, `Deployment Template & Stage Forms`, `Health Badge & Pipeline Status`, `LogsTab.tsx`, `useTeams.ts`, `usePublicChecklist.ts`, `CsCxRegistryOffices.tsx`, `Página 404 (Not Found)`, `Toggle Component`, `SolutionsSearch.tsx`, `useSdAttendanceBi.ts`, `FallbackChecklistForm.tsx`, `Login`, `package.json`, `TransicaoPlaceholder`, `ContactAttentionDashboard`, `v`, `formatLogDetails`, `Módulo Comercial — Documentação por Tela`, `CsCxAdmin`, `CsCxNpsResponse`, `usePosPanorama.ts`, `NpsAnalytics.tsx`, `ImplementerCharts.tsx`, `CsCxReports`, `usePosAiChatVisitors.ts`, `cs-cx-routines-report.test.ts`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `Button` connect `CsCxReports` to `Conversion Post Feed & Drawer`, `VM Worker Job Queue`, `Project Stage Forms & Models`, `filterStore.ts`, `Charts, KPI & Reports`, `GEMINI.md`, `Adherence Form Renderer`, `Sidebar Components`, `Módulo: Calendário, Agenda, Analytics, Relatórios, Roadmap e Implantações`, `ImplementerPDFExport.tsx`, `StageStatus`, `App Sidebar & Protected Route`, `useAuth`, `Project Transformers & Stages`, `cs-cx-admin-permissions.test.tsx`, `Main Layout & Theme Toggle`, `5. Contatos & Clientes`, `ProtectedRoute.tsx`, `Roadmap Page`, `TicketsAiAnalysis.tsx`, `Health Badge & Pipeline Status`, `PipelineStatus.tsx`, `Deployment Template & Stage Forms`, `usePublicChecklist.ts`, `SolutionsSearch.tsx`, `CsCxRegistryOffices.tsx`, `usePosAiAdminAnalytics.ts`, `project-transformers.ts`, `Toggle Component`, `useSdAttendanceBi.ts`, `FallbackChecklistForm.tsx`, `Login`, `package.json`, `CopilotChat.tsx`, `package.json`, `TransicaoPlaceholder`, `SolutionDetails.tsx`, `usePosPanorama.ts`, `NpsAnalytics.tsx`, `AdminSettings.tsx`, `usePosAiChatVisitors.ts`, `pos-chat-visitor-dialog.test.tsx`?**
