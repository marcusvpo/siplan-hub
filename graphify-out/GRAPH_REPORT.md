...
## Corpus Check
- 782 files · ~947,757 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4225 nodes · 11633 edges · 278 communities (228 shown, 50 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 126 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `47843654`
...
## Communities (278 total, 50 thin omitted)

### Community 0 - "use Cs Cx Routines"
Cohesion: 0.10
Nodes (20): Skeleton(), useCsCxRequestStatusAdmin(), ADMIN_SECTIONS, AdminSection, CatalogKind, CsCxAdmin(), DeleteTarget, EMPTY_CATALOG (+12 more)
...
Cohesion: 0.08
Nodes (30): NOTIFICATION_TYPE_ICONS, AdvancedFiltersProps, ProjectHeaderForm(), PosSaudeBadge(), getInitials(), ImplementerProfileCard(), Badge(), BadgeProps (+22 more)
...
Cohesion: 0.18
Nodes (13): ProtectedRoute(), authDb, AuthContext, AuthContextType, Permission, UserRole, useAuth(), CopilotAccess (+5 more)

### Community 7 - "Visual Question Builder"
Cohesion: 0.07
Nodes (44): ConversionIssuesTab(), ConversionIssuesTabProps, PRIORITIES, STATUSES, ConversionPostDrawer(), ConversionPostDrawerProps, STATUS_LABELS, ConversionPostFeed() (+36 more)
...
Cohesion: 0.08
Nodes (33): CS_CX_REQUEST_STATUSES, CsCxOfficeProduct, CsCxOfficeResponsible, CsCxProductResponsible, CsCxRequestInput, CsCxRequestStatus, CsCxRequestStatusConfig, CsCxRequestStatusHistoryEntry (+25 more)
...
Cohesion: 0.05
Nodes (30): CriticalAlertsProps, DashboardReport(), DashboardReportProps, ProjectDetailsModalProps, DeploymentCard(), DeploymentCardProps, DeploymentDetailsDialogProps, project (+22 more)

### Community 18 - "theme context"
Cohesion: 0.10
Nodes (16): PosChatThemeMenu(), initialState, Theme, ThemeProviderContext, ThemeProviderState, ThemeProvider(), ThemeProviderProps, MenuItem (+8 more)
...
Cohesion: 0.11
Nodes (22): AlertTitle, AutocompleteInput(), mapJob(), useDtcAiJobs(), useTeamMembers(), ALL_SYSTEMS, DTCData, dtcStatusToStageStatus() (+14 more)
...
Cohesion: 0.29
Nodes (11): emptyInterval(), TimeEntryDialog(), entryMinutes(), getWeekDays(), getWeekRange(), intervalMinutes(), intervalsOverlap(), SdTimeEntryLike (+3 more)

### Community 26 - "card e relacionados"
Cohesion: 0.08
Nodes (43): data, OverviewChart(), ProjectStatusChart(), ProjectStatusChartProps, STATUS_LABELS, formatAction(), RecentActivity(), AdminSettings() (+35 more)

### Community 27 - "Deployment Form Fields"
Cohesion: 0.17
Nodes (13): DeploymentFormFields(), formatPhone(), Props, DeploymentFormRecord, useDeploymentForms(), CommercialChecklists(), checklists, forms (+5 more)
...
Cohesion: 0.12
Nodes (19): useCsCxContacts(), appointmentContactName(), appointmentOfficeName(), AppointmentTable(), CsCxAppointments(), DataError(), defaultForm(), errorMessage() (+11 more)
...
Cohesion: 0.07
Nodes (50): EnvironmentStageFormProps, ImplementationStageFormProps, PhaseFormProps, InfraStageFormProps, ModelosEditorWorkspaceProps, ProjectRow, AuditEntry, BlockingReason (+42 more)

### Community 38 - "ai Routine Generator Service"
Cohesion: 0.14
Nodes (27): PAGE_SIZE_OPTIONS, VisitorActionResult, UnsavedChangesDialogProps, PosChatHistorySidebarProps, ObservationsWithAIProps, EditableCellProps, StatusType, AiRichTextFieldProps (+19 more)

### Community 39 - "filter Store"
Cohesion: 0.09
Nodes (23): CopilotChat(), CopilotChatProps, fmtDateTime(), linkifyProjects(), loadSaved(), SUGESTOES, NewProjectDialog(), AdvancedFilters() (+15 more)
...
Cohesion: 0.24
Nodes (9): initials(), PosAiChatUsersManager(), fetchPosAiChatVisitorsPage(), PosAiVisitorPage, PosAiVisitorPageParams, PosAiVisitorStatus, usePosAiChatVisitors(), downloadCsv() (+1 more)

### Community 42 - "Project Modal"
Cohesion: 0.08
Nodes (21): copyText(), formatDate(), NpsInvitationsPanel(), QUESTION_TYPES, questionTypeLabel(), effectiveInvitationStatus(), canAccessCsCxRecord(), CsCxOwnedResource (+13 more)
...
Cohesion: 0.23
Nodes (17): SearchableClientSelectProps, CsCxMultiSelectOption, CsCxMultiSelectProps, AutocompleteInputProps, Command, CommandDialogProps, CommandEmpty, CommandGroup (+9 more)
...
Cohesion: 0.14
Nodes (23): SolutionDetailsProps, SolutionForm(), SolutionFormProps, formatDate(), SolutionCard(), SolutionCardProps, SolutionsSearch(), SolutionsSearchProps (+15 more)

### Community 48 - "Cs Cx Appointments"
Cohesion: 0.09
Nodes (49): AdminListPager(), AdminListPagerProps, MarkdownTiptapEditor(), UserProfileDrawer(), ImplementerAllCartoriosTable(), ImplementerPhase1ConsolidatedTable(), ReportListPagination(), ReportListPaginationProps (+41 more)

### Community 58 - "sd time"
Cohesion: 0.14
Nodes (12): CompactQueueCard(), STATUS_COLORS, STATUS_LABELS, MarkdownTiptapEditorProps, VersionDetailModal(), GlobalMetrics(), ScrollArea, Separator (+4 more)
...
Cohesion: 0.12
Nodes (22): TimeEntryDialogProps, db, normalizeEntry(), SaveSdTimeEntryInput, SdTimeBulkImportRequestRow, SdTimeBulkImportResult, SdTimeEntry, SdTimeImportRequestRow (+14 more)
...
Cohesion: 0.19
Nodes (12): CS_CX_APPOINTMENT_STATUSES, CS_CX_APPOINTMENT_TYPES, CsCxAppointmentInput, CsCxContactInput, CsCxProfileOption, currentUser(), db, emptyToNull() (+4 more)
...
Cohesion: 0.26
Nodes (13): formatStepTime(), ModelosEditorWorkspace(), normalizeModelName(), pairKeyFor(), ProgressBody(), mapHeartbeat(), mapJob(), useModelGenerationJobs() (+5 more)
...
Cohesion: 0.11
Nodes (18): 1.1. Subseção: Cartão detalhado da Minha Fila (`MyQueueDetailedCard`), 1. Gestão de Atividades — Fila de Conversão, 5. Modelos Editor (Workspace), Componentes principais, Componentes principais, Dados e Hooks, Dados e Hooks, Fluxos e Interações (+10 more)

### Community 79 - "cs-cx-nps-import.ts"
Cohesion: 0.21
Nodes (9): ImplementerKPIs(), ImplementerKPIsProps, ImplementerPDFExport(), ImplementerPDFExportProps, ImplementerPhaseMetrics(), ImplementerReportTab(), ImplementerSignaturesBlock(), ImplementerSignaturesBlockProps (+1 more)

### Community 80 - "PostObservations"
Cohesion: 0.16
Nodes (21): AiTarget, Block, blockTextLen(), blockToPlain(), escapeHtml(), fmtDate(), inlineHtml(), lexToHtml() (+13 more)
...
Cohesion: 0.26
Nodes (10): useDeleteSdTimeEntry(), useImportSdTimeEntries(), useMySdTimeEntries(), useSaveSdTimeEntry(), entryStartMinutes(), totalMinutes(), DAY_PAGE_SIZE_OPTIONS, errorMessage() (+2 more)
...
Cohesion: 0.15
Nodes (22): AdherenceStageForm(), AdherenceStageFormProps, AdherenceGapCard(), AdherenceGapCardProps, IndividualProjectReport(), useActiveTemplate(), ProjectFormResponse, UpsertResponseInput (+14 more)
...
Cohesion: 0.15
Nodes (14): humanizeCopilotText(), normalizedKey(), readablePeriod(), readableStatus(), STAGE_LABELS, STATUS_LABELS, defaultFilters, FilterState (+6 more)
...
Cohesion: 0.21
Nodes (6): PosChatHistorySidebar(), PosChatVisitorDialog(), defaultProps, session, defaultProps, visitor

### Community 114 - "cs cx core permissions.test"
Cohesion: 0.14
Nodes (12): CsCxMultiSelect(), CsCxRegistryOffices(), DataError(), emptyForm, errorMessage(), formatDate(), matchesRegistryOfficeFilters(), OfficeForm (+4 more)
...
Cohesion: 0.60
Nodes (5): readRememberedVisitor(), rememberVisitor(), usePosChatVisitor(), VisitorActionResult, visitorStorageKey()

### Community 124 - "cs-cx-appointment-observations.ts"
Cohesion: 0.73
Nodes (4): decodeAppointmentObservations(), encodeAppointmentObservations(), formatAppointmentObservations(), normalizeAppointmentObservations()
...
Cohesion: 0.50
Nodes (3): PosAiChatLinksManager(), ErrorLike, getErrorMessage()

### Community 130 - "ImplementerStageAnalysis.tsx"
Cohesion: 0.50
Nodes (4): ImplementerStageAnalysis(), ImplementerStageAnalysisProps, StageTooltipProps, StageTimeEntry

### Community 131 - "Cs Cx Requests"
Cohesion: 0.18
Nodes (13): FeedbackPromptModal(), FeedbackPromptModalProps, formatPosChatTranscript(), PosChatMessage, ProjectPublicInfo, safeTranscriptFilename(), SessionActionResult, usePosAiChat() (+5 more)
...
Cohesion: 0.12
Nodes (24): AiRichTextField(), messageOf(), RichTextEditor(), RichTextEditorProps, appendPlainTextToLexicalJson(), hasRichTextContent(), LexicalNode, lexicalNodeToPlainText() (+16 more)
...
Cohesion: 0.22
Nodes (16): HighlightedText(), filterSdSolutions(), normalizedTextMap(), normalizeSdSearch(), SD_SOLUTION_STATUS, SdHighlightedPart, sdNameCollator, sdSolutionExcerpt() (+8 more)

### Community 137 - "PosAiChatLink"
Cohesion: 0.67
Nodes (3): PosAiChatLinksManagerProps, PosAiChatUsersManagerProps, PosAiChatLink
...
Cohesion: 0.08
Nodes (23): 2. Dashboard (Visão Geral), 5. Detalhes do Projeto, 7. Comparar Projetos, Componentes principais, Componentes principais, Componentes principais, Dados e Hooks, Dados e Hooks (+15 more)
...
Cohesion: 0.12
Nodes (23): SearchableClientOption, emptyPage(), fetchPosAiChatConversationsPage(), PosAiConversationGroup, PosAiConversationMessage, PosAiConversationPage, PosAiConversationPageParams, PosAiVisitorOption (+15 more)
...
Cohesion: 0.16
Nodes (10): Breadcrumbs(), ContextualHeaderAction, getContextualHeaderAction(), matchesPath(), FloatingCopilot, MainLayout(), MainLayoutProps, ModeToggle() (+2 more)
...
Cohesion: 0.05
Nodes (47): DayDroppableZone(), SummaryCard(), CriticalAlerts(), DashboardTable(), DashboardTableProps, HealthBadge(), HealthBadgeProps, KPICard() (+39 more)
...
Cohesion: 0.08
Nodes (35): VersionHistoryDrawer(), CollapsibleFieldSection(), CollapsibleFieldSectionProps, getEditorContent(), ObservationsWithAI(), obsTextLen(), walkText(), StageCard() (+27 more)
...
Cohesion: 0.19
Nodes (19): TicketsSlaAnalysisProps, formatChamadosProductLabel(), getChamadosProductLabel(), ChamadosReportFilters, formatDate(), formatDateTime(), generateChamadosReportPdf(), latestTramiteText() (+11 more)

### Community 318 - "Auth Context Value"
Cohesion: 0.11
Nodes (27): ProjectModal(), CustomTheme, RoadmapManager(), RoadmapManagerProps, RoadmapSettings, Chamado0800Tab(), EditProjectTab(), FilesTab() (+19 more)
...
Cohesion: 0.12
Nodes (30): errorCode(), FamiliesManager(), DeleteTarget, errorCode(), systemNameCollator, SystemsManager(), createSdFamily(), createSdRoutine() (+22 more)
...
Cohesion: 0.15
Nodes (25): NpsQuestionnairesPanel(), NpsThemePreview(), darkenNpsThemeColor(), DEFAULT_NPS_QUESTIONS, DEFAULT_NPS_THEME, isHexColor(), newNpsQuestion(), normalizeNpsTheme() (+17 more)
...
Cohesion: 0.10
Nodes (33): StatusFilter, NewPostForm(), STAGE_OPTIONS, EMPTY_PROFILE, COLORS, FONT_SIZES, DeploymentDetailsDialog(), ReportsFiltersProps (+25 more)

### Community 359 - "dialog e relacionados"
Cohesion: 0.12
Nodes (25): SearchableClientSelect(), BunnyVideoModal(), RestoreVersionModal(), UserProfileDrawerProps, PosChatVisitorDialogProps, EnvironmentScreenshots(), EnvironmentScreenshotsProps, sanitize() (+17 more)
...
Cohesion: 0.09
Nodes (20): DEFAULT_HEALTH_SETTINGS, ProjectHealthSettings, AiTextImprovementJob, mapJob(), useAiTextImprovement(), AccessData, CsCxAccessCandidate, CsCxAccessProfile (+12 more)
...
## Knowledge Gaps
- **1681 isolated node(s):** `envPath`, `envContent`, `env`, `supabase`, `$schema` (+1676 more)
...
- **Why does `cn()` connect `pagination e relacionados` to `use Cs Cx Routines`, `Form Renderer`, `cs cx nps analytics`, `Post Observations`, `Visual Question Builder`, `conversion e relacionados`, `Pwa Status`, `Contact Attention Dashboard`, `sidebar e relacionados`, `use Chamados0800`, `Orion TNDashboard`, `Tickets Sla Info Dialog`, `theme context`, `Transicao Placeholder`, `card e relacionados`, `Deployment Form Fields`, `use Cs Cx Core`, `Nps Analytics`, `sheet e relacionados`, `ai Routine Generator Service`, `filter Store`, `knowledge e relacionados`, `Project Modal`, `command e relacionados`, `pos chat history sidebar.test`, `predictability utils`, `Cs Cx Appointments`, `Families Manager`, `Cs Cx Routines`, `sd time`, `contextual Header Action`, `Auth Context Value`, `FUNCIONALIDADE COPILOTO`, `07 telas publicas autenticacao`, `use Pos Ai Project Summary`, `team e relacionados`, `editor e relacionados`, `PostObservations`, `Nps Survey Management`, `tickets sla`, `Project Adherence Form`, `3. Dashboard — Modelos Editor`, `useTheme`, `select e relacionados`, `dialog e relacionados`, `chart.tsx`, `cs cx core permissions.test`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Why does `Button` connect `select e relacionados` to `use Cs Cx Routines`, `Form Renderer`, `cs cx nps analytics`, `permissions e relacionados`, `Cs Cx Requests`, `Post Observations`, `Visual Question Builder`, `Pwa Status`, `Contact Attention Dashboard`, `sidebar e relacionados`, `use Chamados0800`, `Orion TNDashboard`, `Tickets Sla Info Dialog`, `theme context`, `Transicao Placeholder`, `card e relacionados`, `Nps Analytics`, `sheet e relacionados`, `use Pos Ai Chat Conversations`, `ai Routine Generator Service`, `filter Store`, `knowledge e relacionados`, `pagination e relacionados`, `Project Modal`, `tickets ai analytics`, `Sd Attendance Bi`, `command e relacionados`, `pos chat history sidebar.test`, `predictability utils`, `Cs Cx Appointments`, `Families Manager`, `sd attachments`, `Cs Cx Routines`, `sd time`, `contextual Header Action`, `Auth Context Value`, `FUNCIONALIDADE COPILOTO`, `use Sd Attendance Bi`, `sd solutions`, `07 telas publicas autenticacao`, `chamados date range`, `team e relacionados`, `sd e relacionados`, `PwaStatus.tsx`, `cs-cx-nps-import.ts`, `PostObservations`, `Nps Survey Management`, `cs-cx-nps-xlsx.ts`, `tickets sla`, `Project Adherence Form`, `codexModelSkill.ts`, `dialog e relacionados`, `chart.tsx`, `cs cx core permissions.test`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `useToast()` connect `Cs Cx Appointments` to `use Cs Cx Routines`, `Form Renderer`, `cs cx nps analytics`, `permissions e relacionados`, `Post Observations`, `infra validation`, `Pwa Status`, `Orion TNDashboard`, `theme context`, `card e relacionados`, `Deployment Form Fields`, `use Cs Cx Core`, `Nps Analytics`, `sheet e relacionados`, `ai Routine Generator Service`, `Project Modal`, `command e relacionados`, `predictability utils`, `Cs Cx Routines`, `toast e relacionados`, `Auth Context Value`, `FUNCIONALIDADE COPILOTO`, `team e relacionados`, `Nps Survey Management`, `ProjectsKanban.tsx`, `Project Adherence Form`, `3. Dashboard — Modelos Editor`, `codexModelSkill.ts`, `select e relacionados`, `dialog e relacionados`, `chart.tsx`, `cs cx core permissions.test`?**
