...
## Corpus Check
- 894 files · ~1,024,754 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5781 nodes · 13006 edges · 417 communities (321 shown, 96 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 177 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `398ca886`
...
- CopilotChat.tsx
- package.json
- ImplementerReportTab.tsx
- SolutionDetails.tsx
- useCsCxExperience.ts
- PosPanorama.tsx
- DeploymentFormFields.tsx
...
3. `Badge()` - 118 edges
4. `Card` - 112 edges
5. `CardContent` - 108 edges
6. `useToast()` - 99 edges
7. `usePermissions()` - 99 edges
8. `ProjectV2` - 97 edges
...
## Communities (417 total, 96 thin omitted)
...
Cohesion: 0.06
Nodes (34): CsCxMultiSelect(), useCsCxRegistryOffices(), canAccessCsCxRecord(), CsCxOwnedResource, useCsCxRecordPermissions(), CsCxRegistryOffices(), DataError(), emptyForm (+26 more)
...
Cohesion: 0.17
Nodes (19): err(), text(), RoutineObservationsPreview(), DtcJob, buildVoicePrompt(), processVoiceJob(), runCommand(), AnyObj (+11 more)
...
Cohesion: 0.05
Nodes (60): emptyInterval(), IntervalDraft, TimeEntryDialog(), TimeEntryDialogProps, db, EMPTY_BI, normalizeBiData(), SdAttendanceBiBreakdown (+52 more)

### Community 7 - "Project Stage Forms & Models"
Cohesion: 0.07
Nodes (63): PosAiChatLinksManager(), PAGE_SIZE_OPTIONS, SearchableClientSelect(), SYSTEM_TYPES, NewPostForm(), STAGE_OPTIONS, EMPTY_PROFILE, COLORS (+55 more)

### Community 8 - "Charts, KPI & Reports"
Cohesion: 0.16
Nodes (19): formatStepTime(), ModelosEditorWorkspace(), ModelosEditorWorkspaceProps, ModelosMetrics(), normalizeModelName(), pairKeyFor(), ProgressBody(), mapHeartbeat() (+11 more)
...
Cohesion: 0.06
Nodes (56): dateFormatter, formatLastActivity(), integerFormatter, PosAiVisitorAnalytics(), usdFormatter, MarkdownTiptapEditor(), AccordionContent, AccordionItem (+48 more)

### Community 13 - "Sidebar Components"
Cohesion: 0.07
Nodes (30): Breadcrumbs(), MainLayout(), MainLayoutProps, Sidebar, SidebarContent, SidebarContext, SidebarFooter, SidebarGroup (+22 more)
...
Cohesion: 0.22
Nodes (16): NpsQuestionnairesPanel(), NpsThemePreview(), QUESTION_TYPES, questionTypeLabel(), darkenNpsThemeColor(), isHexColor(), newNpsQuestion(), normalizeNpsTheme() (+8 more)
...
Cohesion: 0.05
Nodes (58): SummaryCard(), ChartEmptyState(), ChartEmptyStateProps, DashboardTable(), DashboardTableProps, HealthBadge(), HealthBadgeProps, PipelineStatus() (+50 more)

### Community 26 - "Project Transformers & Stages"
Cohesion: 0.13
Nodes (20): copyText(), formatDate(), NpsInvitationsPanel(), CreateNpsInvitationInput, currentUser(), db, effectiveInvitationStatus(), invalidateNpsSurveys() (+12 more)

### Community 27 - "use-toast Reducer"
Cohesion: 0.06
Nodes (39): DashboardReport(), DashboardReportProps, ProjectDetailsModalProps, ProjectDistributionChartProps, StatusChartProps, WorkloadChartProps, DeploymentCard(), DeploymentCardProps (+31 more)

### Community 28 - "Project Modal & Kanban"
Cohesion: 0.11
Nodes (22): NpsAnalyticsPanelProps, CS_CX_REQUEST_STATUSES, CsCxOfficeProduct, CsCxOfficeResponsible, CsCxProduct, CsCxProductResponsible, CsCxRequestInput, CsCxRequestStatus (+14 more)
...
Cohesion: 0.07
Nodes (50): EnvironmentScreenshotsProps, EnvironmentStageFormProps, ImplementationStageFormProps, PhaseFormProps, InfraStageFormProps, useProjectDetails(), ProjectRow, ProjectDetails() (+42 more)
...
Cohesion: 0.20
Nodes (10): ModeToggle(), PosChatThemeMenu(), initialState, Theme, ThemeProviderContext, ThemeProviderState, ThemeProvider(), ThemeProviderProps (+2 more)

### Community 41 - "Theme Provider"
Cohesion: 0.13
Nodes (17): ConversionPostFeed(), ConversionPostFeedProps, formatPostDate(), getInitials(), groupPostsByDate(), POST_TYPE_CONFIG, NewPostFormProps, ConversionPost (+9 more)

### Community 42 - "Health Badge & Pipeline Status"
Cohesion: 0.27
Nodes (9): Props, DeploymentFormRecord, useDeploymentForms(), CommercialChecklists(), validateForm(), check(), DeploymentFormData, generateDeploymentTemplate() (+1 more)
...
Cohesion: 0.09
Nodes (24): react, AdherenceImpactSummary(), AdherenceQuestionField(), AdherenceQuestionValue, ArrayFieldTemplateItem, checkHasAdherenceQuestions(), CustomArrayFieldTemplate(), CustomCheckboxWidget() (+16 more)
...
Cohesion: 0.21
Nodes (9): DashboardKPI(), DashboardKPIProps, KPICard(), KPICardProps, ScrollingText(), ScrollingTextProps, useKPIs(), DashboardV2() (+1 more)
...
Cohesion: 0.08
Nodes (24): 2. Motores de Conversão, 3. Dashboard — Modelos Editor, 5. Modelos Editor (Workspace), Componentes principais, Componentes principais, Componentes principais, Dados e Hooks, Dados e Hooks (+16 more)
...
Cohesion: 0.16
Nodes (25): errorCode(), FamiliesManager(), SolutionForm(), attachmentStorageName(), createSdFamily(), createSdSolution(), deleteSdFamily(), deleteSdSolutionAttachment() (+17 more)
...
Cohesion: 0.18
Nodes (14): AttentionClientsChart(), classificationClass(), classificationLabel(), ClassificationSummary(), formatRankingDate(), formatResponseDate(), matchesDrilldown(), NpsAnalyticsPanel() (+6 more)
...
Cohesion: 0.12
Nodes (34): SolutionDetailsProps, SolutionFormProps, formatDate(), HighlightedText(), SolutionCard(), SolutionCardProps, SolutionsSearch(), SolutionsSearchProps (+26 more)
...
Cohesion: 0.07
Nodes (50): Bloco, escapeHtml(), MarkdownLite(), markdownLiteToHtml(), parseBlocos(), renderInline(), Chamado0800DetailDialog(), fmtDateBr() (+42 more)
...
Cohesion: 0.22
Nodes (10): buildContactAttentionRows(), ContactAttentionDashboard(), contactStatus(), filterForStatus(), formatDate(), formatElapsedDays(), isIsoDate(), matchesAttentionFilter() (+2 more)
...
Cohesion: 0.22
Nodes (14): StageCardProps, ProjectCardV3(), StepsTab(), BottleneckIssue, getBottleneckColor(), getBottleneckIcon(), getDaysStuck(), getSeverity() (+6 more)
...
Cohesion: 0.14
Nodes (11): ChecklistEditor(), ChecklistEditorProps, convertVisualToJSONSchema(), parseJSONSchemaToVisual(), VisualQuestion, FormTemplate, NewTemplateInput, useFormTemplates() (+3 more)

### Community 178 - "Calendário (Planejamento Visual)"
Cohesion: 0.19
...
### Community 182 - "Próximas Implantações"
Cohesion: 0.20
Nodes (11): RadioGroup, RadioGroupItem, isEmptyAnswer(), loadInvitation(), messageOf(), NpsScale(), PublicNpsResponse(), RatingScale() (+3 more)
...
### Community 184 - "Login"
Cohesion: 0.08
Nodes (40): SearchableClientOption, SearchableClientSelectProps, CsCxMultiSelectOption, CsCxMultiSelectProps, AttentionChartItem, DatedNpsAxisTickProps, DISTRIBUTION_COLORS, ExpandedNpsChart (+32 more)

### Community 185 - "CsCxReports.tsx"
Cohesion: 0.15
Nodes (24): CsCxOfficeRoutine, CsCxRoutineModel, decodeRoutineObservations(), encodeRoutineObservations(), formatRoutineObservations(), normalizeRoutineObservations(), buildCsCxRoutinesWorkbook(), buildRoutineReportAnalytics() (+16 more)

### Community 186 - "package.json"
Cohesion: 0.10
Nodes (37): ArticleMetadataCardProps, ArticleNavigatorProps, BunnyVideoModalProps, CreateRoutineModal(), CreateRoutineModalProps, RestoreVersionModalProps, SavePublishModalProps, VersionDetailModalProps (+29 more)
...
Cohesion: 0.06
Nodes (27): DEFAULT_HEALTH_SETTINGS, ProjectHealthSettings, AiTextImprovementJob, mapJob(), useAiTextImprovement(), Client, Contact, Project (+19 more)
...
Cohesion: 0.17
Nodes (17): CS_CX_APPOINTMENT_STATUSES, CS_CX_APPOINTMENT_TYPES, CsCxAppointmentInput, CsCxContactInput, CsCxProfileOption, currentUser(), db, emptyToNull() (+9 more)
...
Cohesion: 0.19
Nodes (10): ImplementerAllCartoriosTable(), ImplementerKPIs(), ImplementerPhase1ConsolidatedTable(), ImplementerPhaseMetrics(), ImplementerReportTab(), ImplementerSignaturesBlock(), ImplementerSignaturesBlockProps, ImplementerStageAnalysis() (+2 more)
...
Cohesion: 0.10
Nodes (33): BenchmarkPos, Chamados0800Result, ChamadosClientOption, createChamadosSearchQuery(), fetchAllChamados(), fetchAllChamadosForReport(), fetchChamadosTramites(), fetchUltimosTramites() (+25 more)

### Community 232 - "Módulo: Núcleo — Dashboard e Projetos"
Cohesion: 0.11
Nodes (21): buildPrompt(), classifyPendingChamados(), NATUREZAS_SEM_TEMA, parseResult(), PendingRow, buildManagedSkill(), CODEX_MODEL_SKILL_CONTENT, ensureCodexModelSkill() (+13 more)
...
Cohesion: 0.11
Nodes (18): 2. Editor de Formulário de Aderência, 4. Homologação de Conversões, 7. Relação com telas externas ao módulo, Componentes principais, Componentes principais, Dados e Hooks, Dados e Hooks, Fluxos e Interações (+10 more)

### Community 297 - "TicketsAiAnalysis.tsx"
Cohesion: 0.11
Nodes (35): jspdf, STATUS_COLORS, TicketsAiAnalysis(), tooltipStyle, truncate(), ChamadoReportRow, hashFilterKey(), TicketsAiAnalysisJob (+27 more)
...
Cohesion: 0.09
Nodes (24): RequirePermission(), RequirePermissionProps, ACTION_ORDER, CsCxAccessPanel(), MenuItem, menuItems, ACTION_LABELS, getActionLabel() (+16 more)

### Community 300 - "useTeams.ts"
Cohesion: 0.23
Nodes (11): ImplementerAllCartoriosTableProps, daysBetween(), DetailedInvolvement, fmtDateShort(), generateProjectBullets(), implantationTypeLabels, safeAvg(), satisfactionLabels (+3 more)

### Community 301 - "CsCxRegistryOffices.tsx"
Cohesion: 0.10
Nodes (24): NewProjectDialog(), AdvancedFilters(), ProjectGrid(), ProjectTagsLegendDialog(), useConversionQueue(), useProjectsList(), userProjectsListTransform(), useProjectsV2() (+16 more)
...
Cohesion: 0.17
Nodes (19): calculateCsCxReportRowLayout(), clean(), CsCxPdfOutputOptions, CsCxReportBlock, CsCxReportRowLayout, CsCxSummaryItem, formatDate(), formatDateTime() (+11 more)

### Community 307 - "lexical.ts"
Cohesion: 0.18
Nodes (15): formatAction(), RecentActivity(), useAdminStats(), useStorageStats(), useAuditLogs(), AdminDashboard(), actionLabels, AuditLogPage() (+7 more)
...
Cohesion: 0.23
Nodes (11): ImplementerPhase1ConsolidatedTableProps, daysBetweenStr(), formatCurrency(), formatDate(), ImplementerPhase1Fichas(), ImplementerPhase1FichasProps, priorityLabels, satisfactionLabels (+3 more)

### Community 319 - "ImplementerReportTab.tsx"
Cohesion: 0.26
...
Cohesion: 0.19
Nodes (18): attachmentSecurity(), clampPanelWidth(), longDate(), maxPanelWidth(), shortDate(), SolutionDetails(), canPreviewSdAttachment(), deleteSdSolution() (+10 more)
...
### Community 323 - "DeploymentFormFields.tsx"
Cohesion: 0.07
Nodes (32): DeploymentFormFields(), formatPhone(), ConversionIssuesTab(), ConversionIssuesTabProps, PRIORITIES, STATUSES, NOTIFICATION_TYPE_ICONS, PosSaudeBadge() (+24 more)

### Community 324 - "migrate-cs-cx-files.mjs"
Cohesion: 0.12
Nodes (9): apply, args, bucket, download(), isMissingObjectError(), legacyRoot, projectRef, storage (+1 more)
...
### Community 326 - "useCsCxNpsSurveys.ts"
Cohesion: 0.25
Nodes (9): CsCxAppointments(), DataError(), defaultForm(), errorMessage(), formatDateOnly(), localDateKey(), MonthCalendar(), toDateTimeLocal() (+1 more)

### Community 327 - "CsCxRegistryOffices"
Cohesion: 0.20
Nodes (10): ProjectHeaderForm(), ProjectHeaderFormProps, GeneralInfoTab(), TabProps, useDebounce(), AutoSaveConfig, SaveState, useAutoSave() (+2 more)
...
Cohesion: 0.22
Nodes (11): clamp(), FloatingCopilot(), maxWidth(), SheetContent, SheetContentProps, SheetDescription, SheetFooter(), SheetHeader() (+3 more)

### Community 331 - "processJob.ts"
Cohesion: 0.14
Nodes (17): AppSidebar(), UserProfileDrawer(), ProtectedRoute(), useAuth(), CopilotAccess, CopilotJob, mapAccess(), mapJob() (+9 more)

### Community 332 - "PostObservations"
Cohesion: 0.43
Nodes (6): CsCxRequest, EXECUTION_STATUSES, formatDate(), formatDateTime(), localIsoDate(), printCsCxRequestsReport()

### Community 333 - "CsCxAdmin"
Cohesion: 0.33
Nodes (6): CsCxAdmin(), messageOf(), showError(), statusColorClass(), statusLabel(), required()

### Community 334 - "useHomologationEvents.ts"
Cohesion: 0.22
Nodes (9): CompactQueueCardProps, ProjectInfo, ProjectInfoSection(), ProjectInfoSectionProps, ConversionStageFormProps, ConversionKPIs, ConversionQueueItem, UseConversionQueueOptions (+1 more)

### Community 335 - "formatLogDetails"
Cohesion: 0.22
Nodes (6): RoadmapData, RoadmapPage(), StageConfig, StageData, STAGES_CONFIG, TimelineItem()

### Community 336 - "ImplementerPhase1Fichas.tsx"
Cohesion: 0.22
...
Cohesion: 0.09
Nodes (61): AREA_STAGE_OUTCOME, AreaJourneyRow(), formatDateTime(), matchesSlaCardFilter(), SLA_FILTER_LABELS, SlaCardFilter, SlaCheckpointCell(), TicketSlaRow() (+53 more)

### Community 342 - "usePosAiProjectSummary.ts"
Cohesion: 0.27
...
### Community 343 - "4. Projetos OrionTN"
Cohesion: 0.29
...
### Community 344 - "Dashboard Executivo (Analytics)"
Cohesion: 0.29
...
Cohesion: 0.25
Nodes (7): PosAiVisitorAnalyticsProps, EMPTY_DATA, PosAiVisitorAnalyticsData, PosAiVisitorAnalyticsKpis, PosAiVisitorAnalyticsSector, PosAiVisitorAnalyticsUser, analytics
...
Cohesion: 0.19
Nodes (15): AdherenceStageForm(), AdherenceStageFormProps, useActiveTemplate(), ProjectFormResponse, UpsertResponseInput, useProjectFormResponse(), useUpsertFormResponse(), extractUrlsFromValue() (+7 more)

### Community 351 - "ImplementerCharts.tsx"
Cohesion: 0.28
Nodes (9): TicketsAiAnalysisProps, TicketsSlaAnalysisProps, TicketsSlaSectorAnalysisProps, Chamado0800DetailDialogProps, ChamadosSearchFilters, ChamadosCatalog, ChamadosReportFilters, TicketsSlaReportFilters (+1 more)
...
### Community 354 - "CsCxReports"
Cohesion: 0.10
Nodes (41): StatusFilter, AttentionFilter, AttentionStatus, STATUS_META, ArticleMetadataCard(), ArticleNavigator(), MarkdownTiptapEditorProps, RestoreVersionModal() (+33 more)

### Community 355 - "Relatórios & Análises"
Cohesion: 0.29
...
### Community 356 - "4. Homologação de Conversões"
Cohesion: 0.06
Nodes (40): ConversionPostDrawer(), ConversionPostDrawerProps, STATUS_LABELS, ProjectModal(), RoadmapManager(), Chamado0800Tab(), EditProjectTab(), FilesTab() (+32 more)

### Community 357 - "sd-attendance-bi.test.ts"
Cohesion: 0.29
Nodes (6): app, hook, menu, migration, page, permissionCatalog

### Community 358 - "ImplementerCharts.tsx"
Cohesion: 0.31
...
Cohesion: 0.14
Nodes (22): lexical, AiRichTextField(), messageOf(), appendPlainTextToLexicalJson(), hasRichTextContent(), LexicalNode, lexicalNodeToPlainText(), listItemNode() (+14 more)
...
### Community 361 - "useCsCxAccess.ts"
Cohesion: 0.24
...
### Community 367 - "5. Contatos & Clientes"
Cohesion: 0.40
Nodes (4): name, private, type, version

### Community 370 - "chamados-date-range.ts"
Cohesion: 0.70
Nodes (3): getDefaultChamadosDateRange(), needsHistoricalChamadosSync(), toLocalIsoDate()

### Community 371 - "CsCxReports"
Cohesion: 0.29
Nodes (6): CsCxReports(), formatDateOnly(), formatDateTime(), formatMonth(), messageOf(), validColor()
...
### Community 376 - "ImplementerCharts.tsx"
Cohesion: 0.29
Nodes (7): healthColors, healthLabels, ImplementerCharts(), ImplementerChartsProps, statusColors, statusLabels, StageRadarEntry

### Community 377 - "chart.tsx"
Cohesion: 0.25
Nodes (5): ChartConfig, ChartContext, ChartContextProps, ChartLegendContent, THEMES

### Community 378 - "compilerOptions"
Cohesion: 0.50
Nodes (3): compilerOptions, allowJs, lib

### Community 381 - "6. Formulários de Implantação"
Cohesion: 0.29
...
### Community 400 - "1. Painel de Implantadores (hub)"
Cohesion: 0.29
...
### Community 401 - "3. Aderências Finalizadas"
Cohesion: 0.29
...
### Community 402 - "StageStatus"
Cohesion: 0.07
Nodes (44): ProjectStatusChart(), ProjectStatusChartProps, STATUS_LABELS, STAGE_LABELS, CompactQueueCard(), STATUS_COLORS, STATUS_LABELS, ProjectDistributionChart() (+36 more)

### Community 403 - "5. Roteiro de Treinamento (Placeholder)"
Cohesion: 0.29
...
### Community 404 - "key"
Cohesion: 0.29
Nodes (7): auditSpec(), key(), parseLegacyJson(), requiredMap(), AdminSettings(), useAdminSettings(), NextDeployments()

### Community 405 - "ImplementerPhaseMetrics.tsx"
Cohesion: 0.13
...
### Community 407 - "ObservationsWithAI"
Cohesion: 0.38
Nodes (6): ObservationsWithAI(), obsTextLen(), walkText(), mapJob(), TEXT_JOB_TYPES, useImproveTextJobs()

### Community 408 - "Módulo Comercial — Documentação por Tela"
Cohesion: 0.40
Nodes (4): Acesso ao grupo, Fontes de dados compartilhadas, Módulo Comercial — Documentação por Tela, Índice

### Community 409 - "ImplementerPDFExport.tsx"
Cohesion: 0.67
Nodes (3): ImplementerPDFExport(), ImplementerPDFExportProps, ImplementerReportData

### Community 410 - "CsCxContacts"
Cohesion: 0.21
Nodes (12): AttentionRow, ContactAttentionDashboardProps, OfficeFilterCombobox(), CsCxRegistryOffice, CsCxContact, contactIdentity(), contactTimestamp(), deduplicateAppointmentContacts() (+4 more)

### Community 412 - "sd-time-import.test.ts"
Cohesion: 0.50
Nodes (3): page, sqlView, worker

### Community 414 - "ImplementerInvolvement"
Cohesion: 0.67
Nodes (3): ImplementerOtherStagesProps, ImplementerProjectsListProps, ImplementerInvolvement

### Community 415 - "PhaseMetrics"
Cohesion: 0.67
Nodes (3): ImplementerPhaseMetricsProps, PhaseCardProps, PhaseMetrics

## Knowledge Gaps
- **2684 isolated node(s):** `{ chromium, firefox, webkit }`, `name`, `version`, `description`, `author` (+2679 more)
...
- **Why does `cn()` connect `Deployment Form Fields` to `Conversion Post Feed & Drawer`, `Project Stage Forms & Models`, `Charts, KPI & Reports`, `Notification Bell & Dropdown`, `Calendar Grid & Drag-Drop`, `GEMINI.md`, `Adherence Form Renderer`, `Sidebar Components`, `StageStatus`, `App Sidebar & Protected Route`, `useAuth`, `CsCxContacts`, `use-toast Reducer`, `5. Contatos & Clientes`, `7. Checklists de Implantação`, `Deployment Template & Stage Forms`, `Theme Provider`, `LogsTab.tsx`, `Health Badge & Pipeline Status`, `usePublicChecklist.ts`, `CsCxRegistryOffices.tsx`, `Página 404 (Not Found)`, `Toggle Component`, `SolutionsSearch.tsx`, `AuthContext.tsx`, `lexical.ts`, `Próximas Implantações`, `Login`, `CopilotChat.tsx`, `DeploymentFormFields.tsx`, `useCsCxNpsSurveys.ts`, `CsCxRegistryOffices`, `sheet.tsx`, `processJob.ts`, `formatLogDetails`, `usePosPanorama.ts`, `CsCxReports`, `4. Homologação de Conversões`, `cs-cx-routines-report.test.ts`, `🗄️ Configuração Local do Supabase (Ambiente de Desenvolvimento)`, `useCsCxAccess.ts`, `chart.tsx`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `err()` connect `VM Worker Job Queue` to `Charts, KPI & Reports`, `Notification Bell & Dropdown`, `GEMINI.md`, `Adherence Form Renderer`, `App Sidebar & Protected Route`, `ObservationsWithAI`, `ImplementerPDFExport.tsx`, `Deployment Form Fields`, `Main Layout & Theme Toggle`, `Post Observations Editor`, `Theme Provider`, `LogsTab.tsx`, `chamadosSync.ts`, `usePublicChecklist.ts`, `CsCxRegistryOffices.tsx`, `Improve-Text AI Jobs`, `package.json`, `DeploymentFormFields.tsx`, `index.ts`, `processJob.ts`, `pos-chat-visitor-dialog.test.tsx`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `Button` connect `CsCxReports` to `Conversion Post Feed & Drawer`, `Checklist & Visual Question Builder`, `Project Stage Forms & Models`, `Charts, KPI & Reports`, `filterStore.ts`, `Calendar Grid & Drag-Drop`, `GEMINI.md`, `Adherence Form Renderer`, `Sidebar Components`, `Módulo: Calendário, Agenda, Analytics, Relatórios, Roadmap e Implantações`, `StageStatus`, `Deployment Form Fields`, `ImplementerPDFExport.tsx`, `Main Layout & Theme Toggle`, `Deployment Template & Stage Forms`, `Theme Provider`, `TicketsAiAnalysis.tsx`, `PipelineStatus.tsx`, `LogsTab.tsx`, `usePublicChecklist.ts`, `CsCxRegistryOffices.tsx`, `project-transformers.ts`, `SolutionsSearch.tsx`, `Agenda dos Analistas`, `lexical.ts`, `Próximas Implantações`, `Login`, `CopilotChat.tsx`, `package.json`, `SolutionDetails.tsx`, `DeploymentFormFields.tsx`, `sheet.tsx`, `processJob.ts`, `usePosPanorama.ts`, `AdminSettings.tsx`, `pos-chat-visitor-dialog.test.tsx`, `4. Homologação de Conversões`, `🗄️ Configuração Local do Supabase (Ambiente de Desenvolvimento)`, `Página 404 (Not Found)`?**
