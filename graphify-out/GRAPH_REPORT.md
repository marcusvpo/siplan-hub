...
## Corpus Check
- 924 files · ~1,044,113 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5891 nodes · 13264 edges · 412 communities (312 shown, 100 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 185 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `98f6d1c3`
...
## Communities (412 total, 100 thin omitted)
...
Cohesion: 0.05
Nodes (69): CalendarLegend(), DeploymentDetailsDialog(), StageCard(), AdherenceStageForm(), EnvironmentStageForm(), ImplementationStageForm(), ProjectModal(), FilesTab() (+61 more)

### Community 8 - "Charts, KPI & Reports"
Cohesion: 0.15
Nodes (25): Chamado0800DetailDialog(), fmtDateBr(), fmtDateTimeBr(), formatTicketDuration(), statusBadgeClass(), PostChamados0800(), PostChamados0800Props, PosAiAssistantSection() (+17 more)
...
Cohesion: 0.07
Nodes (33): AppSidebar(), UserProfileDrawer(), ProtectedRoute(), Sidebar, SidebarContent, SidebarContext, SidebarFooter, SidebarGroup (+25 more)
...
Cohesion: 0.09
Nodes (26): ChartEmptyState(), ChartEmptyStateProps, DashboardKPI(), DashboardKPIProps, DashboardReport(), DashboardReportProps, ProjectDetailsModal(), ProjectDistributionChart() (+18 more)

### Community 18 - "App Sidebar & Protected Route"
Cohesion: 0.10
Nodes (27): entryEvidence(), OUTCOME_DISPLAY, RESULT_FILTER_LABELS, SectorResultFilter, TicketsSlaSectorAnalysis(), stage(), fetchChamadosTramites(), normalizeTicketText() (+19 more)
...
Cohesion: 0.12
Nodes (30): SolutionForm(), DeleteTarget, errorCode(), systemNameCollator, SystemsManager(), attachmentStorageName(), createSdRoutine(), createSdSolution() (+22 more)

### Community 26 - "Project Transformers & Stages"
Cohesion: 0.06
Nodes (56): dateFormatter, integerFormatter, usdFormatter, ProjectStatusChart(), ProjectStatusChartProps, STATUS_LABELS, formatAction(), RecentActivity() (+48 more)

### Community 27 - "use-toast Reducer"
Cohesion: 0.06
Nodes (45): CriticalAlertsProps, ProjectDetailsModalProps, TimelineChartProps, DeploymentCard(), DeploymentCardProps, DeploymentDetailsDialogProps, ProjectHeaderForm(), ProjectHeaderFormProps (+37 more)

### Community 28 - "Project Modal & Kanban"
Cohesion: 0.09
Nodes (28): AttentionRow, ContactAttentionDashboardProps, CS_CX_REQUEST_STATUSES, CsCxOfficeProduct, CsCxOfficeResponsible, CsCxProductResponsible, CsCxRegistryOffice, CsCxRequestInput (+20 more)
...
Cohesion: 0.12
Nodes (19): NOTIFICATION_TYPE_ICONS, DropdownMenuContent, DropdownMenuItem, DropdownMenuLabel, DropdownMenuSeparator, DropdownMenuShortcut(), DropdownMenuSubContent, DropdownMenuSubTrigger (+11 more)
...
Cohesion: 0.17
Nodes (23): EnvironmentStageFormProps, useProjectDetails(), useProjectsV2(), useTimeline(), CompareProjects(), OrionTNDashboard(), LatestDeployments(), ProjectDetails() (+15 more)
...
Cohesion: 0.14
Nodes (15): AdvancedFilters(), ProjectGrid(), ProjectTagsLegendDialog(), useConversionQueue(), normalizeText(), OrionTNProjects(), defaultFilters, FilterState (+7 more)
...
Cohesion: 0.07
Nodes (62): SearchableClientSelectProps, CompactQueueCard(), ConversionPostDrawerProps, STATUS_LABELS, CsCxMultiSelectOption, CsCxMultiSelectProps, KPICard(), KPICardProps (+54 more)
...
Cohesion: 0.06
Nodes (57): PosAiChatLinksManager(), PAGE_SIZE_OPTIONS, SearchableClientOption, SearchableClientSelect(), BunnyVideoModal(), UnsavedChangesDialogProps, EditableCellProps, StatusType (+49 more)
...
Cohesion: 0.17
Nodes (24): formatDate(), HighlightedText(), SolutionCard(), SolutionsSearch(), filterSdSolutions(), groupSdSolutionsByFamily(), normalizedTextMap(), normalizeSdSearch() (+16 more)
...
Cohesion: 0.16
Nodes (7): DeploymentFormFields(), formatPhone(), RadioGroup, RadioGroupItem, checklists, forms, {
...
Cohesion: 0.14
Nodes (18): BenchmarkPos, Chamados0800Result, ChamadosClientOption, checkPosCriticosAbertos(), createChamadosSearchQuery(), fetchUltimosTramites(), mapChamado0800(), mapChamadoTramite() (+10 more)
...
Cohesion: 0.09
Nodes (34): err(), getEditorContent(), ObservationsWithAI(), ObservationsWithAIProps, obsTextLen(), walkText(), fmt(), getSpeechRecognition() (+26 more)

### Community 184 - "Login"
Cohesion: 0.04
Nodes (58): project, EnvironmentScreenshotsProps, AdherenceStageFormProps, ConversionStageFormProps, ImplementationStageFormProps, InfraStageFormProps, formatStepTime(), ModelosEditorWorkspace() (+50 more)

### Community 185 - "CsCxReports.tsx"
Cohesion: 0.17
Nodes (8): useAuditLogs(), actionLabels, AuditLogPage(), formatLogDetails(), formatValue(), isUUID(), translateValue(), ActivityLogger

### Community 186 - "package.json"
Cohesion: 0.10
Nodes (17): Breadcrumbs(), ContextualHeaderAction, getContextualHeaderAction(), matchesPath(), MainLayout(), MainLayoutProps, usePwaInstall(), PwaInstallButton() (+9 more)
...
Cohesion: 0.21
Nodes (12): Props, VersionHistoryDrawer(), ImplementationPhaseForm(), DeploymentFormRecord, useDeploymentForms(), CommercialChecklists(), validateForm(), check() (+4 more)
...
Cohesion: 0.09
Nodes (26): CriticalAlerts(), DashboardTable(), DashboardTableProps, HealthBadge(), HealthBadgeProps, PipelineStatus(), PipelineStatusProps, ButtonProps (+18 more)
...
Cohesion: 0.05
Nodes (34): AdminSettings(), DEFAULT_HEALTH_SETTINGS, ProjectHealthSettings, useAdminSettings(), useStorageStats(), AiTextImprovementJob, mapJob(), useAiTextImprovement() (+26 more)
...
Cohesion: 0.06
Nodes (75): StatusFilter, ChecklistEditor(), ChecklistEditorProps, SYSTEM_TYPES, ConversionIssuesTab(), ConversionIssuesTabProps, PRIORITIES, STATUSES (+67 more)
...
Cohesion: 0.18
Nodes (14): storage, event, PwaInstallContext, PwaInstallContextValue, BeforeInstallPromptEvent, isIosDevice(), isMobileViewport(), isPublicExperience() (+6 more)

### Community 305 - "cs-cx-nps-analytics.ts"
Cohesion: 0.06
Nodes (53): copyText(), formatDate(), NpsInvitationsPanel(), NpsQuestionnairesPanel(), NpsThemePreview(), QUESTION_TYPES, questionTypeLabel(), CreateNpsInvitationInput (+45 more)
...
Cohesion: 0.11
Nodes (26): isProcessoVendaSyncSupersededError(), useChamadosClientOptions(), useSolicitarSyncProcessoVenda(), CHAMADOS_CATALOG_CONFIG, CHAMADOS_LEGACY_PRODUCT_GROUPS, formatChamadosProductLabel(), getCatalogSoftwarePattern(), getChamadosProductLabel() (+18 more)
...
Cohesion: 0.13
Nodes (13): CompactQueueCardProps, ProjectInfo, ProjectInfoSection(), ProjectInfoSectionProps, ConversionEngineItem, EngineKPIs, EngineStatus, useConversionEngines() (+5 more)
...
Cohesion: 0.22
Nodes (8): SolutionDetailsProps, SolutionFormProps, SolutionCardProps, SolutionsSearchProps, SdFamilyGroup, serviceMocks, solution, SdSolucao

### Community 332 - "useCsCxAccess.ts"
Cohesion: 0.04
Nodes (59): AttentionFilter, AttentionStatus, ContactAttentionDashboard(), filterForStatus(), formatDate(), formatElapsedDays(), matchesAttentionFilter(), officeResponsible() (+51 more)
...
Cohesion: 0.15
Nodes (39): AREA_STAGE_OUTCOME, AreaJourneyRow(), formatDateTime(), matchesSlaCardFilter(), SLA_FILTER_LABELS, SlaCardFilter, SlaCheckpointCell(), TicketSlaRow() (+31 more)
...
Cohesion: 0.33
Nodes (5): families, serviceMocks, solutions, systems, SdFamilia
...
Cohesion: 0.06
Nodes (55): emptyInterval(), TimeEntryDialog(), TimeEntryDialogProps, DropdownMenuCheckboxItem, useDebounce(), AutoSaveConfig, SaveState, useAutoSave() (+47 more)
...
## Knowledge Gaps
- **2720 isolated node(s):** `{ chromium, firefox, webkit }`, `name`, `version`, `description`, `author` (+2715 more)
...
- **Why does `cn()` connect `usePublicChecklist.ts` to `Conversion Post Feed & Drawer`, `Checklist & Visual Question Builder`, `Project Stage Forms & Models`, `Charts, KPI & Reports`, `Notification Bell & Dropdown`, `Calendar Grid & Drag-Drop`, `GEMINI.md`, `FormRenderer.tsx`, `Sidebar Components`, `Dashboard Table & Pagination`, `App Sidebar & Protected Route`, `Project Transformers & Stages`, `5. Roteiro de Treinamento (Placeholder)`, `use-toast Reducer`, `Predictability & Bottlenecks`, `Main Layout & Theme Toggle`, `5. Contatos & Clientes`, `Post Observations Editor`, `sd-solutions.ts`, `ProtectedRoute.tsx`, `Roadmap Page`, `LogsTab.tsx`, `useTeams.ts`, `CsCxRegistryOffices.tsx`, `Toggle Component`, `cs-cx-nps-analytics.ts`, `Roadmap do Cliente (Portal Público)`, `Últimas Implantações`, `Login`, `ProjectCardV3.tsx`, `package.json`, `CopilotChat.tsx`, `index.ts`, `sheet.tsx`, `useCsCxAccess.ts`, `formatLogDetails`, `Módulo Comercial — Documentação por Tela`, `usePosPanorama.ts`, `cs-cx-engagement-permissions.test.tsx`, `🗄️ Configuração Local do Supabase (Ambiente de Desenvolvimento)`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `err()` connect `Últimas Implantações` to `Conversion Post Feed & Drawer`, `Checklist & Visual Question Builder`, `Project Stage Forms & Models`, `Charts, KPI & Reports`, `Notification Bell & Dropdown`, `GEMINI.md`, `Sidebar Components`, `Roadmap Page`, `Deployment Template & Stage Forms`, `LogsTab.tsx`, `chamadosSync.ts`, `CsCxRegistryOffices.tsx`, `Improve-Text AI Jobs`, `Login`, `cs-cx-nps-survey.ts`, `TransicaoPlaceholder`, `index.ts`, `cs-cx-engagement-permissions.test.tsx`, `Módulo: Núcleo — Dashboard e Projetos`, `pos-chat-visitor-dialog.test.tsx`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `ProjectV2` connect `use-toast Reducer` to `sd-solutions.ts`, `ProtectedRoute.tsx`, `Roadmap Page`, `Project Stage Forms & Models`, `Charts, KPI & Reports`, `Theme Provider`, `useCsCxAccess.ts`, `usePublicChecklist.ts`, `CsCxRegistryOffices.tsx`, `RolesManagement.tsx`, `Toggle Component`, `Dashboard Table & Pagination`, `Login`, `Project Transformers & Stages`, `Commercial/Public Checklists`?**
