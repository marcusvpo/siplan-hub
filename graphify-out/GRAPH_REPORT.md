...
## Corpus Check
- 546 files · ~744,101 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3967 nodes · 7550 edges · 305 communities (236 shown, 69 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 86 edges (avg confidence: 0.66)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8d10acda`
...
## Communities (305 total, 69 thin omitted)
...
Cohesion: 0.09
Nodes (17): CompactQueueCardProps, ProjectInfo, ProjectInfoSection(), ProjectInfoSectionProps, ConversionKPIs, ConversionQueueItem, UseConversionQueueOptions, AuditLogPage() (+9 more)

### Community 4 - "VM Worker Job Queue"
Cohesion: 0.06
Nodes (77): cleanNomeCliente(), decodeDescricao(), mapRow(), ProjectRow, resolvePendingRequests(), runOnce(), startChamadosSync(), toIsoDate() (+69 more)
...
Cohesion: 0.05
Nodes (44): EnvironmentScreenshotsProps, AdherenceStageFormProps, EnvironmentStageFormProps, InfraStageFormProps, ModelosEditorWorkspaceProps, ProjectGrid(), mapJob(), useModelGenerationJobs() (+36 more)

### Community 8 - "Charts, KPI & Reports"
Cohesion: 0.09
Nodes (37): ProjectStatusChart(), ProjectStatusChartProps, STATUS_LABELS, formatAction(), RecentActivity(), AdminSettings(), STAGE_LABELS, CustomTheme (+29 more)
...
Cohesion: 0.14
Nodes (19): DashboardTable(), DashboardTableProps, ButtonProps, buttonVariants, Calendar(), CalendarProps, Pagination(), PaginationContent (+11 more)

### Community 18 - "App Sidebar & Protected Route"
Cohesion: 0.28
Nodes (15): useProjectDetails(), ProjectDetails(), ProjectTramite, calculateHealthScore(), formatDateForDB(), mapAdherenceStage(), mapConversionStage(), mapEnvironmentStage() (+7 more)
...
Cohesion: 0.12
Nodes (25): CalendarLegend(), ConversionPostDrawer(), ConversionPostDrawerProps, STATUS_LABELS, UserProfileDrawerProps, DeploymentDetailsDialog(), DialogContent, DialogDescription (+17 more)
...
Cohesion: 0.26
Nodes (9): RoadmapManager(), Chamado0800Tab(), EditProjectTab(), LogsTab(), Skeleton(), TabsContent, TabsList, TabsTrigger (+1 more)

### Community 27 - "use-toast Reducer"
Cohesion: 0.16
Nodes (21): jspdf, AiTarget, Block, blockTextLen(), blockToPlain(), escapeHtml(), fmtDate(), inlineHtml() (+13 more)

### Community 28 - "Project Modal & Kanban"
Cohesion: 0.13
Nodes (26): CollapsibleFieldSection(), CollapsibleFieldSectionProps, EnvironmentScreenshots(), sanitize(), getEditorContent(), ObservationsWithAI(), ObservationsWithAIProps, obsTextLen() (+18 more)

### Community 29 - "Commercial/Public Checklists"
Cohesion: 0.16
Nodes (28): EditableCellProps, Input, Label, labelVariants, Table, TableBody, TableCaption, TableCell (+20 more)

### Community 30 - "Commercial Page & Hooks"
Cohesion: 0.09
Nodes (22): ProjectDetailsModalProps, TimelineChartProps, DeploymentCard(), DeploymentCardProps, DeploymentDetailsDialogProps, ProjectHeaderForm(), ProjectHeaderFormProps, ProjectCardV3Props (+14 more)
...
Cohesion: 0.17
Nodes (17): StageCardProps, ProjectCardV3(), StepsTab(), AccordionContent, AccordionItem, AccordionTrigger, BottleneckIssue, getBottleneckColor() (+9 more)
...
Cohesion: 0.11
Nodes (21): CompactQueueCard(), STATUS_COLORS, STATUS_LABELS, ConversionPostFeed(), ConversionPostFeedProps, formatPostDate(), getInitials(), groupPostsByDate() (+13 more)

### Community 35 - "Post Observations Editor"
Cohesion: 0.15
Nodes (12): AdherenceGapCard(), AdherenceGapCardProps, GlobalMetrics(), HealthDistribution(), HealthDistributionProps, IndividualProjectReport(), ReportsFilters(), StatusDistribution() (+4 more)
...
Cohesion: 0.05
Nodes (68): ProjectDetailsModal(), TimelineChart(), AppSidebar(), UserProfileDrawer(), ModeToggle(), NewProjectDialog(), NotificationBell(), SortableThumb() (+60 more)
...
Cohesion: 0.10
Nodes (47): ConversionIssuesTabProps, PRIORITIES, STATUSES, COLORS, FONT_SIZES, NOTIFICATION_TYPE_ICONS, AdvancedFilters(), AdvancedFiltersProps (+39 more)
...
Cohesion: 0.03
Nodes (59): dependencies, canvas-confetti, class-variance-authority, clsx, cmdk, date-fns, @dnd-kit/core, @dnd-kit/sortable (+51 more)
...
Cohesion: 0.05
Nodes (35): react, DeploymentFormFields(), Props, AdherenceImpactSummary(), AdherenceQuestionField(), AdherenceQuestionValue, ArrayFieldTemplateItem, checkHasAdherenceQuestions() (+27 more)
...
Cohesion: 0.10
Nodes (30): ChecklistEditor(), ChecklistEditorProps, SYSTEM_TYPES, convertVisualToJSONSchema(), convertVisualToUISchema(), parseJSONSchemaToVisual(), VisualQuestion, VisualQuestionBuilder() (+22 more)

### Community 141 - "Coleta Pública de Infraestrutura"
Cohesion: 0.24
Nodes (11): StageCard(), EnvironmentStageForm(), ImplementationPhaseForm(), ImplementationStageForm(), ImplementationStageFormProps, PhaseFormProps, convertBlocksToTiptap(), MyQueueDetailedCard() (+3 more)
...
### Community 184 - "Login"
Cohesion: 0.27
Nodes (12): fmtDate(), PostChamados0800(), PostChamados0800Props, statusBadgeClass(), Chamado0800, Chamados0800Result, mapChamado(), normalizeProduto() (+4 more)

### Community 185 - "ImplementationStageV2"
Cohesion: 0.27
Nodes (8): Breadcrumbs(), useProjectsV2(), useTimeline(), OrionTNDashboard(), OrionTNProjects(), NextDeployments(), AuditEntry, resolveResponsibleIds()
...
Cohesion: 0.17
Nodes (18): err(), ConversionIssuesTab(), fmt(), getSpeechRecognition(), pickMimeType(), VoiceDictationButton(), VoiceDictationButtonProps, useConversionEngines() (+10 more)
...
## Knowledge Gaps
- **2165 isolated node(s):** `{ chromium, firefox, webkit }`, `name`, `version`, `description`, `author` (+2160 more)
...
- **Why does `cn()` connect `Admin Stats & RBAC Hooks` to `Conversion Post Feed & Drawer`, `FormRenderer.tsx`, `Charts, KPI & Reports`, `Calendar Grid & Drag-Drop`, `chart.tsx`, `Coleta Pública de Infraestrutura`, `Sidebar Components`, `Adherence Form Renderer`, `Custom Widgets & Sheet`, `Dashboard Table & Pagination`, `Commercial & Conversion Hooks`, `Distribution/Workload Charts`, `Project Transformers & Stages`, `use-toast Reducer`, `Project Modal & Kanban`, `Commercial/Public Checklists`, `Commercial Page & Hooks`, `Predictability & Bottlenecks`, `Main Layout & Theme Toggle`, `Post Observations Editor`, `Roadmap Page`, `Deployment Template & Stage Forms`, `CopilotChat`, `LogsTab.tsx`, `editor.tsx`, `PipelineStatus.tsx`, `usePublicChecklist.ts`, `Health Badge & Pipeline Status`, `Login`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `dependencies` connect `Auth Context` to `FormRenderer.tsx`, `DeploymentFormFields.tsx`, `Custom Widgets & Sheet`, `package.json`, `use-toast Reducer`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `err()` connect `LogsTab.tsx` to `VM Worker Job Queue`, `Admin Stats & RBAC Hooks`, `FormRenderer.tsx`, `Project Stage Forms & Models`, `Notification Bell & Dropdown`, `Health Badge & Pipeline Status`, `useAuth.ts`, `Coleta Pública de Infraestrutura`, `Improve-Text AI Jobs`, `Custom Widgets & Sheet`, `Distribution/Workload Charts`, `use-toast Reducer`?**
