...
## Corpus Check
- 837 files · ~983,027 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5470 nodes · 12096 edges · 398 communities (308 shown, 90 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 166 edges (avg confidence: 0.72)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `66865113`
...
Cohesion: 0.18
Nodes (14): Bloco, escapeHtml(), MarkdownLite(), markdownLiteToHtml(), parseBlocos(), renderInline(), usePanoramaParecer(), diasDesde() (+6 more)
...
Cohesion: 0.10
Nodes (20): EnvironmentStageForm(), formatDateTime(), latestTramiteText(), text(), RoutineObservationsPreview(), CopilotJob, DtcJob, getCodexBin() (+12 more)
...
Cohesion: 0.29
Nodes (7): mapJob(), useDtcAiJobs(), dtcStatusToStageStatus(), formatPhoneNumber(), getLexicalTextLength(), renderVal(), TransicaoPlaceholder()

### Community 7 - "Project Stage Forms & Models"
Cohesion: 0.11
Nodes (18): PosAiAssistantSection(), DEFAULT_HEALTH_SETTINGS, ProjectHealthSettings, useStorageStats(), ConversionEngineItem, EngineKPIs, EngineStatus, ConversionIssue (+10 more)

### Community 8 - "Charts, KPI & Reports"
Cohesion: 0.06
Nodes (60): data, OverviewChart(), ProjectStatusChart(), ProjectStatusChartProps, STATUS_LABELS, formatAction(), RecentActivity(), AdminSettings() (+52 more)
...
Cohesion: 0.06
Nodes (32): Breadcrumbs(), MainLayout(), MainLayoutProps, NotificationBell(), Sidebar, SidebarContent, SidebarContext, SidebarFooter (+24 more)
...
Cohesion: 0.17
Nodes (20): buildPrompt(), classifyPendingChamados(), NATUREZAS_SEM_TEMA, parseResult(), PendingRow, config, buildImprovePrompt(), buildNpsAnalysisPrompt() (+12 more)

### Community 17 - "Dashboard Table & Pagination"
Cohesion: 0.07
Nodes (32): DashboardTable(), DashboardTableProps, HealthBadge(), HealthBadgeProps, PipelineStatus(), PipelineStatusProps, Editor(), editorConfig (+24 more)
...
Cohesion: 0.16
Nodes (15): ImplementerAllCartoriosTableProps, ImplementerPhaseMetricsProps, PhaseCardProps, ImplementerReportTab(), daysBetween(), DetailedInvolvement, fmtDateShort(), generateProjectBullets() (+7 more)
...
Cohesion: 0.05
Nodes (45): EnvironmentScreenshotsProps, AdherenceStageFormProps, ConversionStageFormProps, EnvironmentStageFormProps, ImplementationStageFormProps, PhaseFormProps, InfraStageFormProps, ProjectRow (+37 more)
...
Cohesion: 0.15
Nodes (23): UnsavedChangesDialogProps, PosChatHistorySidebar(), PosChatHistorySidebarProps, getEditorContent(), ObservationsWithAI(), ObservationsWithAIProps, obsTextLen(), walkText() (+15 more)

### Community 26 - "Project Transformers & Stages"
Cohesion: 0.16
Nodes (16): clamp(), FloatingCopilot(), maxWidth(), RestoreVersionModal(), RestoreVersionModalProps, VersionDetailModal(), VersionDetailModalProps, VersionHistoryDrawerProps (+8 more)
...
Cohesion: 0.13
Nodes (23): CollapsibleFieldSection(), CollapsibleFieldSectionProps, ConversionStageForm(), ImplementationStageForm(), formatStepTime(), ModelosEditorWorkspace(), ModelosEditorWorkspaceProps, ModelosMetrics() (+15 more)

### Community 30 - "Commercial Page & Hooks"
Cohesion: 0.43
Nodes (6): StageCard(), ImplementationPhaseForm(), check(), generateDeploymentTemplate(), v(), yn()
...
Cohesion: 0.08
Nodes (51): ConversionPostDrawer(), ConversionPostDrawerProps, STATUS_LABELS, CsCxMultiSelectOption, CsCxMultiSelectProps, MarkdownTiptapEditorProps, NewProjectDialog(), ProjectModal() (+43 more)
...
Cohesion: 0.18
Nodes (22): formatDate(), HighlightedText(), SolutionCard(), SolutionsSearch(), filterSdSolutions(), groupSdSolutionsByFamily(), normalizedTextMap(), normalizeSdSearch() (+14 more)
...
Cohesion: 0.19
Nodes (15): CHAMADOS_CATALOG_CONFIG, CHAMADOS_LEGACY_PRODUCT_GROUPS, formatChamadosProductLabel(), getCatalogSoftwarePattern(), getChamadosProductLabel(), isLegacyFamily(), LEGACY_PRODUCT_FAMILIES, CHAMADOS_ORION_PRODUCTS (+7 more)
...
Cohesion: 0.22
Nodes (12): AppSidebar(), UserProfileDrawer(), ProtectedRoute(), useAuth(), CopilotAccess, CopilotJob, mapAccess(), mapJob() (+4 more)
...
Cohesion: 0.09
Nodes (38): NpsQuestionnairesPanel(), NpsThemePreview(), QUESTION_TYPES, questionTypeLabel(), darkenNpsThemeColor(), DEFAULT_NPS_QUESTIONS, DEFAULT_NPS_THEME, isHexColor() (+30 more)
...
Cohesion: 0.08
Nodes (47): PosAiChatLinksManager(), StatusFilter, dateFormatter, integerFormatter, usdFormatter, CsCxMultiSelect(), MarkdownTiptapEditor(), UserProfileDrawerProps (+39 more)
...
Cohesion: 0.21
Nodes (9): ImplementerAllCartoriosTable(), ImplementerKPIs(), ImplementerKPIsProps, ImplementerPhase1ConsolidatedTable(), ImplementerPhaseMetrics(), ImplementerSignaturesBlock(), ImplementerStageAnalysis(), ImplementerStageAnalysisProps (+1 more)
...
Cohesion: 0.11
Nodes (18): 4. Central de Bloqueios, 5. Contatos & Clientes, Acesso ao grupo, Componentes principais, Componentes principais, Dados e Hooks, Dados e Hooks, Fluxos e Interações (+10 more)
...
### Community 184 - "Login"
Cohesion: 0.15
Nodes (24): Chamado0800DetailDialog(), fmtDateBr(), fmtDateTimeBr(), formatTicketDuration(), statusBadgeClass(), PostChamados0800(), PostChamados0800Props, bucketNatureza() (+16 more)
...
Cohesion: 0.06
Nodes (50): CS_CX_APPOINTMENT_STATUSES, CS_CX_APPOINTMENT_TYPES, CsCxAppointment, CsCxAppointmentInput, CsCxContact, CsCxContactInput, CsCxProfileOption, currentUser() (+42 more)
...
Cohesion: 0.04
Nodes (80): CalendarControls(), CalendarLegend(), CompactQueueCard(), STATUS_COLORS, STATUS_LABELS, DashboardKPI(), DashboardKPIProps, DashboardReport() (+72 more)

### Community 233 - "calendar.tsx"
Cohesion: 0.12
Nodes (23): apply, args, auditSpec(), autoLinkProfiles(), bulkUpsert(), key(), loadMaps(), mapArg (+15 more)

### Community 295 - "ProtectedRoute.tsx"
Cohesion: 0.07
Nodes (45): ConversionIssuesTabProps, PRIORITIES, STATUSES, NewPostForm(), STAGE_OPTIONS, CopilotChatProps, SUGESTOES, EMPTY_PROFILE (+37 more)
...
Cohesion: 0.12
Nodes (29): jspdf, STATUS_COLORS, TicketsAiAnalysis(), tooltipStyle, truncate(), Chamado0800, ChamadoReportRow, fetchAllChamados() (+21 more)

### Community 298 - "LogsTab.tsx"
Cohesion: 0.09
Nodes (19): canAccessCsCxRecord(), CsCxOwnedResource, useCsCxRecordPermissions(), answerLabel(), ContactReadOnlyDetails(), CsCxContacts(), DataError(), errorMessage() (+11 more)
...
Cohesion: 0.31
Nodes (15): generateCsCxPdfReport(), buildCsCxRoutinesWorkbook(), buildRoutineReportAnalytics(), formatDateTime(), generateCsCxRoutinePdf(), generateCsCxRoutinesPdf(), generateCsCxRoutinesXlsx(), localIsoDate() (+7 more)
...
Cohesion: 0.11
Nodes (20): SolutionDetailsProps, SolutionFormProps, SolutionCardProps, SolutionsSearchProps, SdFamilyGroup, serviceMocks, solution, families (+12 more)
...
Cohesion: 0.15
Nodes (18): CsCxVisit, calculateCsCxReportRowLayout(), clean(), CsCxPdfOutputOptions, CsCxReportRow, CsCxReportRowLayout, CsCxSummaryItem, formatDate() (+10 more)
...
Cohesion: 0.22
Nodes (10): err(), mapPost(), RawPost, useConversionPosts(), HomologationEvent, mapEvent(), RawEvent, useHomologationEvents() (+2 more)

### Community 313 - "useCsCxCore.ts"
Cohesion: 0.08
Nodes (36): CS_CX_REQUEST_STATUSES, CsCxOfficeProduct, CsCxOfficeResponsible, CsCxProductResponsible, CsCxRegistryOffice, CsCxRequest, CsCxRequestInput, CsCxRequestStatus (+28 more)
...
Cohesion: 0.11
Nodes (18): PosAiChatLinksManagerProps, ActivePosAiProjectOption, PosAiAdminAnalyticsData, PosAiAdminKpis, PosAiAdminLogItem, PosAiAdminProjectItem, PosAiAdminTimelineItem, PosAiFeedbackItem (+10 more)
...
Cohesion: 0.23
Nodes (19): attachmentSecurity(), clampPanelWidth(), longDate(), maxPanelWidth(), shortDate(), SolutionDetails(), canPreviewSdAttachment(), isSdSolutionReviewOverdue() (+11 more)

### Community 321 - "useCsCxExperience.ts"
Cohesion: 0.11
Nodes (22): storagePath(), CS_CX_VISIT_STATUSES, CsCxChecklistInput, CsCxNpsHistory, CsCxVisitAttachment, CsCxVisitChecklistItem, CsCxVisitInput, CsCxVisitPendingInput (+14 more)
...
Cohesion: 0.24
Nodes (13): ArticleMetadataCardProps, ArticleNavigatorProps, CreateRoutineModalProps, SavePublishModalProps, SaveStep, computeTextDiff(), formatBackupFilePath(), KnowledgeArticle (+5 more)
...
Cohesion: 0.10
Nodes (31): BenchmarkPos, Chamados0800Result, checkPosCriticosAbertos(), createChamadosSearchQuery(), fetchChamadosTramites(), fetchUltimosTramites(), isNaturezaIgnorada(), mapChamado0800() (+23 more)
...
Cohesion: 0.33
Nodes (9): fmt(), getSpeechRecognition(), pickMimeType(), VoiceDictationButton(), VoiceDictationButtonProps, extFromMime(), mapJob(), useVoiceNoteJobs() (+1 more)

### Community 338 - "usePosAiVisitorAnalytics.ts"
Cohesion: 0.07
Nodes (37): ConversionIssuesTab(), NOTIFICATION_TYPE_ICONS, AdvancedFilters(), AdvancedFiltersProps, ProjectGrid(), ProjectTagsLegendDialog(), DropdownMenuCheckboxItem, DropdownMenuContent (+29 more)
...
Cohesion: 0.14
Nodes (40): formatDateTime(), SlaCardFilter, TicketSlaRow(), TicketsSlaAnalysis(), ChamadoTramite, isTicketCompleted(), normalizeTicketText(), formatDate() (+32 more)

### Community 342 - "cs-cx-nps-public.test.ts"
Cohesion: 0.38
Nodes (10): useKnowledgeBase(), deleteArticleFromDocument(), insertNewArticleIntoDocument(), normalizeMarkdown(), parseArticleFrontmatter(), parseMasterDocument(), parseTimestampToSeconds(), serializeArticleToMarkdown() (+2 more)
...
Cohesion: 0.33
Nodes (6): ModeToggle(), useTheme(), AdminLayout(), Home(), Login(), ResetPassword()
...
Cohesion: 0.29
Nodes (7): react, AdherenceImpactSummary(), CustomImageUploadWidget(), getImpactedItems(), ImplementerSelector(), useChart(), AuthProvider()
...
### Community 367 - "KnowledgeEditorPage.tsx"
Cohesion: 0.33
Nodes (5): ArticleMetadataCard(), SavePublishModal(), UnsavedChangesDialog(), VersionHistoryDrawer(), KnowledgeEditorPage()

### Community 370 - "CsCxAdmin"
Cohesion: 0.05
Nodes (60): ChecklistEditor(), ChecklistEditorProps, SYSTEM_TYPES, convertVisualToJSONSchema(), convertVisualToUISchema(), parseJSONSchemaToVisual(), VisualQuestion, VisualQuestionBuilder() (+52 more)

### Community 371 - "CsCxAdmin"
Cohesion: 0.33
Nodes (6): CsCxAdmin(), messageOf(), showError(), statusColorClass(), statusLabel(), required()

### Community 372 - "formatLogDetails"
Cohesion: 0.60
...
Cohesion: 0.08
Nodes (34): BunnyVideoPlayer(), BunnyVideoPlayerProps, formatBunnyEmbedUrl(), FeedbackPromptModal(), FeedbackPromptModalProps, Block, extractBunnyVideoFromLine(), isBunnyStreamUrl() (+26 more)

### Community 376 - "main"
Cohesion: 0.67
Nodes (4): applyUserMap(), assertTargetReady(), main(), validateSourceSchema()

### Community 377 - "BunnyVideoModal.tsx"
Cohesion: 0.67
Nodes (3): BunnyVideoModal(), BunnyVideoModalProps, BunnyVideoMetadata

### Community 378 - "compilerOptions"
Cohesion: 0.50
Nodes (3): compilerOptions, allowJs, lib

### Community 380 - "ImplementerPDFExport.tsx"
Cohesion: 0.67
Nodes (3): ImplementerPDFExport(), ImplementerPDFExportProps, ImplementerReportData

## Knowledge Gaps
- **2583 isolated node(s):** `{ chromium, firefox, webkit }`, `name`, `version`, `description`, `author` (+2578 more)
...
- **Why does `cn()` connect `Módulo: Núcleo — Dashboard e Projetos` to `Conversion Post Feed & Drawer`, `FormRenderer.tsx`, `Checklist & Visual Question Builder`, `filterStore.ts`, `Charts, KPI & Reports`, `Calendar Grid & Drag-Drop`, `GEMINI.md`, `Sidebar Components`, `Dashboard Table & Pagination`, `App Sidebar & Protected Route`, `Deployment Form Fields`, `Project Transformers & Stages`, `use-toast Reducer`, `Commercial/Public Checklists`, `Commercial Page & Hooks`, `Predictability & Bottlenecks`, `Main Layout & Theme Toggle`, `5. Contatos & Clientes`, `ProtectedRoute.tsx`, `Deployment Template & Stage Forms`, `Roadmap Page`, `LogsTab.tsx`, `PipelineStatus.tsx`, `useTeams.ts`, `useImproveTextJobs.ts`, `Login`, `sonner.tsx`, `copilot-language.ts`, `3. Dashboard — Modelos Editor`, `Módulo Comercial — Documentação por Tela`, `usePosAiVisitorAnalytics.ts`, `VersionHistoryDrawer.tsx`, `usePosPanorama.ts`, `SdSolutionContent.tsx`, `cs-cx-user-matching.mjs`, `ImplementerProfileCard.tsx`, `CsCxAdmin`, `Página 404 (Not Found)`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Why does `err()` connect `sonner.tsx` to `Conversion Post Feed & Drawer`, `VM Worker Job Queue`, `Checklist & Visual Question Builder`, `Sidebar Components`, `Custom Widgets & Sheet`, `use-toast Reducer`, `Commercial/Public Checklists`, `Deployment Template & Stage Forms`, `PipelineStatus.tsx`, `chamadosSync.ts`, `Improve-Text AI Jobs`, `Login`, `index.ts`, `Coleta Pública de Infraestrutura`, `CsCxNps`, `usePosAiVisitorAnalytics.ts`, `cs-cx-nps-public.test.ts`, `cs-cx-engagement-permissions.test.tsx`, `pos-chat-visitor-dialog.test.tsx`, `ImplementerProfileCard.tsx`, `Módulo: Núcleo — Dashboard e Projetos`, `CsCxAdmin`, `Página 404 (Not Found)`, `ImplementerPDFExport.tsx`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `useToast()` connect `CsCxAdmin` to `Conversion Issues & Post Forms`, `VM Worker Job Queue`, `FormRenderer.tsx`, `Project Stage Forms & Models`, `filterStore.ts`, `Charts, KPI & Reports`, `GEMINI.md`, `App Sidebar & Protected Route`, `Deployment Form Fields`, `Commercial/Public Checklists`, `Main Layout & Theme Toggle`, `ProtectedRoute.tsx`, `Deployment Template & Stage Forms`, `LogsTab.tsx`, `PipelineStatus.tsx`, `useTeams.ts`, `useCsCxCore.ts`, `useCsCxExperience.ts`, `useCsCxNpsSurveys.ts`, `CsCxRegistryOffices`, `Coleta Pública de Infraestrutura`, `3. Dashboard — Modelos Editor`, `Módulo Comercial — Documentação por Tela`, `usePosAiVisitorAnalytics.ts`, `VersionHistoryDrawer.tsx`, `CsCxReports`, `SdSolutionContent.tsx`, `ImplementerProfileCard.tsx`, `Módulo: Núcleo — Dashboard e Projetos`, `useCsCxAccess.ts`, `CsCxAdmin`, `Página 404 (Not Found)`?**
