...
## Corpus Check
- 792 files · ~952,316 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4264 nodes · 11703 edges · 276 communities (225 shown, 51 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 128 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4b7870e2`
...
## Communities (276 total, 51 thin omitted)

### Community 0 - "use Cs Cx Routines"
Cohesion: 0.06
Nodes (60): clamp(), FloatingCopilot(), maxWidth(), ArticleMetadataCard(), ArticleMetadataCardProps, ArticleNavigator(), ArticleNavigatorProps, BunnyVideoModalProps (+52 more)
...
Cohesion: 0.13
Nodes (17): appointmentContactName(), appointmentOfficeName(), AppointmentTable(), CsCxAppointments(), DataError(), defaultForm(), errorMessage(), formatDateOnly() (+9 more)

### Community 4 - "permissions e relacionados"
Cohesion: 0.24
Nodes (6): RequirePermission(), RequirePermissionProps, ProtectedRoute(), useAuth(), hasPermission, permissionsLoaded
...
Cohesion: 0.14
Nodes (27): CalendarControls(), CalendarGrid(), CalendarGridProps, DayDroppableZone(), CalendarLegend(), DraggableTeamMember(), DraggableTeamMemberProps, CalendarEventPill() (+19 more)
...
Cohesion: 0.14
Nodes (23): BenchmarkPos, Chamados0800Result, checkPosCriticosAbertos(), createChamadosSearchQuery(), fetchUltimosTramites(), isNaturezaIgnorada(), mapChamado0800(), mapChamadoTramite() (+15 more)
...
Cohesion: 0.05
Nodes (54): CompactQueueCard(), STATUS_COLORS, STATUS_LABELS, SummaryCard(), DashboardTable(), DashboardTableProps, HealthBadge(), HealthBadgeProps (+46 more)
...
Cohesion: 0.12
Nodes (16): DropdownMenuCheckboxItem, useDebounce(), AutoSaveConfig, SaveState, normalizeEntry(), useImportSdTeamWeek(), useManagedSdTimeEntries(), useManagedSdTimeReport() (+8 more)
...
Cohesion: 0.07
Nodes (50): NpsQuestionnairesPanel(), NpsThemePreview(), QUESTION_TYPES, questionTypeLabel(), CreateNpsInvitationInput, currentUser(), db, effectiveInvitationStatus() (+42 more)
...
Cohesion: 0.13
Nodes (16): DeploymentFormFields(), formatPhone(), Props, DeploymentFormRecord, useDeploymentForms(), CommercialChecklists(), EMPTY_FORM, checklists (+8 more)
...
Cohesion: 0.05
Nodes (56): CriticalAlerts(), CriticalAlertsProps, DeploymentCard(), DeploymentCardProps, DeploymentDetailsDialogProps, ProjectHeaderForm(), ProjectHeaderFormProps, StageCard() (+48 more)
...
Cohesion: 0.06
Nodes (60): NewProjectDialog(), AdvancedFilters(), AdherenceStageFormProps, EnvironmentStageFormProps, InfraStageFormProps, ProjectGrid(), ProjectTagsLegendDialog(), useConversionQueue() (+52 more)

### Community 38 - "ai Routine Generator Service"
Cohesion: 0.08
Nodes (42): PosAiChatLinksManager(), PosAiChatLinksManagerProps, initials(), PAGE_SIZE_OPTIONS, PosAiChatUsersManager(), PosAiChatUsersManagerProps, SearchableClientSelect(), ACTION_ORDER (+34 more)
...
Cohesion: 0.17
Nodes (12): AdherenceGapCard(), AdherenceGapCardProps, GlobalMetrics(), HealthDistribution(), IndividualProjectReport(), StatusDistribution(), getStartAndEndDates(), TimePerStageChart() (+4 more)

### Community 41 - "Implementer Phase1 Fichas"
Cohesion: 0.16
Nodes (10): AppSidebar(), ModeToggle(), MenuItem, menuItems, useTheme(), AdminLayout(), Home(), Login() (+2 more)

### Community 42 - "Project Modal"
Cohesion: 0.06
Nodes (33): CsCxMultiSelect(), copyText(), formatDate(), NpsInvitationsPanel(), Skeleton(), useCsCxRegistryOffices(), useCsCxContacts(), canAccessCsCxRecord() (+25 more)
...
Cohesion: 0.22
Nodes (17): SearchableClientOption, SearchableClientSelectProps, CsCxMultiSelectOption, CsCxMultiSelectProps, TabProps, ProjectSelectorProps, AutocompleteInputProps, Command (+9 more)

### Community 46 - "pos chat history sidebar.test"
Cohesion: 0.17
Nodes (17): jspdf, Chamado0800DetailDialog(), fmtDateBr(), fmtDateTimeBr(), formatTicketDuration(), statusBadgeClass(), PostChamados0800(), PostChamados0800Props (+9 more)

### Community 47 - "Families Manager"
Cohesion: 0.11
Nodes (22): Bloco, escapeHtml(), MarkdownLite(), markdownLiteToHtml(), parseBlocos(), renderInline(), ParecerPosJob, ChamadoPanorama (+14 more)

### Community 48 - "Cs Cx Appointments"
Cohesion: 0.07
Nodes (59): AdminListPager(), AdminListPagerProps, MarkdownTiptapEditor(), UserProfileDrawer(), Table, TableBody, TableCaption, TableCell (+51 more)
...
Cohesion: 0.17
Nodes (16): emptyInterval(), IntervalDraft, TimeEntryDialog(), TimeEntryDialogProps, db, SaveSdTimeEntryInput, SdTimeBulkImportRequestRow, SdTimeBulkImportResult (+8 more)
...
Cohesion: 0.21
Nodes (8): Plugins(), COLORS, FONT_SIZES, ToolbarPlugin(), EditorContentEditable(), Props, Toggle, toggleVariants
...
Cohesion: 0.23
Nodes (8): ContextualHeaderAction, getContextualHeaderAction(), matchesPath(), FloatingCopilot, MainLayout(), MainLayoutProps, SidebarProvider, SidebarTrigger
...
Cohesion: 0.10
Nodes (26): NOTIFICATION_TYPE_ICONS, DropdownMenuContent, DropdownMenuItem, DropdownMenuLabel, DropdownMenuRadioItem, DropdownMenuSeparator, DropdownMenuShortcut(), DropdownMenuSubContent (+18 more)

### Community 79 - "cs-cx-nps-import.ts"
Cohesion: 0.05
Nodes (55): ImplementerAllCartoriosTable(), ImplementerAllCartoriosTableProps, ChartTooltipProps, healthColors, healthLabels, ImplementerCharts(), ImplementerChartsProps, statusColors (+47 more)
...
Cohesion: 0.11
Nodes (18): Client, Contact, Project, ConversionEngineInputBase, CreateConversionEngineInput, EngineKPIs, EngineRecordType, EngineSpecialty (+10 more)

### Community 82 - "cs-cx-nps-xlsx.ts"
Cohesion: 0.35
Nodes (10): entryMinutes(), entryStartMinutes(), getWeekDays(), getWeekRange(), intervalMinutes(), intervalsOverlap(), SdTimeEntryLike, SdTimeIntervalLike (+2 more)
...
Cohesion: 0.12
Nodes (23): CollapsibleFieldSection(), CollapsibleFieldSectionProps, EnvironmentScreenshots(), sanitize(), formatStepTime(), ModelosEditorWorkspace(), ModelosEditorWorkspaceProps, ModelosMetrics() (+15 more)

### Community 87 - "Project Adherence Form"
Cohesion: 0.10
Nodes (33): AdherenceStageForm(), ProjectModal(), RoadmapManager(), Chamado0800Tab(), EditProjectTab(), FilesTab(), GeneralInfoTab(), LogsTab() (+25 more)
...
Cohesion: 0.16
Nodes (21): TicketsAiAnalysisProps, TicketsSlaAnalysisProps, TicketsSlaSectorAnalysisProps, ChamadosSearchFilters, ChamadosCatalog, getChamadosProductLabel(), ChamadosReportFilters, formatDate() (+13 more)
...
Cohesion: 0.06
Nodes (41): CopilotChat(), CopilotChatProps, fmtDateTime(), linkifyProjects(), loadSaved(), SUGESTOES, ChartEmptyState(), ChartEmptyStateProps (+33 more)

### Community 104 - "index.ts"
Cohesion: 0.31
Nodes (5): Editor(), editorConfig, nodes, editorTheme, RichTextEditorProps
...
Cohesion: 0.14
Nodes (13): CompactQueueCardProps, ProjectInfo, ProjectInfoSection(), ProjectInfoSectionProps, ConversionStageFormProps, ConversionEngineItem, ConversionKPIs, ConversionQueueItem (+5 more)
...
Cohesion: 0.12
Nodes (16): 1. Home (Hub de Navegação), 3. Quadro Kanban, Componentes principais, Componentes principais, Dados e Hooks, Dados e Hooks, Fluxos e Interações, Fluxos e Interações (+8 more)
...
Cohesion: 0.29
Nodes (6): lifecycleMigration, migration, otherToolsMigration, root, specialtyMigration, types
...
Cohesion: 0.33
Nodes (5): VisitorActionResult, PosAiChatVisitorAdmin, PosAiVisitorPage, PosAiVisitorPageParams, PosAiVisitorStatus
...
Cohesion: 0.10
Nodes (23): AlertTitle, AutocompleteInput(), mapJob(), useDtcAiJobs(), useTeamMembers(), useTimeline(), ALL_SYSTEMS, DTCData (+15 more)
...
Cohesion: 0.22
Nodes (9): 2. Motores de Conversão, Componentes principais, Dados e Hooks, Fluxos e Interações, Módulo: Conversão e Modelos OrionTN, Objetivo, Pontos de Manutenção, Regras de Negócio e Estados (+1 more)

### Community 129 - "getErrorMessage"
Cohesion: 0.11
Nodes (51): StatusFilter, ConversionIssuesTab(), ConversionIssuesTabProps, PRIORITIES, STATUSES, ConversionPostDrawer(), ConversionPostDrawerProps, STATUS_LABELS (+43 more)
...
Cohesion: 0.19
Nodes (19): AiRichTextField(), AiRichTextFieldProps, messageOf(), RichTextEditor(), useModelWorkerStatus(), appendPlainTextToLexicalJson(), hasRichTextContent(), LexicalNode (+11 more)
...
Cohesion: 0.22
Nodes (11): VersionHistoryDrawer(), ConversionStageForm(), EnvironmentStageForm(), ImplementationPhaseForm(), ImplementationStageForm(), ImplementationStageFormProps, PhaseFormProps, convertBlocksToTiptap() (+3 more)
...
Cohesion: 0.11
Nodes (18): Switch, CsCxRequestStatusConfig, ADMIN_SECTIONS, AdminSection, CatalogKind, CsCxAdmin(), DeleteTarget, EMPTY_CATALOG (+10 more)
...
Cohesion: 0.09
Nodes (34): text(), RoutineObservationsPreview(), buildPrompt(), classifyPendingChamados(), NATUREZAS_SEM_TEMA, parseResult(), PendingRow, config (+26 more)
...
Cohesion: 0.10
Nodes (33): CsCxRequest, APPOINTMENT_STATUS_LABELS, APPOINTMENT_TYPE_LABELS, formatDate(), formatDateTime(), generateCsCxAppointmentsPdf(), generateCsCxContactsPdf(), groupByOffice() (+25 more)
...
Cohesion: 0.18
Nodes (10): 1. Painel de Implantadores (hub), 7. Relação com telas externas ao módulo, Componentes principais, Dados e Hooks, Fluxos e Interações, Módulo Implantadores — Documentação por Tela, Objetivo, Pontos de Manutenção (+2 more)
...
Cohesion: 0.10
Nodes (17): DEFAULT_HEALTH_SETTINGS, ProjectHealthSettings, AiTextImprovementJob, mapJob(), useAiTextImprovement(), AccessData, CsCxAccessCandidate, CsCxAccessProfile (+9 more)

## Knowledge Gaps
- **1697 isolated node(s):** `envPath`, `envContent`, `env`, `supabase`, `$schema` (+1692 more)
...
- **Why does `cn()` connect `chart e relacionados` to `use Cs Cx Routines`, `getErrorMessage`, `Form Renderer`, `cs cx nps analytics`, `Post Observations`, `Visual Question Builder`, `conversion e relacionados`, `Pwa Status`, `sidebar e relacionados`, `useDebounce`, `sd solutions`, `card e relacionados`, `Deployment Form Fields`, `use Cs Cx Core`, `chamados-date-range.ts`, `Nps Analytics`, `use Copilot`, `CsCxAdmin`, `Project V2`, `ai Routine Generator Service`, `filter Store`, `knowledge e relacionados`, `Implementer Phase1 Fichas`, `Project Modal`, `command e relacionados`, `pos chat history sidebar.test`, `Families Manager`, `Cs Cx Appointments`, `Cs Cx Routines`, `ImplementerInvolvement`, `toast e relacionados`, `07 telas publicas autenticacao`, `use Pos Ai Project Summary`, `sd attendance bi interactions.test`, `usePosAiChatVisitors.ts`, `tickets sla`, `ImplementerCharts.tsx`, `Project Adherence Form`, `useTheme`, `chart.tsx`, `index.ts`, `migrate cs cx`, `pos-chat-visitor-dialog.test.tsx`, `sd-solutions-search.test.tsx`?**
  _High betweenness centrality (0.062) - this node is a cross-community bridge._
- **Why does `Button` connect `getErrorMessage` to `use Cs Cx Routines`, `Form Renderer`, `cs cx nps analytics`, `permissions e relacionados`, `Cs Cx Requests`, `Post Observations`, `Visual Question Builder`, `sd solutions`, `infra validation`, `Pwa Status`, `sidebar e relacionados`, `chart e relacionados`, `Transicao Placeholder`, `chamados-date-range.ts`, `card e relacionados`, `Deployment Form Fields`, `use Cs Cx Core`, `sd solutions`, `Nps Analytics`, `use Copilot`, `CsCxAdmin`, `Project V2`, `ai Routine Generator Service`, `filter Store`, `tickets ai analytics`, `Project Modal`, `Implementer Phase1 Fichas`, `command e relacionados`, `sd attachments`, `Families Manager`, `Cs Cx Appointments`, `Cs Cx Routines`, `use Sd Attendance Bi`, `sd solutions`, `07 telas publicas autenticacao`, `package e relacionados`, `chamados date range`, `use Pos Ai Project Summary`, `team e relacionados`, `sd e relacionados`, `PwaStatus.tsx`, `usePosAiChatVisitors.ts`, `cs-cx-nps-import.ts`, `PostObservations`, `ProjectsKanban.tsx`, `tickets sla`, `ImplementerCharts.tsx`, `Project Adherence Form`, `1. Gestão de Atividades — Fila de Conversão`, `5. Modelos Editor (Workspace)`, `Reports.tsx`, `useHomologationEvents.ts`, `codexModelSkill.ts`, `chart.tsx`, `index.ts`, `migrate cs cx`, `pos-chat-visitor-dialog.test.tsx`, `sd-solutions-search.test.tsx`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `text()` connect `run Skill` to `codexModelSkill.ts`, `sd solutions`, `CsCxNpsResponse`, `Cs Cx Requests`, `Post Observations`, `filter Store`, `chart.tsx`, `process Copilot Job`, `process Dtc Job`, `cs cx experience pdf`, `useDebounce`, `Deployment Form Fields`, `sd-solutions-search.test.tsx`, `useHomologationEvents.ts`?**
