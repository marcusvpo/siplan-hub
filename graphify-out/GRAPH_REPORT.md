...
## Corpus Check
- 894 files · ~1,024,619 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5780 nodes · 13005 edges · 402 communities (306 shown, 96 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 177 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `01d70af3`
...
## Communities (402 total, 96 thin omitted)
...
Cohesion: 0.12
Nodes (24): TimeEntryDialogProps, db, normalizeEntry(), SaveSdTimeEntryInput, SdTimeBulkImportRequestRow, SdTimeBulkImportResult, SdTimeEntry, SdTimeImportRequestRow (+16 more)

### Community 7 - "Project Stage Forms & Models"
Cohesion: 0.04
Nodes (76): ACTION_ORDER, CsCxAccessPanel(), EMPTY_PROFILE, UnsavedChangesDialogProps, CollapsibleFieldSection(), CollapsibleFieldSectionProps, getEditorContent(), ObservationsWithAI() (+68 more)
...
Cohesion: 0.10
Nodes (23): NotificationBell(), LogsTab(), useNotifications(), UseNotificationsOptions, useTimelineEvents(), ConversionActivityLog, ConversionIssue, ConversionKPIs (+15 more)
...
Cohesion: 0.05
Nodes (63): dateFormatter, formatLastActivity(), integerFormatter, PosAiVisitorAnalytics(), PosAiVisitorAnalyticsProps, usdFormatter, ProjectDetailsModal(), ProjectDetailsModalProps (+55 more)
...
Cohesion: 0.11
Nodes (22): data, OverviewChart(), ProjectStatusChart(), formatAction(), RecentActivity(), STATUS_COLORS, STATUS_LABELS, RestoreVersionModal() (+14 more)
...
Cohesion: 0.14
Nodes (25): copyText(), formatDate(), NpsInvitationsPanel(), NpsQuestionnairesPanel(), NpsThemePreview(), QUESTION_TYPES, questionTypeLabel(), currentUser() (+17 more)
...
Cohesion: 0.07
Nodes (39): CompactQueueCard(), DashboardTable(), DashboardTableProps, PipelineStatus(), PipelineStatusProps, SortableThumb(), EditProjectTab(), ProjectSelector() (+31 more)

### Community 26 - "Project Transformers & Stages"
Cohesion: 0.18
Nodes (13): CreateNpsInvitationInput, db, RawInvitation, SaveQuestionnaireInput, CsCxNpsInvitation, CsCxNpsQuestionnaire, NpsAnswerValue, NpsInvitationStatus (+5 more)

### Community 27 - "use-toast Reducer"
Cohesion: 0.07
Nodes (40): DeploymentCard(), DeploymentCardProps, DeploymentDetailsDialogProps, ProjectHeaderForm(), ProjectHeaderFormProps, ModelosEditorWorkspaceProps, PosAiAssistantSectionProps, PosSaudeBadge() (+32 more)

### Community 28 - "Project Modal & Kanban"
Cohesion: 0.09
Nodes (27): CS_CX_REQUEST_STATUSES, CsCxOfficeProduct, CsCxOfficeResponsible, CsCxProductResponsible, CsCxRequestInput, CsCxRequestStatus, CsCxRequestStatusHistoryEntry, CsCxRequestUpdate (+19 more)

### Community 29 - "Commercial/Public Checklists"
Cohesion: 0.08
Nodes (27): HealthBadge(), HealthBadgeProps, MarkdownTiptapEditorProps, daysBetweenStr(), formatCurrency(), formatDate(), ImplementerPhase1Fichas(), priorityLabels (+19 more)
...
Cohesion: 0.09
Nodes (36): VersionHistoryDrawer(), AppSidebar(), UserProfileDrawer(), ModeToggle(), DeploymentDetailsDialog(), StageCard(), EnvironmentStageForm(), ProtectedRoute() (+28 more)
...
Cohesion: 0.08
Nodes (27): EnvironmentScreenshotsProps, mapHeartbeat(), mapJob(), useModelGenerationJobs(), AttachedFile, BlockingReason, ChecklistItem, ClientSatisfaction (+19 more)
...
Cohesion: 0.08
Nodes (34): CompactQueueCardProps, ConversionPostDrawer(), ConversionPostDrawerProps, STATUS_LABELS, ConversionPostFeed(), ConversionPostFeedProps, formatPostDate(), getInitials() (+26 more)
...
Cohesion: 0.10
Nodes (21): react, AdherenceImpactSummary(), AdherenceQuestionField(), AdherenceQuestionValue, ArrayFieldTemplateItem, checkHasAdherenceQuestions(), CustomArrayFieldTemplate(), CustomCheckboxWidget() (+13 more)
...
Cohesion: 0.19
Nodes (13): classificationClass(), classificationLabel(), formatRankingDate(), formatResponseDate(), matchesDrilldown(), NpsAnalyticsPanel(), NpsDrilldownDialog(), npsTone() (+5 more)
...
Cohesion: 0.18
Nodes (21): emptyInterval(), TimeEntryDialog(), useDeleteSdTimeEntry(), useSaveSdTimeEntry(), entryMinutes(), entryStartMinutes(), formatMinutes(), getWeekDays() (+13 more)
...
Cohesion: 0.37
Nodes (13): StageStatus, calculateHealthScore(), formatDateForDB(), mapAdherenceStage(), mapConversionStage(), mapEnvironmentStage(), mapImplementationStage(), mapInfraStage() (+5 more)
...
Cohesion: 0.09
Nodes (33): ChecklistEditor(), ChecklistEditorProps, SYSTEM_TYPES, STAGE_OPTIONS, convertVisualToJSONSchema(), convertVisualToUISchema(), parseJSONSchemaToVisual(), VisualQuestion (+25 more)
...
Cohesion: 0.24
Nodes (9): isEmptyAnswer(), loadInvitation(), messageOf(), NpsScale(), PublicNpsResponse(), RatingScale(), StateCard(), statusDescription() (+1 more)
...
### Community 184 - "Login"
Cohesion: 0.10
Nodes (35): SearchableClientOption, SearchableClientSelect(), SearchableClientSelectProps, CsCxMultiSelect(), CsCxMultiSelectOption, CsCxMultiSelectProps, AttentionChartItem, AttentionClientsChart() (+27 more)
...
Cohesion: 0.10
Nodes (43): ArticleMetadataCard(), ArticleMetadataCardProps, ArticleNavigator(), ArticleNavigatorProps, BunnyVideoModal(), BunnyVideoModalProps, CreateRoutineModal(), CreateRoutineModalProps (+35 more)
...
Cohesion: 0.05
Nodes (68): AdminSettings(), STAGE_LABELS, StageCardProps, formatStepTime(), ModelosEditorWorkspace(), ModelosMetrics(), normalizeModelName(), pairKeyFor() (+60 more)
...
Cohesion: 0.12
Nodes (20): RequirePermission(), RequirePermissionProps, MenuItem, menuItems, ACTION_LABELS, getActionLabel(), getResourceCategory(), getResourceLabel() (+12 more)

### Community 300 - "useTeams.ts"
Cohesion: 0.07
Nodes (36): ImplementerAllCartoriosTable(), healthColors, healthLabels, ImplementerChartsProps, statusColors, statusLabels, ImplementerHeaderBanner(), ImplementerHeaderBannerProps (+28 more)
...
Cohesion: 0.33
Nodes (8): actionLabels, AuditLogPage(), formatLogDetails(), formatValue(), isUUID(), translateValue(), AdminStats, AuditLog
...
Cohesion: 0.08
Nodes (33): ConversionIssuesTab(), ConversionIssuesTabProps, PRIORITIES, STATUSES, NewProjectDialog(), NOTIFICATION_TYPE_ICONS, AdvancedFilters(), ProjectGrid() (+25 more)
...
Cohesion: 0.13
Nodes (20): AdherenceStageFormProps, EnvironmentStageFormProps, InfraStageFormProps, ProjectRow, useProjectsList(), userProjectsListTransform(), Analytics(), AdherenceStageV2 (+12 more)
...
Cohesion: 0.12
Nodes (41): PosAiChatLinksManagerProps, StatusFilter, PAGE_SIZE_OPTIONS, PosAiChatUsersManagerProps, COLORS, FONT_SIZES, UserProfileDrawerProps, AdvancedFiltersProps (+33 more)
...
Cohesion: 0.05
Nodes (41): ProjectModal(), CustomTheme, RoadmapManager(), RoadmapManagerProps, RoadmapSettings, Chamado0800Tab(), GeneralInfoTab(), StepsTab() (+33 more)
...
Cohesion: 0.17
Nodes (18): APPOINTMENT_STATUS_LABELS, APPOINTMENT_TYPE_LABELS, formatDate(), formatDateTime(), generateCsCxAppointmentsPdf(), generateCsCxContactsPdf(), groupByOffice(), localIsoDate() (+10 more)
...
Cohesion: 0.08
Nodes (42): ProjectStatusChartProps, STATUS_LABELS, AdherenceGapCard(), GlobalMetrics(), HealthDistribution(), ImplementerAllCartoriosTableProps, SortOption, ImplementerReportTab() (+34 more)

### Community 405 - "ImplementerPhaseMetrics.tsx"
Cohesion: 0.07
Nodes (36): PosAiChatLinksManager(), initials(), PosAiChatUsersManager(), VisitorActionResult, emptyPage(), fetchPosAiChatConversationsPage(), PosAiConversationGroup, PosAiConversationMessage (+28 more)
...
Cohesion: 0.23
Nodes (11): AttentionRow, ContactAttentionDashboardProps, CsCxRegistryOffice, CsCxContact, contactIdentity(), contactTimestamp(), deduplicateAppointmentContacts(), buildCsCxRegistryOfficesReport() (+3 more)
...
- **Why does `cn()` connect `Deployment Form Fields` to `Conversion Post Feed & Drawer`, `Project Stage Forms & Models`, `Notification Bell & Dropdown`, `Calendar Grid & Drag-Drop`, `GEMINI.md`, `Adherence Form Renderer`, `Sidebar Components`, `Dashboard Table & Pagination`, `App Sidebar & Protected Route`, `StageStatus`, `useAuth`, `use-toast Reducer`, `Project Modal & Kanban`, `Commercial/Public Checklists`, `Main Layout & Theme Toggle`, `5. Contatos & Clientes`, `Post Observations Editor`, `Theme Provider`, `LogsTab.tsx`, `Health Badge & Pipeline Status`, `useTeams.ts`, `usePublicChecklist.ts`, `Página 404 (Not Found)`, `Toggle Component`, `Agenda dos Analistas`, `Calendário (Planejamento Visual)`, `AuthContext.tsx`, `Próximas Implantações`, `Login`, `package.json`, `CopilotChat.tsx`, `DeploymentFormFields.tsx`, `useCsCxNpsSurveys.ts`, `RolesManagement.tsx`, `sheet.tsx`, `formatLogDetails`, `usePosPanorama.ts`, `CsCxReports`, `4. Homologação de Conversões`, `cs-cx-routines-report.test.ts`, `🗄️ Configuração Local do Supabase (Ambiente de Desenvolvimento)`, `useCsCxAccess.ts`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `err()` connect `VM Worker Job Queue` to `Main Layout & Theme Toggle`, `Post Observations Editor`, `DeploymentFormFields.tsx`, `sd-solutions.ts`, `index.ts`, `RolesManagement.tsx`, `Theme Provider`, `LogsTab.tsx`, `GEMINI.md`, `useTeams.ts`, `usePublicChecklist.ts`, `processJob.ts`, `Improve-Text AI Jobs`, `Notification Bell & Dropdown`, `chamadosSync.ts`, `App Sidebar & Protected Route`, `pos-chat-visitor-dialog.test.tsx`, `package.json`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `Button` connect `CsCxReports` to `Conversion Post Feed & Drawer`, `Project Stage Forms & Models`, `Charts, KPI & Reports`, `filterStore.ts`, `GEMINI.md`, `Adherence Form Renderer`, `Sidebar Components`, `Módulo: Calendário, Agenda, Analytics, Relatórios, Roadmap e Implantações`, `Dashboard Table & Pagination`, `App Sidebar & Protected Route`, `StageStatus`, `useAuth`, `ImplementerPhaseMetrics.tsx`, `Deployment Form Fields`, `use-toast Reducer`, `Commercial/Public Checklists`, `6. Análise de Aderência`, `Main Layout & Theme Toggle`, `5. Contatos & Clientes`, `Post Observations Editor`, `Theme Provider`, `TicketsAiAnalysis.tsx`, `PipelineStatus.tsx`, `LogsTab.tsx`, `usePublicChecklist.ts`, `useTeams.ts`, `project-transformers.ts`, `SolutionsSearch.tsx`, `Agenda dos Analistas`, `Calendário (Planejamento Visual)`, `lexical.ts`, `AuthContext.tsx`, `Toggle Component`, `Próximas Implantações`, `Login`, `package.json`, `CopilotChat.tsx`, `SolutionDetails.tsx`, `DeploymentFormFields.tsx`, `RolesManagement.tsx`, `sheet.tsx`, `usePosPanorama.ts`, `pos-chat-visitor-dialog.test.tsx`, `4. Homologação de Conversões`, `CsCxReports`, `Página 404 (Not Found)`?**
