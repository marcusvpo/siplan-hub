...
## Corpus Check
- 904 files · ~1,030,597 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5831 nodes · 13118 edges · 410 communities (314 shown, 96 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 181 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3a5d8af4`
...
## Communities (410 total, 96 thin omitted)
...
Cohesion: 0.07
Nodes (29): canAccessCsCxRecord(), CsCxOwnedResource, useCsCxRecordPermissions(), answerLabel(), CLASS_LABELS, CsCxNps(), formatDate(), formatDateOnly() (+21 more)
...
Cohesion: 0.17
Nodes (10): ContextualHeaderAction, getContextualHeaderAction(), matchesPath(), MainLayout(), MainLayoutProps, ModeToggle(), SidebarProvider, SidebarTrigger (+2 more)
...
Cohesion: 0.19
Nodes (9): DropdownMenuCheckboxItem, useManagedSdTimeReport(), errorMessage(), formatEntryDescription(), PAGE_SIZE_OPTIONS, PeriodView, SD_ATTENDANCE_GROUPS, shortAnalystName() (+1 more)

### Community 8 - "Charts, KPI & Reports"
Cohesion: 0.21
Nodes (10): CompactQueueCardProps, STATUS_COLORS, STATUS_LABELS, ProjectInfo, ProjectInfoSection(), ProjectInfoSectionProps, ConversionKPIs, ConversionQueueItem (+2 more)
...
Cohesion: 0.07
Nodes (28): HealthBadge(), HealthBadgeProps, Sidebar, SidebarContent, SidebarContext, SidebarFooter, SidebarGroup, SidebarGroupAction (+20 more)
...
Cohesion: 0.14
Nodes (19): AccordionContent, AccordionItem, AccordionTrigger, Checkbox, Action, ActionType, actionTypes, addToRemoveQueue() (+11 more)
...
Cohesion: 0.33
Nodes (12): NpsQuestionnairesPanel(), NpsThemePreview(), darkenNpsThemeColor(), isHexColor(), newNpsQuestion(), normalizeNpsTheme(), npsThemeForegroundColor(), npsThemeTint() (+4 more)
...
Cohesion: 0.07
Nodes (41): PosAiChatLinksManagerProps, PAGE_SIZE_OPTIONS, PosAiChatUsersManagerProps, AttentionFilter, AttentionStatus, ContactAttentionDashboard(), filterForStatus(), formatDate() (+33 more)

### Community 27 - "use-toast Reducer"
Cohesion: 0.06
Nodes (41): CriticalAlerts(), CriticalAlertsProps, DashboardReport(), DashboardReportProps, ProjectDetailsModalProps, DeploymentCard(), DeploymentCardProps, DeploymentDetailsDialogProps (+33 more)

### Community 28 - "Project Modal & Kanban"
Cohesion: 0.08
Nodes (31): CS_CX_REQUEST_STATUSES, CsCxOfficeProduct, CsCxOfficeResponsible, CsCxProductResponsible, CsCxRequestInput, CsCxRequestStatus, CsCxRequestStatusHistoryEntry, CsCxRequestUpdate (+23 more)
...
Cohesion: 0.06
Nodes (39): EnvironmentScreenshotsProps, ConversionStageFormProps, EnvironmentStageFormProps, InfraStageFormProps, GLOBAL_STATUS_LABELS, GLOBAL_STATUS_VARIANTS, ImplementerOtherStagesProps, ImplementerProjectsListProps (+31 more)
...
Cohesion: 0.07
Nodes (46): ConversionIssuesTab(), ConversionIssuesTabProps, PRIORITIES, STATUSES, ConversionPostDrawer(), ConversionPostDrawerProps, STATUS_LABELS, MarkdownTiptapEditorProps (+38 more)
...
Cohesion: 0.13
Nodes (19): StageCardProps, ProjectCardV3(), ProjectCardV3Props, Progress, BottleneckIssue, getBottleneckColor(), getBottleneckIcon(), getDaysStuck() (+11 more)
...
Cohesion: 0.12
Nodes (33): SolutionForm(), DeleteTarget, errorCode(), systemNameCollator, SystemsManager(), Solutions(), SolutionsTab, attachmentStorageName() (+25 more)
...
Cohesion: 0.08
Nodes (29): ChartEmptyState(), ChartEmptyStateProps, DashboardKPI(), DashboardKPIProps, KPICard(), KPICardProps, ProjectDistributionChart(), ProjectDistributionChartProps (+21 more)
...
Cohesion: 0.08
Nodes (24): 1.1. Subseção: Cartão detalhado da Minha Fila (`MyQueueDetailedCard`), 1. Gestão de Atividades — Fila de Conversão, 2. Motores de Conversão, 4. Projetos OrionTN, Componentes principais, Componentes principais, Componentes principais, Dados e Hooks (+16 more)
...
Cohesion: 0.13
Nodes (21): clamp(), FloatingCopilot(), maxWidth(), RestoreVersionModal(), RestoreVersionModalProps, VersionDetailModal(), VersionDetailModalProps, VersionHistoryDrawerProps (+13 more)
...
### Community 184 - "Login"
Cohesion: 0.06
Nodes (57): CalendarControls(), CompactQueueCard(), ConversionPostFeed(), ConversionPostFeedProps, formatPostDate(), getInitials(), groupPostsByDate(), POST_TYPE_CONFIG (+49 more)
...
Cohesion: 0.16
Nodes (26): ArticleMetadataCardProps, ArticleNavigatorProps, BunnyVideoModalProps, CreateRoutineModalProps, SavePublishModalProps, SaveStep, useKnowledgeBase(), KnowledgeEditorPage() (+18 more)
...
Cohesion: 0.11
Nodes (25): CS_CX_APPOINTMENT_STATUSES, CS_CX_APPOINTMENT_TYPES, CsCxAppointment, CsCxAppointmentInput, CsCxContactInput, CsCxProfileOption, currentUser(), db (+17 more)
...
Cohesion: 0.06
Nodes (56): EMPTY_PROFILE, CsCxMultiSelect(), UnsavedChangesDialogProps, CollapsibleFieldSection(), CollapsibleFieldSectionProps, getEditorContent(), ObservationsWithAI(), ObservationsWithAIProps (+48 more)
...
Cohesion: 0.09
Nodes (34): csvCell(), groupBy(), matchLegacyUsers(), normalizeEmail(), normalizeName(), apply, applyUserMap(), args (+26 more)
...
Cohesion: 0.13
Nodes (20): DashboardTable(), DashboardTableProps, PipelineStatus(), PipelineStatusProps, ProjectDetailsModal(), ButtonProps, buttonVariants, Pagination() (+12 more)
...
Cohesion: 0.18
Nodes (15): formatDate(), NpsInvitationsPanel(), CreateNpsInvitationInput, currentUser(), db, effectiveInvitationStatus(), invalidateNpsSurveys(), RawInvitation (+7 more)

### Community 306 - "cs-cx-experience-pdf.ts"
Cohesion: 0.11
Nodes (27): CsCxRequest, calculateCsCxReportRowLayout(), clean(), CsCxPdfOutputOptions, CsCxReportBlock, CsCxReportRow, CsCxReportRowLayout, CsCxSummaryItem (+19 more)
...
Cohesion: 0.05
Nodes (48): ImplementerAllCartoriosTable(), ImplementerAllCartoriosTableProps, healthColors, healthLabels, ImplementerChartsProps, statusColors, statusLabels, ImplementerHeaderBanner() (+40 more)

### Community 319 - "TransicaoPlaceholder"
Cohesion: 0.08
Nodes (51): SearchableClientSelectProps, CsCxMultiSelectOption, CsCxMultiSelectProps, copyText(), ArticleMetadataCard(), UnsavedChangesDialog(), ProjectHeaderForm(), PosSaudeBadge() (+43 more)
...
Cohesion: 0.11
Nodes (22): storagePath(), CS_CX_VISIT_STATUSES, CsCxChecklistInput, CsCxNpsHistory, CsCxVisit, CsCxVisitAttachment, CsCxVisitChecklistItem, CsCxVisitInput (+14 more)

### Community 322 - "PosPanorama.tsx"
Cohesion: 0.22
Nodes (13): buildContactAttentionRows(), contactStatus(), isIsoDate(), parseIsoDate(), APPOINTMENT_STATUS_LABELS, APPOINTMENT_TYPE_LABELS, formatDate(), formatDateTime() (+5 more)

### Community 323 - "ContactAttentionDashboard"
Cohesion: 0.23
Nodes (11): AttentionRow, ContactAttentionDashboardProps, OfficeFilterCombobox(), CsCxRegistryOffice, CsCxContact, contactIdentity(), contactTimestamp(), deduplicateAppointmentContacts() (+3 more)
...
### Community 334 - "v"
Cohesion: 0.18
Nodes (7): DeploymentFormFields(), formatPhone(), Props, check(), DeploymentFormData, generateDeploymentTemplate(), yn()
...
Cohesion: 0.31
Nodes (9): useAuditLogs(), actionLabels, AuditLogPage(), formatLogDetails(), formatValue(), isUUID(), translateValue(), AdminStats (+1 more)
...
### Community 342 - "useCsCxNpsAiReport.ts"
Cohesion: 0.31
...
Cohesion: 0.07
Nodes (50): AdherenceStageForm(), AdherenceStageFormProps, InfraStageForm(), useDebounce(), AutoSaveConfig, SaveState, FormTemplate, NewTemplateInput (+42 more)
...
Cohesion: 0.12
Nodes (23): StatusFilter, CalendarLegend(), BunnyVideoModal(), SavePublishModal(), UserProfileDrawerProps, EnvironmentScreenshots(), sanitize(), CustomTheme (+15 more)

### Community 356 - "6. Documento de Transição de Conhecimento — DTC"
Cohesion: 0.22
...
### Community 361 - "3. Dashboard — Modelos Editor"
Cohesion: 0.29
...
### Community 367 - "3. Aderências Finalizadas"
Cohesion: 0.29
...
### Community 370 - "4. Homologação de Conversões"
Cohesion: 0.29
...
Cohesion: 0.07
Nodes (42): data, OverviewChart(), ProjectStatusChart(), ProjectStatusChartProps, STATUS_LABELS, formatAction(), RecentActivity(), AdminSettings() (+34 more)

### Community 405 - "ImplementerPhaseMetrics.tsx"
Cohesion: 0.14
Nodes (16): PosAiChatLinksManager(), initials(), PosAiChatUsersManager(), SearchableClientOption, SearchableClientSelect(), downloadCsv(), escapeCsvValue(), ErrorLike (+8 more)
...
Cohesion: 0.06
Nodes (62): ArticleNavigator(), VersionHistoryDrawer(), AppSidebar(), UserProfileDrawer(), NotificationBell(), SortableThumb(), StageCard(), EnvironmentStageForm() (+54 more)

## Knowledge Gaps
- **2697 isolated node(s):** `{ chromium, firefox, webkit }`, `name`, `version`, `description`, `author` (+2692 more)
...
- **Why does `cn()` connect `cs-cx-admin-permissions.test.tsx` to `Conversion Post Feed & Drawer`, `Charts, KPI & Reports`, `Calendar Grid & Drag-Drop`, `GEMINI.md`, `Sidebar Components`, `App Sidebar & Protected Route`, `StageStatus`, `useAuth`, `ImplementerPhaseMetrics.tsx`, `Project Transformers & Stages`, `use-toast Reducer`, `Predictability & Bottlenecks`, `Main Layout & Theme Toggle`, `5. Contatos & Clientes`, `Roadmap Page`, `ProtectedRoute.tsx`, `Theme Provider`, `Health Badge & Pipeline Status`, `LogsTab.tsx`, `useTeams.ts`, `usePublicChecklist.ts`, `Página 404 (Not Found)`, `Toggle Component`, `usePosAiAdminAnalytics.ts`, `FamiliesManager.tsx`, `Login`, `ProjectCardV3.tsx`, `TransicaoPlaceholder`, `ContactAttentionDashboard`, `formatLogDetails`, `usePosPanorama.ts`, `NpsAnalytics.tsx`, `AdminSettings.tsx`, `CsCxReports`, `cs-cx-routines-report.test.ts`, `🗄️ Configuração Local do Supabase (Ambiente de Desenvolvimento)`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `err()` connect `index.ts` to `FormRenderer.tsx`, `Notification Bell & Dropdown`, `GEMINI.md`, `Deployment Form Fields`, `cs-cx-admin-permissions.test.tsx`, `5. Contatos & Clientes`, `Roadmap Page`, `LogsTab.tsx`, `chamadosSync.ts`, `usePublicChecklist.ts`, `Improve-Text AI Jobs`, `FallbackChecklistForm.tsx`, `Login`, `package.json`, `package.json`, `TransicaoPlaceholder`, `processCopilotJob.ts`, `useCsCxNpsAiReport.ts`, `usePosAiProjectSummary.ts`, `AdminSettings.tsx`, `Módulo: Núcleo — Dashboard e Projetos`, `pos-chat-visitor-dialog.test.tsx`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `Button` connect `Login` to `Conversion Post Feed & Drawer`, `VM Worker Job Queue`, `Project Stage Forms & Models`, `Charts, KPI & Reports`, `filterStore.ts`, `GEMINI.md`, `Sidebar Components`, `Módulo: Calendário, Agenda, Analytics, Relatórios, Roadmap e Implantações`, `Dashboard Table & Pagination`, `StageStatus`, `App Sidebar & Protected Route`, `ImplementerPhaseMetrics.tsx`, `Deployment Form Fields`, `Project Transformers & Stages`, `use-toast Reducer`, `CsCxContacts`, `Predictability & Bottlenecks`, `cs-cx-admin-permissions.test.tsx`, `Main Layout & Theme Toggle`, `5. Contatos & Clientes`, `Roadmap Page`, `ProtectedRoute.tsx`, `TicketsAiAnalysis.tsx`, `Health Badge & Pipeline Status`, `PipelineStatus.tsx`, `LogsTab.tsx`, `usePublicChecklist.ts`, `Theme Provider`, `SolutionsSearch.tsx`, `project-transformers.ts`, `usePosAiAdminAnalytics.ts`, `FamiliesManager.tsx`, `Toggle Component`, `FallbackChecklistForm.tsx`, `package.json`, `TransicaoPlaceholder`, `SolutionDetails.tsx`, `CsCxRegistryOffices`, `SimpleMarkdown.tsx`, `usePosPanorama.ts`, `NpsAnalytics.tsx`, `AdminSettings.tsx`, `CsCxReports`, `🗄️ Configuração Local do Supabase (Ambiente de Desenvolvimento)`, `pos-chat-visitor-dialog.test.tsx`?**
