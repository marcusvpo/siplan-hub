# Graph Report - siplan-hub  (2026-08-31)

## Corpus Check
- 923 files · ~1,042,641 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5886 nodes · 13247 edges · 418 communities (321 shown, 97 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 185 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `095cd07a`
...
- vercel.json
- Auto-descoberta do binário do Claude (CLAUDE_BIN opcional)
- VM Worker README (geração automática de modelos)
- Rascunho headless requer revisão do analista
- Heartbeat do worker (model_worker_heartbeat, selo online/offline)
- Claim de job (FOR UPDATE SKIP LOCKED)
- Andamento ao vivo (stream-json, progress/progress_log)
- Fila de jobs model_generation_jobs (Supabase)
- Skill criar-modelo-mesclado (Claude Code headless)
- Projeto Orion.Modelos (/opt/Orion.Modelos)
- Reaper de jobs travados (MAX_ATTEMPTS)
- Por que rodar como administrator (não-root)
- Supabase (SUPABASE_SECRET_KEY, Realtime, RLS)
- Serviço systemd siplan-model-worker
- SiplanHUB VM Worker
- Watchdog (worker-watchdog.sh cron)
- Visual QA Checklist
- ProtectedRoute.tsx
- commercial-contacts-permissions.test.tsx
- TicketsAiAnalysis.tsx
- LogsTab.tsx
- PipelineStatus.tsx
- useTeams.ts
- CsCxRegistryOffices.tsx
- project-transformers.ts
- Página 404 (Not Found)
- usePosAiAdminAnalytics.ts
- cs-cx-nps-analytics.ts
- cs-cx-experience-pdf.ts
- useSdAttendanceBi.ts
- CompactQueueCard.tsx
- calendar.tsx
- sdTimeImport.ts
- OverviewChart.tsx
- sonner.tsx
...
- apply-migration.js
- PipelineStatus.tsx
- prepare-cs-cx-schema.mjs
- CopilotChat.tsx
- cs-cx-nps-survey.ts
- TransicaoPlaceholder
- SolutionDetails.tsx
- useCsCxExperience.ts
- PosPanorama.tsx
- ContactAttentionDashboard
- migrate-cs-cx-files.mjs
- index.ts
- cs-cx-engagement-pdf.ts
- useCsCxNpsSurveys.ts
...
- chamados-official-sla-sync.test.ts
- cs-cx-engagement-permissions.test.tsx
- cs-cx-nps-webhook.ts
- AdminSettings.tsx
- ImplementerCharts.tsx
- Migração de dados CS/CX
- Gate de homologação CS/CX
- usePosAiChatVisitors.ts
- 3. Banco de dados
- 2. Motores de Conversão
- sd-attendance-bi.test.ts
- usePosAiChatVisitors.ts
- cs-cx-routines-report.test.ts
- Migração SistemaRegistro → CS/CX
- 3. Aderências Finalizadas
- cs-cx-schema-preflight.test.ts
- cs-cx-routine-observations.ts
- admin-layout-sidebar.test.tsx
- cs-cx-routines-permissions.test.tsx
- pos-ai-chat-visitor-management-migration.test.ts
- Checklist Público (Comercial)
- check-cs-cx-readiness.mjs
- deno.d.ts
- DeploymentsTickets.mobile.test.tsx
- useDeploymentForms.ts
- prepare-ellevo-hours-view.mjs
- sonner.tsx
- Dashboard Executivo (Analytics)
- pos-chat-visitor-dialog.test.tsx
- Últimas Implantações
- v
- compilerOptions
- index.ts
- pos-ai-chat-clear-conversations-migration.test.ts
- 6. Documento de Transição de Conhecimento — DTC
- chamados-client-options-migration.test.ts
- pos-ai-chat-admin-hardening-migration.test.ts
- cs-cx-record-ownership-migration.test.ts
- index.ts
- cs-cx-appointment-leads-migration.test.ts
- cs-cx-nps-product-migration.test.ts
- cs-cx-nps-questionnaires-rls.test.ts
- cs-cx-office-responsibles-migration.test.ts
- cs-cx-routine-admin-migration.test.ts
- cs-cx-routine-history-migration.test.ts
- cs-cx-routine-product-tabs-migration.test.ts
- pos-ai-visitor-admin-analytics-migration.test.ts
- pos-chat-visitor-migration.test.ts
- index.ts
- index.ts
- 7. Checklists de Implantação
- Página 404 (Not Found)
...
- `CustomImageUploadWidget()` --indirect_call--> `err()`  [INFERRED]
  src/components/FormRenderer/FormRenderer.tsx → .agent/skills/typescript-expert/references/utility-types.ts
- `DeploymentDetailsDialog()` --indirect_call--> `err()`  [INFERRED]
  src/components/ProjectManagement/DeploymentDetailsDialog.tsx → .agent/skills/typescript-expert/references/utility-types.ts
...
## Communities (418 total, 97 thin omitted)
...
Cohesion: 0.07
Nodes (24): AdherenceQuestionValue, ArrayFieldTemplateItem, checkHasAdherenceQuestions(), CustomArrayFieldTemplate(), CustomCheckboxWidget(), customFields, CustomFieldTemplate(), CustomObjectFieldTemplate() (+16 more)

### Community 2 - "App Routes & Pages"
Cohesion: 0.03
Nodes (73): AderenciasFinalizadas, AdminDashboard, AdminLayout, AdminSettings, AgendaAnalistas, Analytics, AuditLogPage, Calendar (+65 more)
...
Cohesion: 0.07
Nodes (44): ChecklistEditor(), ChecklistEditorProps, SYSTEM_TYPES, convertVisualToJSONSchema(), convertVisualToUISchema(), parseJSONSchemaToVisual(), VisualQuestion, VisualQuestionBuilder() (+36 more)

### Community 8 - "Charts, KPI & Reports"
Cohesion: 0.09
Nodes (43): Chamado0800DetailDialog(), fmtDateBr(), fmtDateTimeBr(), formatTicketDuration(), statusBadgeClass(), PostChamados0800(), PostChamados0800Props, PosAiAssistantSection() (+35 more)
...
Cohesion: 0.17
Nodes (23): CalendarControls(), CalendarGrid(), CalendarGridProps, DayDroppableZone(), CalendarLegend(), DraggableTeamMember(), DraggableTeamMemberProps, CalendarEventPill() (+15 more)
...
Cohesion: 0.06
Nodes (33): react, SummaryCard(), AdherenceImpactSummary(), AdherenceQuestionField(), CustomImageUploadWidget(), formatToDateMask(), getImpactedItems(), DeploymentDetailsDialog() (+25 more)
...
Cohesion: 0.05
Nodes (36): copyText(), formatDate(), NpsInvitationsPanel(), useCsCxRegistryOffices(), CsCxVisit, canAccessCsCxRecord(), CsCxOwnedResource, useCsCxRecordPermissions() (+28 more)
...
Cohesion: 0.12
Nodes (32): SolutionForm(), DeleteTarget, errorCode(), systemNameCollator, SystemsManager(), Solutions(), SolutionsTab, attachmentStorageName() (+24 more)

### Community 26 - "Project Transformers & Stages"
Cohesion: 0.10
Nodes (29): ProjectStatusChartProps, STATUS_LABELS, AdminSettings(), STAGE_LABELS, getInitials(), ImplementerProfileCard(), SortOption, ImplementerStageAnalysisProps (+21 more)

### Community 27 - "use-toast Reducer"
Cohesion: 0.06
Nodes (41): CriticalAlerts(), CriticalAlertsProps, DashboardTableProps, PipelineStatusProps, ProjectDetailsModalProps, DeploymentCard(), DeploymentCardProps, DeploymentDetailsDialogProps (+33 more)

### Community 28 - "Project Modal & Kanban"
Cohesion: 0.10
Nodes (26): AttentionRow, ContactAttentionDashboardProps, CS_CX_REQUEST_STATUSES, CsCxOfficeProduct, CsCxOfficeResponsible, CsCxProductResponsible, CsCxRegistryOffice, CsCxRequestInput (+18 more)
...
Cohesion: 0.29
Nodes (16): appProperties(), buildXlsxWorkbook(), cellXml(), columnName(), contentTypes(), coreProperties(), escapeXml(), rootRelationships() (+8 more)
...
Cohesion: 0.10
Nodes (26): NOTIFICATION_TYPE_ICONS, PosChatHistorySidebarProps, AlertTitle, DropdownMenuContent, DropdownMenuItem, DropdownMenuLabel, DropdownMenuRadioItem, DropdownMenuSeparator (+18 more)

### Community 35 - "Post Observations Editor"
Cohesion: 0.12
Nodes (22): clamp(), FloatingCopilot(), maxWidth(), RestoreVersionModal(), RestoreVersionModalProps, VersionDetailModal(), VersionDetailModalProps, VersionHistoryDrawerProps (+14 more)
...
### Community 37 - "sd-solutions.ts"
Cohesion: 0.13
Nodes (30): ConversionStageFormProps, EnvironmentStageFormProps, InfraStageFormProps, ProjectRow, useProjectsList(), userProjectsListTransform(), Analytics(), AdherenceStageV2 (+22 more)
...
Cohesion: 0.10
Nodes (39): ArticleMetadataCard(), ArticleMetadataCardProps, ArticleNavigator(), ArticleNavigatorProps, BunnyVideoModalProps, CreateRoutineModal(), CreateRoutineModalProps, SavePublishModal() (+31 more)
...
### Community 43 - "chamadosSync.ts"
Cohesion: 0.08
Nodes (40): err(), AderenciasFinalizadas(), normalizeChamadoStatus(), STATUS_BY_KEY, assertProcessoVendaRunActive(), cancelActiveRequestWhenSuperseded(), cancelProcessoVendaRun(), claimProcessoVendaRequest() (+32 more)
...
Cohesion: 0.16
Nodes (19): SearchableClientOption, SearchableClientSelectProps, CsCxMultiSelectOption, CsCxMultiSelectProps, COLORS, FONT_SIZES, ProjectSelectorProps, Command (+11 more)

### Community 46 - "SolutionsSearch.tsx"
Cohesion: 0.22
Nodes (13): errorCode(), FamiliesManager(), FamiliesManagerProps, nameCollator, Alert, AlertDescription, alertVariants, createSdFamily() (+5 more)
...
### Community 48 - "Toggle Component"
Cohesion: 0.21
Nodes (16): BunnyVideoModal(), UnsavedChangesDialogProps, ObservationsWithAIProps, StatusType, AiRichTextFieldProps, AlertDialogAction, AlertDialogCancel, AlertDialogContent (+8 more)
...
### Community 59 - "📘 Guia Completo: Área de Conversão"
Cohesion: 0.04
...
### Community 60 - "Postgres Best Practices"
Cohesion: 0.05
...
### Community 61 - "🎯 Siplan Hub - Relatório Final de Otimização (3 Fases Completas)"
Cohesion: 0.05
Nodes (41): 1. Functions com search_path corrigidas (6), 1. Índices em Foreign Keys (4), 2. RLS InitPlan Otimizado (3 tabelas), 2. RLS Policies Refatoradas (8 tabelas), 3. Policies Duplicadas Removidas, 📝 Arquivos Modificados, Arquivos Otimizados, Baixa Prioridade (+33 more)

### Community 62 - "UI/UX Pro Max - Design Intelligence"
Cohesion: 0.05
...
### Community 63 - "REST API Best Practices"
Cohesion: 0.05
...
### Community 64 - "InterviewAnalyzer"
Cohesion: 0.07
...
### Community 67 - "GraphQL Schema Design Patterns"
Cohesion: 0.06
...
### Community 68 - "Product Manager Toolkit"
Cohesion: 0.06
Nodes (34): Best Practices, Common Pitfalls to Avoid, Core Workflows, Customer Discovery Process, Customer Discovery Tips, customer_interview_analyzer.py, Customer Interview Guide, Discovery Frameworks (+26 more)
...
### Community 70 - "TypeScript Expert"
Cohesion: 0.06
Nodes (34): Advanced Patterns, Advanced Type System Expertise, AI-Assisted Development, Biome vs ESLint, CLI Debugging Tools, Code Organization, Code Review Checklist, Complex Error Patterns (+26 more)

### Community 71 - "Web Performance Optimization"
Cohesion: 0.06
Nodes (33): Additional Resources, Analysis Tools, Best Practices, Caching, Common Pitfalls, Core Web Vitals, CSS, ✅ Do This (+25 more)

### Community 72 - "🛠️ Manual do Desenvolvedor: Siplan Hub"
Cohesion: 0.06
...
### Community 73 - "🔧 Build Warnings - Correções Aplicadas"
Cohesion: 0.06
Nodes (30): Análise de Bundle, 📝 Arquivos Modificados, Benefícios Problema 1, Benefícios Problema 2, Benefícios Problema 3, Build de Produção, 🔧 Build Warnings - Correções Aplicadas, ✅ Checklist de Deploy (+22 more)

### Community 74 - "ProjectV2"
Cohesion: 0.22
...
### Community 75 - "React Patterns"
Cohesion: 0.07
Nodes (27): 10. Anti-Patterns, 1. Component Design Principles, 2. Hook Patterns, 3. State Management Selection, 4. React 19 Patterns, 5. Composition Patterns, 6. Performance Principles, 7. Error Handling (+19 more)

### Community 76 - "What You Must Do When Invoked"
Cohesion: 0.07
Nodes (26): For /graphify add and --watch, For /graphify query, For the commit hook and native CLAUDE.md integration, For --update and --cluster-only, /graphify, Honesty Rules, Interpreter guard for subcommands, Part A - Structural extraction for code files (+18 more)

### Community 77 - "Git Advanced Workflows"
Cohesion: 0.08
...
### Community 78 - "Modern JavaScript Patterns"
Cohesion: 0.08
...
### Community 79 - "KPI Dashboard Design"
Cohesion: 0.08
...
### Community 80 - "What You Must Do When Invoked"
Cohesion: 0.08
Nodes (24): For /graphify add and --watch, For /graphify query, For the commit hook and native CLAUDE.md integration, For --update and --cluster-only, /graphify, Honesty Rules, Interpreter guard for subcommands, Part A - Structural extraction for code files (+16 more)

### Community 81 - "SQL Optimization Patterns"
Cohesion: 0.08
...
### Community 82 - "Pre-Implementation Review"
Cohesion: 0.09
...
### Community 83 - "rest-api-template.py"
Cohesion: 0.17
...
### Community 84 - "Authentication and Authorization Implementation Patterns Implementation Playbook"
Cohesion: 0.09
...
### Community 86 - "React State Management"
Cohesion: 0.09
...
### Community 88 - "AI-Driven Predictability Features - Implementação Concluída"
Cohesion: 0.09
Nodes (21): 1. **Visual "Ready to Advance" Signals** ✅, 2. **Critical Path Indicator** (Gargalo Atual) ✅, AI-Driven Predictability Features - Implementação Concluída, Animações e Efeitos Visuais, Arquivos Criados/Modificados, Benefícios, Cenário 1: Etapa Pronta para Avançar, Cenário 2: Projeto com Gargalo (+13 more)
...
### Community 91 - "API Design Principles Implementation Playbook"
Cohesion: 0.10
...
### Community 92 - "Playwright Skill - Complete API Reference"
Cohesion: 0.10
Nodes (20): Accessibility Testing, Additional Resources, Assertions, Basic Page Object, Best Practices, Common Assertions, Common Issues, Data-Driven Testing (+12 more)

### Community 93 - "Tailwind Design System"
Cohesion: 0.10
...
### Community 95 - "Error Handling Patterns"
Cohesion: 0.11
...
### Community 100 - "Playwright Browser Automation"
Cohesion: 0.12
Nodes (14): Advanced Usage, Available Helpers, Configuration, Custom HTTP Headers, Example Usage, Execution Pattern, How It Works, How It Works (+6 more)

### Community 101 - "Writing Guidelines for Postgres Rules"
Cohesion: 0.12
...
### Community 104 - "TypeScript Cheatsheet"
Cohesion: 0.13
...
### Community 105 - "CLAUDE.md — Siplan Hub"
Cohesion: 0.12
Nodes (15): A persistência: `src/utils/project-transformers.ts`, Arquitetura em uma frase, CLAUDE.md — Siplan Hub, Comandos, Cross-cutting, Fronteira da VM Worker (`vm-worker/src/index.ts`), graphify, Idioma (obrigatório) (+7 more)

### Community 106 - "README.md"
Cohesion: 0.19
Nodes (5): Documentação do Siplan Hub, Component Check, Design System Verification, Visual QA Checklist, SiplanHUB — VM Worker (geração automática de modelos)

### Community 107 - "Clean Code - Pragmatic AI Coding Standards"
Cohesion: 0.14
...
### Community 109 - "Automated Unit Test Generation"
Cohesion: 0.14
...
### Community 112 - "🚀 Siplan Hub - Relatório Final de Otimização"
Cohesion: 0.14
Nodes (13): Eliminações:, ✅ FASE 1: Type Safety (COMPLETA - 88% redução em `as any`), ✅ FASE 2: Database Optimization (COMPLETA - 93% redução vulnerabilidades), 📋 FASE 3: React Patterns (ANÁLISE), Identificado:, 🎯 Impacto Total, Migrations:, Performance: (+5 more)

### Community 113 - "Standard PRD Template"
Cohesion: 0.15
...
Cohesion: 0.20
Nodes (8): matchesRegistryOfficeFilters(), deleteObservationMutation, deleteRoutineMutation, hasPermission, mutation, { printOfficesReport, printRequestsReport }, routineMutation, updateObservationMutation
...
### Community 117 - "Caveman Compress"
Cohesion: 0.17
Nodes (11): Boundaries, Caveman Compress, Compress, Compression Rules, Pattern, Preserve EXACTLY (never modify), Preserve Structure, Process (+3 more)

### Community 118 - "SKILL.md"
Cohesion: 0.17
Nodes (10): caveman, Example output, How to invoke, See also, What it does, Auto-Clarity, Boundaries, Intensity (+2 more)

### Community 119 - "Página 404 (Not Found)"
Cohesion: 0.05
Nodes (31): dateFormatter, formatLastActivity(), integerFormatter, PosAiVisitorAnalytics(), PosAiVisitorAnalyticsProps, usdFormatter, ActivePosAiProjectOption, PosAiAdminAnalyticsData (+23 more)

### Community 121 - "Anti-Patterns"
Cohesion: 0.18
Nodes (10): Anti-Patterns, Email Event Tracking, Email Systems, ❌ HTML email soup, ❌ Huge image emails, ❌ No plain text fallback, Patterns, ⚠️ Sharp Edges (+2 more)

### Community 122 - "[Feature Name] - One-Page PRD"
Cohesion: 0.18
Nodes (11): [Feature Name] - One-Page PRD, Open Questions, Problem, Resources, Risks, Scope, Solution, Success Metrics (+3 more)

### Community 123 - "caveman-commit"
Cohesion: 0.18
Nodes (9): caveman-commit, Example output, How to invoke, See also, What it does, Auto-Clarity, Boundaries, Examples (+1 more)

### Community 124 - "caveman-review"
Cohesion: 0.18
Nodes (9): caveman-review, Example output, How to invoke, See also, What it does, Auto-Clarity, Boundaries, Examples (+1 more)

### Community 125 - "Graph Report - .  (2026-07-08)"
Cohesion: 0.18
...
### Community 126 - "Section Definitions"
Cohesion: 0.20
Nodes (9): 1. Query Performance (query), 2. Connection Management (conn), 3. Security & RLS (security), 4. Schema Design (schema), 5. Concurrency & Locking (lock), 6. Data Access Patterns (data), 7. Monitoring & Diagnostics (monitor), 8. Advanced Features (advanced) (+1 more)

### Community 127 - "📚 Índice de Módulos"
Cohesion: 0.20
...
### Community 128 - "Concise Planning"
Cohesion: 0.22
Nodes (8): 1. Scan Context, 2. Minimal Interaction, 3. Generate Plan, Checklist Guidelines, Concise Planning, Goal, Plan Template, Workflow

### Community 129 - "Monitoring and Observability Setup"
Cohesion: 0.22
...
### Community 130 - "Best Practices"
Cohesion: 0.22
Nodes (8): Anti-Patterns to Avoid, Architecture and Design, Best Practices, Code Quality, Code Style Rules, General Principles, Library-First Approach, Software Architecture Development Skill
...
### Community 132 - "graphify reference: extra exports and benchmark"
Cohesion: 0.22
Nodes (8): graphify reference: extra exports and benchmark, Step 6b - Wiki (only if --wiki flag), Step 7 - Neo4j export (only if --neo4j or --neo4j-push flag), Step 7a - FalkorDB export (only if --falkordb or --falkordb-push flag), Step 7b - SVG export (only if --svg flag), Step 7c - GraphML export (only if --graphml flag), Step 7d - MCP server (only if --mcp flag), Step 8 - Token reduction benchmark (only if total_words > 5000)

### Community 133 - "🪝 Referência de Hooks"
Cohesion: 0.22
...
### Community 136 - "filterStore.ts"
Cohesion: 0.10
Nodes (36): SolutionDetailsProps, SolutionFormProps, formatDate(), HighlightedText(), SolutionCard(), SolutionCardProps, SolutionsSearch(), SolutionsSearchProps (+28 more)

### Community 137 - "Accessibility Audit and Testing"
Cohesion: 0.25
...
### Community 139 - "GEMINI.md"
Cohesion: 0.09
Nodes (25): jspdf, Bloco, escapeHtml(), MarkdownLite(), markdownLiteToHtml(), parseBlocos(), renderInline(), PosSaudeBadge() (+17 more)

### Community 140 - "chart.tsx"
Cohesion: 0.14
Nodes (22): CsCxNpsResponse, buildNpsAiSource(), buildNpsAnalytics(), compact(), EMPTY_NPS_FILTERS, filterNpsResponses(), formatDate(), metrics() (+14 more)
...
### Community 143 - "Migration Principles"
Cohesion: 0.29
...
### Community 144 - "Schema Design Principles"
Cohesion: 0.29
...
### Community 145 - "find_schema_files"
Cohesion: 0.48
Nodes (6): find_schema_files(), main(), Path, Find database schema files., Validate Prisma schema file., validate_prisma_schema()

### Community 146 - "SKILL.md"
Cohesion: 0.29
Nodes (6): Approach, Do not use this skill when, Focus Areas, Instructions, Output, Use this skill when

### Community 147 - "Common Patterns"
Cohesion: 0.29
Nodes (7): Check for Broken Links, Common Patterns, Fill and Submit Form, Take Screenshot with Error Handling, Test a Page (Multiple Viewports), Test Login Flow, Test Responsive Design

### Community 148 - "caveman-stats"
Cohesion: 0.29
Nodes (5): caveman-stats, Example output, How to invoke, See also, What it does

### Community 149 - "Automação (deploy + migrations + alerta)"
Cohesion: 0.29
...
### Community 150 - "Arquitetura do Projeto Siplan Hub"
Cohesion: 0.29
...
### Community 151 - "Documentação Técnica: Calendar Component"
Cohesion: 0.29
...
### Community 152 - "1. Home (Hub de Navegação)"
Cohesion: 0.29
...
### Community 153 - "2. Dashboard (Visão Geral)"
Cohesion: 0.29
...
### Community 155 - "4. Projetos Ativos (Listagem)"
Cohesion: 0.29
...
### Community 156 - "5. Detalhes do Projeto"
Cohesion: 0.29
...
### Community 157 - "6. Análise de Aderência"
Cohesion: 0.13
Nodes (15): CsCxRequestStatusConfig, CatalogKind, CsCxAdmin(), DeleteTarget, EMPTY_CATALOG, EMPTY_ITEM, EMPTY_MODEL, EMPTY_PRODUCT (+7 more)

### Community 158 - "7. Comparar Projetos"
Cohesion: 0.29
...
### Community 159 - "1. Painel de Clientes"
Cohesion: 0.29
...
### Community 160 - "2. Visão 360º do Cliente"
Cohesion: 0.29
...
### Community 161 - "3. Timeline do Cliente"
Cohesion: 0.29
...
### Community 162 - "4. Central de Bloqueios"
Cohesion: 0.29
...
### Community 163 - "5. Contatos & Clientes"
Cohesion: 0.13
Nodes (12): DeploymentFormFields(), formatPhone(), Props, RadioGroup, RadioGroupItem, checklists, forms, {
  useCommercialChecklistsMock,
  useDeploymentFormsMock,
  useProjectsV2Mock,
} (+4 more)

### Community 164 - "6. Formulários de Implantação"
Cohesion: 0.29
...
### Community 165 - "7. Checklists de Implantação"
Cohesion: 0.25
Nodes (10): emptyPage(), fetchPosAiChatConversationsPage(), PosAiConversationGroup, PosAiConversationMessage, PosAiConversationPage, PosAiConversationPageParams, PosAiVisitorOption, usePosAiChatConversations() (+2 more)

### Community 166 - "8. Editor de Perguntas do Checklist"
Cohesion: 0.29
...
### Community 167 - "Armazenamento do Sistema"
Cohesion: 0.29
...
### Community 168 - "Dashboard Administrativo"
Cohesion: 0.29
...
### Community 169 - "Gerenciamento de Usuários"
Cohesion: 0.29
...
### Community 170 - "Perfis de Acesso (Roles)"
Cohesion: 0.29
...
### Community 171 - "Configurações do Time / Equipes"
Cohesion: 0.29
...
### Community 172 - "Log de Auditoria"
Cohesion: 0.29
...
### Community 173 - "Saúde dos Projetos (Configurações)"
Cohesion: 0.29
...
### Community 174 - "Gestão de Férias"
Cohesion: 0.29
...
### Community 175 - "Usuários Inativos"
Cohesion: 0.29
...
### Community 176 - "TeamAreasManagement (componente auxiliar)"
Cohesion: 0.29
...
### Community 177 - "Agenda dos Analistas"
Cohesion: 0.19
Nodes (16): CsCxAppointment, decodeAppointmentObservations(), encodeAppointmentObservations(), formatAppointmentObservations(), normalizeAppointmentObservations(), APPOINTMENT_STATUS_LABELS, APPOINTMENT_TYPE_LABELS, formatDate() (+8 more)

### Community 178 - "FamiliesManager.tsx"
Cohesion: 0.13
Nodes (8): apply, args, bucket, download(), isMissingObjectError(), legacyRoot, projectRef, target

### Community 179 - "Dashboard Executivo (Analytics)"
Cohesion: 0.29
...
### Community 180 - "Relatórios & Análises"
Cohesion: 0.16
Nodes (14): PosAiChatLinksManager(), initials(), PosAiChatUsersManager(), downloadCsv(), escapeCsvValue(), ErrorLike, getErrorMessage(), CHAT_PAGE_SIZE_OPTIONS (+6 more)

### Community 181 - "Roadmap do Cliente (Portal Público)"
Cohesion: 0.13
Nodes (21): decodeRoutineObservations(), encodeRoutineObservations(), formatRoutineObservations(), normalizeRoutineObservations(), ActionBadge(), actionLabel(), CsCxRoutines(), formatDate() (+13 more)

### Community 182 - "FallbackChecklistForm.tsx"
Cohesion: 0.43
Nodes (5): authDb, AuthContext, AuthContextType, Permission, UserRole

### Community 183 - "Últimas Implantações"
Cohesion: 0.32
Nodes (7): fmt(), getSpeechRecognition(), pickMimeType(), VoiceDictationButton(), extFromMime(), mapJob(), useVoiceNoteJobs()

### Community 184 - "Login"
Cohesion: 0.06
Nodes (35): EnvironmentScreenshotsProps, ModelosEditorWorkspace(), normalizeModelName(), pairKeyFor(), mapHeartbeat(), mapJob(), useModelGenerationJobs(), useModelWorkerStatus() (+27 more)

### Community 185 - "CsCxReports.tsx"
Cohesion: 0.17
Nodes (13): AdherenceGapCard(), AdherenceGapCardProps, HealthDistribution(), IndividualProjectReport(), IndividualProjectReportProps, ProjectHeaderStats(), StageAnalysisTimeline(), StatusDistribution() (+5 more)

### Community 186 - "package.json"
Cohesion: 0.15
Nodes (12): ContextualHeaderAction, getContextualHeaderAction(), matchesPath(), MainLayout(), MainLayoutProps, ModeToggle(), NotificationBell(), SidebarProvider (+4 more)

### Community 187 - "API Design Principles"
Cohesion: 0.33
Nodes (5): API Design Principles, Do not use this skill when, Instructions, Resources, Use this skill when

### Community 188 - "Database Design"
Cohesion: 0.33
Nodes (5): Anti-Patterns, ⚠️ Core Principle, Database Design, Decision Checklist, 🎯 Selective Reading Rule

### Community 189 - "Error Handling Patterns"
Cohesion: 0.33
Nodes (5): Do not use this skill when, Error Handling Patterns, Instructions, Resources, Use this skill when

### Community 190 - "Modern JavaScript Patterns"
Cohesion: 0.33
Nodes (5): Do not use this skill when, Instructions, Modern JavaScript Patterns, Resources, Use this skill when

### Community 191 - "Postgres Best Practices - Contributor Guide"
Cohesion: 0.33
Nodes (5): Creating a New Rule, Postgres Best Practices - Contributor Guide, Quick Start, Repository Structure, Rule File Structure

### Community 192 - "Supabase Postgres Best Practices"
Cohesion: 0.33
Nodes (5): Full Compiled Document, How to Use, Rule Categories by Priority, Supabase Postgres Best Practices, When to Apply

### Community 193 - "Feature: [Name]"
Cohesion: 0.33
Nodes (6): Context, Effort Estimate, Feature: [Name], Hypothesis, Next Steps, Proposed Solution

### Community 194 - "SQL Optimization Patterns"
Cohesion: 0.33
Nodes (5): Do not use this skill when, Instructions, Resources, SQL Optimization Patterns, Use this skill when

### Community 195 - "Tailwind Design System"
Cohesion: 0.33
...
### Community 197 - "graphify reference: query, path, explain"
Cohesion: 0.33
Nodes (5): For /graphify explain, For /graphify path, graphify reference: query, path, explain, Step 0 — Constrained query expansion (REQUIRED before traversal), Step 1 — Traversal

### Community 198 - "🗄️ Modelo de Dados (Supabase / PostgreSQL)"
Cohesion: 0.33
...
### Community 199 - "TeamManagement (legado/descontinuado)"
Cohesion: 0.33
...
### Community 200 - "RolesManagement.tsx"
Cohesion: 0.15
Nodes (11): GLOBAL_STATUS_LABELS, GLOBAL_STATUS_VARIANTS, ImplementerOtherStagesProps, ImplementerProjectsListProps, Progress, ImplementerInvolvement, Column, COLUMNS (+3 more)

### Community 201 - "Database Selection (2025)"
Cohesion: 0.40
Nodes (4): Comparison, Database Selection (2025), Decision Tree, Questions to Ask

### Community 202 - "Indexing Principles"
Cohesion: 0.40
Nodes (4): Composite Index Principles, Index Type Selection, Indexing Principles, When to Create Indexes

### Community 203 - "Query Optimization"
Cohesion: 0.40
Nodes (4): N+1 Problem, Optimization Priorities, Query Analysis Mindset, Query Optimization

### Community 204 - "Common Patterns & Solutions"
Cohesion: 0.40
Nodes (5): Common Patterns & Solutions, File Downloads, Handling Popups, iFrames, Infinite Scroll

### Community 205 - "Product Requirements Document (PRD) Templates"
Cohesion: 0.40
Nodes (4): Agile Epic Template, Feature Brief Template (Lightweight), One-Page PRD Template, Product Requirements Document (PRD) Templates

### Community 206 - "3. Solution Overview"
Cohesion: 0.40
Nodes (5): 3.1 Proposed Solution, 3.2 In Scope, 3.3 Out of Scope, 3.4 MVP Definition, 3. Solution Overview

### Community 207 - "6. Technical Specifications"
Cohesion: 0.40
...
### Community 208 - "Módulo Comercial — Documentação por Tela"
Cohesion: 0.10
Nodes (27): CS_CX_APPOINTMENT_STATUSES, CS_CX_APPOINTMENT_TYPES, CsCxAppointmentInput, CsCxContact, CsCxContactInput, CsCxProfileOption, currentUser(), db (+19 more)

### Community 209 - "Módulo Administração"
Cohesion: 0.40
Nodes (4): AdminLayout (navegação e controle de acesso), Modelo RBAC (visão geral), Módulo Administração, Sumário

### Community 210 - "ORM Selection (2025)"
Cohesion: 0.50
Nodes (3): Comparison, Decision Tree, ORM Selection (2025)

### Community 211 - "Common Actions"
Cohesion: 0.50
Nodes (4): Common Actions, Form Interactions, Keyboard Actions, Mouse Actions

### Community 212 - "4. User Stories & Requirements"
Cohesion: 0.50
Nodes (4): 4.1 User Stories, 4.2 Functional Requirements, 4.3 Non-Functional Requirements, 4. User Stories & Requirements

### Community 213 - "5. Design & User Experience"
Cohesion: 0.50
Nodes (4): 5.1 Design Principles, 5.2 Wireframes/Mockups, 5.3 Information Architecture, 5. Design & User Experience

### Community 214 - "7. Go-to-Market Strategy"
Cohesion: 0.50
Nodes (4): 7.1 Launch Plan, 7.2 Pricing Strategy, 7.3 Success Metrics, 7. Go-to-Market Strategy

### Community 215 - "graphify reference: add a URL and watch a folder"
Cohesion: 0.50
Nodes (3): For /graphify add, For --watch, graphify reference: add a URL and watch a folder

### Community 216 - "graphify reference: commit hook and native CLAUDE.md integration"
Cohesion: 0.50
Nodes (3): For git commit hook, For native CLAUDE.md integration, graphify reference: commit hook and native CLAUDE.md integration

### Community 217 - "graphify reference: incremental update and cluster-only"
Cohesion: 0.50
...
### Community 221 - "NpsAnalytics.tsx"
Cohesion: 0.09
Nodes (31): CollapsibleFieldSection(), CollapsibleFieldSectionProps, getEditorContent(), ObservationsWithAI(), obsTextLen(), walkText(), ProjectHeaderForm(), ProjectHeaderFormProps (+23 more)

### Community 222 - "Selectors & Locators"
Cohesion: 0.67
Nodes (3): Advanced Locator Patterns, Best Practices for Selectors, Selectors & Locators

### Community 223 - "Core Patterns"
Cohesion: 0.67
Nodes (3): Basic Browser Automation, Core Patterns, Test Structure

### Community 224 - "Installation & Setup"
Cohesion: 0.67
Nodes (3): Basic Configuration, Installation & Setup, Prerequisites

### Community 225 - "Network & API Testing"
Cohesion: 0.67
Nodes (3): Custom Headers via Environment Variables, Intercepting Requests, Network & API Testing

### Community 226 - "Debugging"
Cohesion: 0.67
Nodes (3): Debug Mode, Debugging, In-Code Debugging

### Community 231 - "🗄️ Configuração Local do Supabase (Ambiente de Desenvolvimento)"
Cohesion: 0.15
Nodes (10): CsCxRegistryOffices(), DataError(), emptyForm, errorMessage(), formatDate(), OfficeForm, OfficeProductForm, RegistryOfficeFilters (+2 more)
...
### Community 272 - "Módulo: Calendário, Agenda, Analytics, Relatórios, Roadmap e Implantações"
Cohesion: 0.25
Nodes (13): AreaSlaPolicy, buildAreaSlaPolicies(), canonicalCriticality(), criticalityRank(), formatMinutes(), normalizeText(), SlaPolicyObservation, chamados (+5 more)

### Community 295 - "ProtectedRoute.tsx"
Cohesion: 0.14
Nodes (19): DashboardTable(), HealthBadge(), HealthBadgeProps, PipelineStatus(), ProjectDetailsModal(), ButtonProps, Pagination(), PaginationContent (+11 more)

### Community 296 - "commercial-contacts-permissions.test.tsx"
Cohesion: 0.50
Nodes (3): clients, contacts, { useCommercialMock }

### Community 297 - "TicketsAiAnalysis.tsx"
Cohesion: 0.12
Nodes (30): STATUS_COLORS, TicketsAiAnalysis(), tooltipStyle, truncate(), ChamadoReportRow, fetchAllChamados(), fetchAllChamadosForReport(), hashFilterKey() (+22 more)

### Community 298 - "LogsTab.tsx"
Cohesion: 0.14
Nodes (23): AiTarget, Block, blockTextLen(), blockToPlain(), escapeHtml(), fmtDate(), inlineHtml(), lexToHtml() (+15 more)

### Community 299 - "PipelineStatus.tsx"
Cohesion: 0.07
Nodes (46): AppSidebar(), UserProfileDrawer(), ProtectedRoute(), FallbackChecklistForm(), FallbackChecklistFormProps, useIsMobile(), useTheme(), useToast() (+38 more)
...
### Community 301 - "CsCxRegistryOffices.tsx"
Cohesion: 0.10
Nodes (60): StatusFilter, ConversionIssuesTabProps, PRIORITIES, STATUSES, NewPostForm(), STAGE_OPTIONS, EMPTY_PROFILE, VisualQuestionBuilderProps (+52 more)

### Community 302 - "project-transformers.ts"
Cohesion: 0.20
Nodes (14): escapeHtml(), highlightTechnicalCode(), prepareTechnicalHtml(), SdSolutionContent(), SdSolutionContentProps, SQL_KEYWORDS, AttachmentPreview, SolutionRichTextEditor() (+6 more)

### Community 304 - "usePosAiAdminAnalytics.ts"
Cohesion: 0.11
...
### Community 305 - "cs-cx-nps-analytics.ts"
Cohesion: 0.14
Nodes (17): isEmptyAnswer(), loadInvitation(), messageOf(), NpsScale(), PublicNpsResponse(), RatingScale(), StateCard(), statusDescription() (+9 more)

### Community 306 - "cs-cx-experience-pdf.ts"
Cohesion: 0.20
Nodes (16): calculateCsCxReportRowLayout(), clean(), CsCxPdfOutputOptions, CsCxReportRowLayout, CsCxSummaryItem, formatDate(), formatDateTime(), generateCsCxNpsAnalysisPdf() (+8 more)

### Community 307 - "useSdAttendanceBi.ts"
Cohesion: 0.09
Nodes (19): db, EMPTY_BI, normalizeBiData(), SdAttendanceBiBreakdown, SdAttendanceBiData, SdAttendanceBiFilters, SdAttendanceBiMetrics, useSdAttendanceBi() (+11 more)

### Community 308 - "CompactQueueCard.tsx"
Cohesion: 0.29
...
### Community 313 - "ProjectCardV3.tsx"
Cohesion: 0.10
Nodes (25): ConversionPostDrawer(), ConversionPostDrawerProps, STATUS_LABELS, ConversionPostFeed(), ConversionPostFeedProps, formatPostDate(), getInitials(), groupPostsByDate() (+17 more)

### Community 315 - "PipelineStatus.tsx"
Cohesion: 0.50
...
### Community 317 - "CopilotChat.tsx"
Cohesion: 0.12
Nodes (20): ChamadosClientOption, isProcessoVendaSyncSupersededError(), ProcessoVendaSyncFilters, useChamadosClientOptions(), useSolicitarSyncProcessoVenda(), CHAMADOS_CATALOG_CONFIG, CHAMADOS_LEGACY_PRODUCT_GROUPS, getCatalogSoftwarePattern() (+12 more)

### Community 318 - "cs-cx-nps-survey.ts"
Cohesion: 0.27
...
### Community 319 - "TransicaoPlaceholder"
Cohesion: 0.19
Nodes (11): CompactQueueCard(), CompactQueueCardProps, STATUS_COLORS, STATUS_LABELS, ProjectInfo, ProjectInfoSection(), ProjectInfoSectionProps, ConversionKPIs (+3 more)

### Community 320 - "SolutionDetails.tsx"
Cohesion: 0.17
Nodes (20): attachmentSecurity(), clampPanelWidth(), longDate(), maxPanelWidth(), shortDate(), SolutionDetails(), canPreviewSdAttachment(), isSdSolutionReviewOverdue() (+12 more)

### Community 321 - "useCsCxExperience.ts"
Cohesion: 0.13
...
### Community 322 - "PosPanorama.tsx"
Cohesion: 0.14
Nodes (24): TicketsAiAnalysisProps, TicketsSlaAnalysisProps, TicketsSlaSectorAnalysisProps, Chamado0800DetailDialogProps, ChamadosSearchFilters, ChamadosCatalog, getChamadosProductLabel(), ChamadosReportFilters (+16 more)

### Community 323 - "ContactAttentionDashboard"
Cohesion: 0.19
Nodes (19): CsCxOfficeRoutine, CsCxRoutineModel, buildCsCxRoutinesWorkbook(), buildRoutineReportAnalytics(), formatDateTime(), generateCsCxRoutinePdf(), generateCsCxRoutinesPdf(), generateCsCxRoutinesXlsx() (+11 more)

### Community 324 - "migrate-cs-cx-files.mjs"
Cohesion: 0.26
...
### Community 326 - "cs-cx-engagement-pdf.ts"
Cohesion: 0.12
Nodes (16): DashboardKPI(), DashboardKPIProps, DashboardReport(), DashboardReportProps, KPICard(), KPICardProps, Breadcrumbs(), useKPIs() (+8 more)

### Community 327 - "useCsCxNpsSurveys.ts"
Cohesion: 0.23
Nodes (12): CreateNpsInvitationInput, currentUser(), db, effectiveInvitationStatus(), invalidateNpsSurveys(), RawInvitation, SaveQuestionnaireInput, useCsCxNpsSurveys() (+4 more)

### Community 328 - "processCopilotJob.ts"
Cohesion: 0.11
...
### Community 329 - "processDtcJob.ts"
Cohesion: 0.30
Nodes (15): AnyObj, buildContext(), buildPrompt(), buildStagesSection(), dumpStageExtras(), fmtDate(), humanVal(), lexToText() (+7 more)

### Community 330 - "sheet.tsx"
Cohesion: 0.21
Nodes (8): Editor(), editorConfig, nodes, Plugins(), ToolbarPlugin(), editorTheme, EditorContentEditable(), Props

### Community 331 - "processJob.ts"
Cohesion: 0.25
Nodes (7): AccessData, CsCxAccessCandidate, CsCxAccessProfile, CsCxAccessUser, CsCxModulePermission, db, QUERY_KEY

### Community 332 - "useCsCxAccess.ts"
Cohesion: 0.08
Nodes (46): PosAiChatLinksManagerProps, PAGE_SIZE_OPTIONS, PosAiChatUsersManagerProps, AttentionFilter, AttentionStatus, ContactAttentionDashboard(), filterForStatus(), formatDate() (+38 more)

### Community 333 - "ImplementerPhaseMetrics.tsx"
Cohesion: 0.35
...
### Community 334 - "v"
Cohesion: 0.20
Nodes (10): ConversionIssuesTab(), ConversionEngineItem, EngineKPIs, EngineStatus, useConversionEngines(), useConversionIssues(), useTeamAreas(), TeamAreasManagement() (+2 more)

### Community 335 - "formatLogDetails"
Cohesion: 0.22
Nodes (6): RoadmapData, RoadmapPage(), StageConfig, StageData, STAGES_CONFIG, TimelineItem()

### Community 336 - "CsCxNpsResponse"
Cohesion: 0.29
...
### Community 337 - "cs-cx-nps-public.test.ts"
Cohesion: 0.27
...
### Community 339 - "🚀 Guia Técnico: Sincronização Contínua e Rotação da Vector Store OpenAI com Zero Downtime — Siplan HUB"
Cohesion: 0.17
...
### Community 340 - "SimpleMarkdown.tsx"
Cohesion: 0.29
...
Cohesion: 0.10
Nodes (55): AREA_STAGE_OUTCOME, AreaJourneyRow(), formatDateTime(), matchesSlaCardFilter(), SLA_FILTER_LABELS, SlaCardFilter, SlaCheckpointCell(), TicketSlaRow() (+47 more)

### Community 343 - "6. Documento de Transição de Conhecimento — DTC"
Cohesion: 0.22
...
### Community 344 - "cs-cx-engagement-permissions.test.tsx"
Cohesion: 0.08
Nodes (30): ChartTooltipProps, healthColors, healthLabels, ImplementerCharts(), ImplementerChartsProps, statusColors, statusLabels, ImplementerKPIs() (+22 more)

### Community 345 - "3. Aderências Finalizadas"
Cohesion: 0.50
Nodes (3): groupFilterMigration, reportPage, timeHook

### Community 346 - "Próximas Implantações"
Cohesion: 0.29
...
### Community 347 - "chamados-official-sla-sync.test.ts"
Cohesion: 0.25
Nodes (6): migration, slaInfoDialog, slaScreen, slaSectorScreen, ticketsPage, worker

### Community 348 - "cs-cx-engagement-permissions.test.tsx"
Cohesion: 0.24
Nodes (6): SearchableClientSelect(), OfficeFilterCombobox(), paginateItems(), RoutineOfficeCombobox(), TicketFilterMultiSelect(), normalizeSearchText()

### Community 349 - "cs-cx-nps-webhook.ts"
Cohesion: 0.33
...
### Community 350 - "AdminSettings.tsx"
Cohesion: 0.29
...
### Community 351 - "ImplementerCharts.tsx"
Cohesion: 0.31
Nodes (7): formatPosChatTranscript(), PosChatMessage, ProjectPublicInfo, safeTranscriptFilename(), SessionActionResult, usePosAiChat(), UsePosAiChatOptions

### Community 352 - "Migração de dados CS/CX"
Cohesion: 0.22
...
### Community 353 - "Gate de homologação CS/CX"
Cohesion: 0.22
...
### Community 354 - "usePosAiChatVisitors.ts"
Cohesion: 0.29
Nodes (7): VisitorActionResult, fetchPosAiChatVisitorsPage(), PosAiChatVisitorAdmin, PosAiVisitorPage, PosAiVisitorPageParams, PosAiVisitorStatus, usePosAiChatVisitors()

### Community 355 - "3. Banco de dados"
Cohesion: 0.39
...
### Community 356 - "2. Motores de Conversão"
Cohesion: 0.29
...
### Community 357 - "sd-attendance-bi.test.ts"
Cohesion: 0.29
Nodes (6): app, hook, menu, migration, page, permissionCatalog

### Community 358 - "usePosAiChatVisitors.ts"
Cohesion: 0.36
Nodes (5): ReportsFilters(), ReportsFiltersProps, buttonVariants, Calendar(), CalendarProps

### Community 359 - "cs-cx-routines-report.test.ts"
Cohesion: 0.07
Nodes (47): emptyInterval(), TimeEntryDialog(), TimeEntryDialogProps, DropdownMenuCheckboxItem, db, normalizeEntry(), SaveSdTimeEntryInput, SdTimeBulkImportRequestRow (+39 more)
...
### Community 361 - "3. Aderências Finalizadas"
Cohesion: 0.29
Nodes (7): 3. Aderências Finalizadas, Componentes principais, Dados e Hooks, Fluxos e Interações, Objetivo, Pontos de Manutenção, Regras de Negócio e Estados

### Community 362 - "cs-cx-schema-preflight.test.ts"
Cohesion: 0.25
Nodes (7): fileMigrator, migrations, migrator, readiness, root, runner, workflow

### Community 363 - "cs-cx-routine-observations.ts"
Cohesion: 0.11
Nodes (18): Autenticação e Rotas Protegidas, AuthProvider / AuthContext / useAuth, Checklist Público (Comercial), Coleta Pública de Infraestrutura, Componentes principais, Componentes principais, Dados e Hooks, Dados e Hooks (+10 more)

### Community 365 - "cs-cx-routines-permissions.test.tsx"
Cohesion: 0.40
Nodes (3): bulkMutation, hasPermission, mutation

### Community 367 - "Checklist Público (Comercial)"
Cohesion: 0.29
...
### Community 370 - "DeploymentsTickets.mobile.test.tsx"
Cohesion: 0.29
...
### Community 371 - "useDeploymentForms.ts"
Cohesion: 0.29
...
### Community 372 - "prepare-ellevo-hours-view.mjs"
Cohesion: 0.25
Nodes (5): apply, inspect, inspectSdMembers, scriptDirectory, viewSql

### Community 373 - "sonner.tsx"
Cohesion: 0.29
Nodes (7): 5. Roteiro de Treinamento (Placeholder), Componentes principais, Dados e Hooks, Fluxos e Interações, Objetivo, Pontos de Manutenção, Regras de Negócio e Estados

### Community 374 - "Dashboard Executivo (Analytics)"
Cohesion: 0.29
...
### Community 375 - "pos-chat-visitor-dialog.test.tsx"
Cohesion: 0.15
Nodes (12): FeedbackPromptModal(), FeedbackPromptModalProps, PosChatHistorySidebar(), PosChatVisitorDialog(), isTriageMessage(), MessageItem(), PublicPosChat(), QUICK_PROMPTS (+4 more)

### Community 376 - "Últimas Implantações"
Cohesion: 0.29
...
### Community 401 - "cs-cx-requests-report.ts"
Cohesion: 0.43
Nodes (6): CsCxRequest, EXECUTION_STATUSES, formatDate(), formatDateTime(), localIsoDate(), printCsCxRequestsReport()

### Community 402 - "ImplementerProfile"
Cohesion: 0.40
Nodes (5): ImplementerHeaderBanner(), ImplementerHeaderBannerProps, ImplementerProfileCardProps, ImplementerSelectorProps, ImplementerProfile

### Community 403 - "usePosAiChatLinks.ts"
Cohesion: 0.40
Nodes (5): isOrionProject(), LinkRow, PosAiChatProjectCandidate, usePosAiChatLinks(), usePosAiChatProjectCandidates()

### Community 405 - "2. Editor de Formulário de Aderência"
Cohesion: 0.11
Nodes (18): 1. Painel de Implantadores (hub), 2. Editor de Formulário de Aderência, 7. Relação com telas externas ao módulo, Componentes principais, Componentes principais, Dados e Hooks, Dados e Hooks, Fluxos e Interações (+10 more)

### Community 406 - "commercial-contacts-permissions.test.tsx"
Cohesion: 0.40
Nodes (3): contatoFake, hasPermission, TODAS

### Community 408 - "GEMINI.md"
Cohesion: 0.25
...
### Community 409 - "buildContactAttentionRows"
Cohesion: 0.67
Nodes (4): buildContactAttentionRows(), contactStatus(), isIsoDate(), parseIsoDate()

### Community 410 - "sonner.tsx"
Cohesion: 0.50
Nodes (3): sonner, SonnerToaster(), ToasterProps

### Community 411 - "5. Roteiro de Treinamento (Placeholder)"
Cohesion: 0.16
Nodes (15): CopilotChat(), CopilotChatProps, fmtDateTime(), linkifyProjects(), loadSaved(), SUGESTOES, renderInline(), renderLink() (+7 more)

### Community 412 - "sd-time-import.test.ts"
Cohesion: 0.50
Nodes (3): page, sqlView, worker

### Community 415 - "🗄️ Configuração Local do Supabase (Ambiente de Desenvolvimento)"
Cohesion: 0.67
Nodes (3): Arquivo `.env` Local, Como obter essas chaves no painel do Supabase, 🗄️ Configuração Local do Supabase (Ambiente de Desenvolvimento)

## Knowledge Gaps
- **2717 isolated node(s):** `{ chromium, firefox, webkit }`, `name`, `version`, `description`, `author` (+2712 more)
...
- **Why does `cn()` connect `App Sidebar & Protected Route` to `Conversion Post Feed & Drawer`, `Checklist & Visual Question Builder`, `Project Stage Forms & Models`, `Charts, KPI & Reports`, `FormRenderer.tsx`, `Calendar Grid & Drag-Drop`, `GEMINI.md`, `Adherence Form Renderer`, `Sidebar Components`, `Dashboard Table & Pagination`, `useAuth`, `Project Transformers & Stages`, `5. Roteiro de Treinamento (Placeholder)`, `use-toast Reducer`, `Predictability & Bottlenecks`, `Main Layout & Theme Toggle`, `5. Contatos & Clientes`, `Post Observations Editor`, `ProtectedRoute.tsx`, `Deployment Template & Stage Forms`, `LogsTab.tsx`, `PipelineStatus.tsx`, `useTeams.ts`, `CsCxRegistryOffices.tsx`, `usePublicChecklist.ts`, `SolutionsSearch.tsx`, `Toggle Component`, `cs-cx-nps-analytics.ts`, `Roadmap do Cliente (Portal Público)`, `Login`, `ProjectCardV3.tsx`, `package.json`, `CsCxReports.tsx`, `CopilotChat.tsx`, `cs-cx-nps-survey.ts`, `TransicaoPlaceholder`, `cs-cx-engagement-pdf.ts`, `RolesManagement.tsx`, `sheet.tsx`, `useCsCxAccess.ts`, `v`, `formatLogDetails`, `Módulo Comercial — Documentação por Tela`, `usePosPanorama.ts`, `cs-cx-engagement-permissions.test.tsx`, `NpsAnalytics.tsx`, `usePosAiChatVisitors.ts`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `err()` connect `chamadosSync.ts` to `Checklist & Visual Question Builder`, `Charts, KPI & Reports`, `GEMINI.md`, `App Sidebar & Protected Route`, `Main Layout & Theme Toggle`, `Post Observations Editor`, `Deployment Template & Stage Forms`, `LogsTab.tsx`, `PipelineStatus.tsx`, `CsCxRegistryOffices.tsx`, `Improve-Text AI Jobs`, `Últimas Implantações`, `Login`, `ProjectCardV3.tsx`, `package.json`, `index.ts`, `v`, `cs-cx-engagement-permissions.test.tsx`, `ImplementerCharts.tsx`, `Módulo: Núcleo — Dashboard e Projetos`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `Button` connect `CsCxRegistryOffices.tsx` to `Conversion Post Feed & Drawer`, `VM Worker Job Queue`, `FormRenderer.tsx`, `Project Stage Forms & Models`, `Charts, KPI & Reports`, `filterStore.ts`, `Calendar Grid & Drag-Drop`, `GEMINI.md`, `Adherence Form Renderer`, `Sidebar Components`, `Módulo: Calendário, Agenda, Analytics, Relatórios, Roadmap e Implantações`, `useAuth`, `Deployment Form Fields`, `Project Transformers & Stages`, `5. Roteiro de Treinamento (Placeholder)`, `use-toast Reducer`, `6. Análise de Aderência`, `Predictability & Bottlenecks`, `Main Layout & Theme Toggle`, `Post Observations Editor`, `ProtectedRoute.tsx`, `Deployment Template & Stage Forms`, `TicketsAiAnalysis.tsx`, `LogsTab.tsx`, `PipelineStatus.tsx`, `Theme Provider`, `usePublicChecklist.ts`, `SolutionsSearch.tsx`, `project-transformers.ts`, `Toggle Component`, `usePosAiAdminAnalytics.ts`, `cs-cx-nps-analytics.ts`, `useSdAttendanceBi.ts`, `Relatórios & Análises`, `Roadmap do Cliente (Portal Público)`, `ProjectCardV3.tsx`, `package.json`, `CopilotChat.tsx`, `TransicaoPlaceholder`, `SolutionDetails.tsx`, `cs-cx-engagement-pdf.ts`, `useCsCxAccess.ts`, `usePosPanorama.ts`, `cs-cx-engagement-permissions.test.tsx`, `NpsAnalytics.tsx`, `usePosAiChatVisitors.ts`, `🗄️ Configuração Local do Supabase (Ambiente de Desenvolvimento)`, `cs-cx-routines-report.test.ts`, `pos-chat-visitor-dialog.test.tsx`, `v`?**
