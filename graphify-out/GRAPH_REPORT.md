...
## Corpus Check
- 919 files · ~1,038,618 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5871 nodes · 13228 edges · 416 communities (321 shown, 95 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 185 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `70e01bf3`
...
## Communities (416 total, 95 thin omitted)

### Community 0 - "Conversion Issues & Post Forms"
Cohesion: 0.11
Nodes (23): CsCxProduct, CsCxRoutineCategory, CsCxRoutineHistory, CsCxRoutineLink, CsCxRoutineLinkModel, CsCxRoutineModelItem, CsCxRoutineType, db (+15 more)

### Community 1 - "Conversion Post Feed & Drawer"
Cohesion: 0.05
Nodes (44): react, DayDroppableZone(), SummaryCard(), AdherenceImpactSummary(), AdherenceQuestionField(), AdherenceQuestionValue, ArrayFieldTemplateItem, checkHasAdherenceQuestions() (+36 more)
...
Cohesion: 0.27
Nodes (6): ContextualHeaderAction, getContextualHeaderAction(), matchesPath(), MainLayout(), MenuItem, menuItems
...
Cohesion: 0.10
Nodes (20): ChecklistEditor(), ChecklistEditorProps, SYSTEM_TYPES, convertVisualToJSONSchema(), convertVisualToUISchema(), parseJSONSchemaToVisual(), VisualQuestion, VisualQuestionBuilder() (+12 more)

### Community 8 - "Charts, KPI & Reports"
Cohesion: 0.13
Nodes (26): Bloco, escapeHtml(), MarkdownLite(), markdownLiteToHtml(), parseBlocos(), renderInline(), Chamado0800DetailDialog(), fmtDateBr() (+18 more)
...
Cohesion: 0.16
Nodes (24): CalendarControls(), CalendarGrid(), CalendarGridProps, CalendarLegend(), DraggableTeamMember(), DraggableTeamMemberProps, CalendarEventPill(), CalendarEventPillProps (+16 more)
...
Cohesion: 0.08
Nodes (29): AppSidebar(), MainLayoutProps, UserProfileDrawer(), Sidebar, SidebarContent, SidebarContext, SidebarFooter, SidebarGroup (+21 more)
...
Cohesion: 0.08
Nodes (28): NOTIFICATION_TYPE_ICONS, Checkbox, DropdownMenuContent, DropdownMenuItem, DropdownMenuLabel, DropdownMenuRadioItem, DropdownMenuSeparator, DropdownMenuSubContent (+20 more)
...
Cohesion: 0.14
Nodes (18): CompactQueueCard(), STATUS_COLORS, STATUS_LABELS, CopilotChatProps, SUGESTOES, RestoreVersionModal(), RestoreVersionModalProps, VersionDetailModal() (+10 more)
...
Cohesion: 0.21
Nodes (13): SolutionForm(), attachmentStorageName(), createSdSolution(), deleteSdSolutionAttachment(), listSdProfiles(), updateSdSolution(), uploadSdSolutionAttachment(), SdAttachmentVerificationStatus (+5 more)

### Community 26 - "Project Transformers & Stages"
Cohesion: 0.05
Nodes (62): data, OverviewChart(), ProjectStatusChart(), ProjectStatusChartProps, STATUS_LABELS, formatAction(), RecentActivity(), AdminSettings() (+54 more)

### Community 27 - "use-toast Reducer"
Cohesion: 0.08
Nodes (29): CriticalAlertsProps, ProjectDetailsModalProps, DeploymentCard(), DeploymentCardProps, DeploymentDetailsDialogProps, ProjectHeaderForm(), ProjectHeaderFormProps, PosAiAssistantSectionProps (+21 more)

### Community 28 - "Project Modal & Kanban"
Cohesion: 0.07
Nodes (39): NpsAnalyticsPanelProps, CS_CX_REQUEST_STATUSES, CsCxOfficeProduct, CsCxOfficeResponsible, CsCxProduct, CsCxProductResponsible, CsCxRequest, CsCxRequestInput (+31 more)
...
Cohesion: 0.09
Nodes (36): AttentionClientsChart(), classificationClass(), classificationLabel(), ClassificationSummary(), formatRankingDate(), formatResponseDate(), matchesDrilldown(), NpsAnalyticsPanel() (+28 more)
...
Cohesion: 0.18
Nodes (18): AdherenceStageForm(), FormTemplate, NewTemplateInput, useActiveTemplate(), ProjectFormResponse, UpsertResponseInput, useProjectFormResponse(), useUpsertFormResponse() (+10 more)
...
Cohesion: 0.05
Nodes (43): EnvironmentScreenshotsProps, AdherenceStageFormProps, EnvironmentStageFormProps, InfraStageFormProps, ModelosEditorWorkspaceProps, ProjectRow, useProjectsList(), userProjectsListTransform() (+35 more)
...
Cohesion: 0.23
Nodes (9): NewProjectDialog(), AdvancedFilters(), ProjectGrid(), ProjectTagsLegendDialog(), useConversionQueue(), normalizeText(), Conversion(), OrionTNProjects() (+1 more)

### Community 40 - "Deployment Template & Stage Forms"
Cohesion: 0.11
Nodes (20): ProtectedRoute(), authDb, AuthContext, AuthContextType, Permission, UserRole, useAuth(), CopilotAccess (+12 more)

### Community 41 - "Theme Provider"
Cohesion: 0.13
Nodes (15): DashboardKPI(), DashboardKPIProps, DashboardReport(), DashboardReportProps, KPICard(), Breadcrumbs(), DeploymentDetailsDialog(), project (+7 more)

### Community 42 - "Health Badge & Pipeline Status"
Cohesion: 0.24
Nodes (10): ConversionPostFeed(), ConversionPostFeedProps, formatPostDate(), getInitials(), groupPostsByDate(), POST_TYPE_CONFIG, NewPostForm(), NewPostFormProps (+2 more)
...
Cohesion: 0.08
Nodes (45): SearchableClientSelectProps, CsCxMultiSelectOption, CsCxMultiSelectProps, AttentionChartItem, DatedNpsAxisTickProps, DISTRIBUTION_COLORS, ExpandedNpsChart, NpsDrilldown (+37 more)
...
Cohesion: 0.16
Nodes (17): lexical, AiRichTextField(), messageOf(), AiTextImprovementJob, mapJob(), useAiTextImprovement(), appendPlainTextToLexicalJson(), LexicalNode (+9 more)
...
Cohesion: 0.10
Nodes (17): jspdf, chamados, TicketsSlaInfoDialogProps, Chamado0800, ParecerPosJob, ChamadoPanorama, JanelaPos, PosPanoramaData (+9 more)

### Community 140 - "chart.tsx"
Cohesion: 0.15
Nodes (12): DropdownMenuCheckboxItem, useDebounce(), AutoSaveConfig, SaveState, useManagedSdTimeReport(), errorMessage(), formatEntryDescription(), PAGE_SIZE_OPTIONS (+4 more)
...
Cohesion: 0.18
Nodes (16): db, normalizeEntry(), SdTimeBulkImportRequestRow, SdTimeBulkImportResult, SdTimeImportRequestRow, SdTimeImportResult, SdTimeInterval, SdTimeManagementAnalyst (+8 more)
...
Cohesion: 0.14
Nodes (17): ImplementerPDFExport(), ImplementerPDFExportProps, ImplementerPhaseMetricsProps, PhaseCardProps, ImplementerStageAnalysisProps, daysBetween(), fmtDateShort(), generateProjectBullets() (+9 more)

### Community 178 - "FamiliesManager.tsx"
Cohesion: 0.18
Nodes (16): fmt(), getSpeechRecognition(), pickMimeType(), VoiceDictationButton(), VoiceDictationButtonProps, mapHeartbeat(), mapJob(), useModelGenerationJobs() (+8 more)
...
Cohesion: 0.33
Nodes (9): emptyInterval(), IntervalDraft, TimeEntryDialog(), TimeEntryDialogProps, SaveSdTimeEntryInput, SdTimeEntry, intervalMinutes(), intervalsOverlap() (+1 more)

### Community 184 - "Login"
Cohesion: 0.33
Nodes (8): formatStepTime(), ModelosEditorWorkspace(), ModelosMetrics(), normalizeModelName(), pairKeyFor(), ProgressBody(), useProjectFiles(), MODEL_TYPES

### Community 185 - "CsCxReports.tsx"
Cohesion: 0.22
Nodes (14): CsCxAppointment, decodeAppointmentObservations(), encodeAppointmentObservations(), formatAppointmentObservations(), normalizeAppointmentObservations(), APPOINTMENT_STATUS_LABELS, APPOINTMENT_TYPE_LABELS, formatDate() (+6 more)
...
Cohesion: 0.09
Nodes (30): AttentionRow, ContactAttentionDashboardProps, CsCxRegistryOffice, CS_CX_APPOINTMENT_STATUSES, CS_CX_APPOINTMENT_TYPES, CsCxAppointmentInput, CsCxContact, CsCxContactInput (+22 more)
...
Cohesion: 0.14
Nodes (26): BunnyVideoModal(), UnsavedChangesDialogProps, CollapsibleFieldSection(), CollapsibleFieldSectionProps, EnvironmentScreenshots(), sanitize(), ObservationsWithAI(), ObservationsWithAIProps (+18 more)
...
Cohesion: 0.10
Nodes (12): CompactQueueCardProps, ProjectInfo, ProjectInfoSection(), ProjectInfoSectionProps, ConversionKPIs, ConversionQueueItem, UseConversionQueueOptions, MyQueueDetailedCardProps (+4 more)

### Community 232 - "Módulo: Núcleo — Dashboard e Projetos"
Cohesion: 0.10
Nodes (33): text(), buildPrompt(), classifyPendingChamados(), NATUREZAS_SEM_TEMA, parseResult(), PendingRow, config, CopilotJob (+25 more)
...
Cohesion: 0.43
Nodes (7): buildAreaSlaPolicies(), canonicalCriticality(), criticalityRank(), formatMinutes(), normalizeText(), TicketsSlaInfoDialog(), validMinutes()

### Community 295 - "ProtectedRoute.tsx"
Cohesion: 0.09
Nodes (27): CriticalAlerts(), DashboardTable(), DashboardTableProps, HealthBadge(), HealthBadgeProps, PipelineStatus(), PipelineStatusProps, ProjectDetailsModal() (+19 more)

### Community 296 - "commercial-contacts-permissions.test.tsx"
Cohesion: 0.11
Nodes (17): 1. Painel de Implantadores (hub), 3. Aderências Finalizadas, 7. Relação com telas externas ao módulo, Componentes principais, Componentes principais, Dados e Hooks, Dados e Hooks, Fluxos e Interações (+9 more)
...
Cohesion: 0.07
Nodes (77): PosAiChatLinksManager(), PosAiChatLinksManagerProps, StatusFilter, PAGE_SIZE_OPTIONS, PosAiChatUsersManagerProps, SearchableClientOption, SearchableClientSelect(), ConversionIssuesTab() (+69 more)
...
Cohesion: 0.15
Nodes (22): TicketsAiAnalysisProps, TicketsSlaAnalysisProps, TicketsSlaSectorAnalysisProps, Chamado0800DetailDialogProps, ChamadosSearchFilters, ChamadosCatalog, getChamadosProductLabel(), ChamadosReportFilters (+14 more)
...
Cohesion: 0.08
Nodes (46): copyText(), formatDate(), NpsInvitationsPanel(), NpsQuestionnairesPanel(), NpsThemePreview(), QUESTION_TYPES, questionTypeLabel(), CreateNpsInvitationInput (+38 more)
...
Cohesion: 0.08
Nodes (42): BenchmarkPos, Chamados0800Result, ChamadosClientOption, checkPosCriticosAbertos(), createChamadosSearchQuery(), fetchAllChamados(), fetchAllChamadosForReport(), fetchUltimosTramites() (+34 more)
...
Cohesion: 0.29
Nodes (8): StageCard(), StageCardProps, EnvironmentStageForm(), AccordionContent, AccordionItem, AccordionTrigger, StageStatus, v()

### Community 320 - "SolutionDetails.tsx"
Cohesion: 0.19
Nodes (21): attachmentSecurity(), clampPanelWidth(), longDate(), maxPanelWidth(), shortDate(), SolutionDetails(), canPreviewSdAttachment(), isSdSolutionReviewOverdue() (+13 more)
...
Cohesion: 0.17
Nodes (13): err(), ConversionPostDrawer(), NotificationBell(), mapPost(), RawPost, useConversionPosts(), HomologationEvent, mapEvent() (+5 more)
...
Cohesion: 0.18
Nodes (9): Editor(), editorConfig, nodes, Plugins(), ToolbarPlugin(), editorTheme, EditorContentEditable(), Props (+1 more)

### Community 331 - "processJob.ts"
Cohesion: 0.11
Nodes (17): 1.1. Subseção: Cartão detalhado da Minha Fila (`MyQueueDetailedCard`), 1. Gestão de Atividades — Fila de Conversão, 4. Projetos OrionTN, Componentes principais, Componentes principais, Dados e Hooks, Dados e Hooks, Fluxos e Interações (+9 more)
...
Cohesion: 0.10
Nodes (27): OfficeFilterCombobox(), CsCxRoutineItemConfig, decodeRoutineObservations(), encodeRoutineObservations(), formatRoutineObservations(), normalizeRoutineObservations(), ActionBadge(), actionLabel() (+19 more)

### Community 337 - "CsCxAdmin"
Cohesion: 0.22
...
### Community 342 - "1. Gestão de Atividades — Fila de Conversão"
Cohesion: 0.14
Nodes (12): hasRichTextContent(), richTextToPlainText(), ContactReadOnlyDetails(), CsCxContacts(), DataError(), emptyForm, errorMessage(), formatDate() (+4 more)

### Community 343 - "usePosAiProjectSummary.ts"
Cohesion: 0.06
Nodes (32): DEFAULT_HEALTH_SETTINGS, ProjectHealthSettings, useAdminStats(), useStorageStats(), ConversionEngineItem, EngineKPIs, EngineStatus, ConversionIssue (+24 more)
...
Cohesion: 0.04
Nodes (73): dateFormatter, formatLastActivity(), integerFormatter, PosAiVisitorAnalytics(), PosAiVisitorAnalyticsProps, usdFormatter, AttentionFilter, AttentionStatus (+65 more)
...
Cohesion: 0.21
Nodes (16): useDeleteSdTimeEntry(), useSaveSdTimeEntry(), entryMinutes(), entryStartMinutes(), formatMinutes(), getWeekDays(), getWeekRange(), SdTimeEntryLike (+8 more)
...
### Community 361 - "Relatórios & Análises"
Cohesion: 0.19
...
Cohesion: 0.27
Nodes (9): getEditorContent(), ImplementationPhaseForm(), ImplementationStageForm(), ImplementationStageFormProps, PhaseFormProps, convertBlocksToTiptap(), ContentBlock, ImplementationPhase (+1 more)

### Community 374 - "activityLogger.ts"
Cohesion: 0.25
...
### Community 376 - "key"
Cohesion: 0.29
Nodes (10): key(), requiredMap(), targetHashes(), verify(), AuditLogPage(), formatLogDetails(), formatValue(), isUUID() (+2 more)
...
### Community 409 - "2. Motores de Conversão"
Cohesion: 0.29
...
### Community 410 - "4. Homologação de Conversões"
Cohesion: 0.29
...
### Community 413 - "codexModelSkill.ts"
Cohesion: 0.40
Nodes (5): buildManagedSkill(), CODEX_MODEL_SKILL_CONTENT, ensureCodexModelSkill(), MODEL_SKILL_PARTS, MODEL_SKILL_SOURCES

### Community 417 - "cs-cx-admin-permissions.test.tsx"
Cohesion: 0.18
Nodes (13): PosSaudeBadge(), ProjectModal(), RoadmapManager(), Chamado0800Tab(), EditProjectTab(), FilesTab(), GeneralInfoTab(), LogsTab() (+5 more)

## Knowledge Gaps
- **2707 isolated node(s):** `{ chromium, firefox, webkit }`, `name`, `version`, `description`, `author` (+2702 more)
...
- **Why does `err()` connect `PosPanorama.tsx` to `Conversion Post Feed & Drawer`, `Checklist & Visual Question Builder`, `Charts, KPI & Reports`, `GEMINI.md`, `App Sidebar & Protected Route`, `Roadmap Page`, `Deployment Template & Stage Forms`, `Theme Provider`, `LogsTab.tsx`, `chamadosSync.ts`, `CsCxRegistryOffices.tsx`, `Improve-Text AI Jobs`, `Agenda dos Analistas`, `FamiliesManager.tsx`, `FallbackChecklistForm.tsx`, `Login`, `package.json`, `index.ts`, `usePosAiProjectSummary.ts`, `Módulo: Núcleo — Dashboard e Projetos`, `pos-chat-visitor-dialog.test.tsx`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `cn()` connect `Conversion Post Feed & Drawer` to `Checklist & Visual Question Builder`, `Project Stage Forms & Models`, `Charts, KPI & Reports`, `Calendar Grid & Drag-Drop`, `GEMINI.md`, `Adherence Form Renderer`, `Sidebar Components`, `App Sidebar & Protected Route`, `useAuth`, `Project Transformers & Stages`, `use-toast Reducer`, `Project Modal & Kanban`, `cs-cx-admin-permissions.test.tsx`, `ProtectedRoute.tsx`, `Roadmap Page`, `Theme Provider`, `Health Badge & Pipeline Status`, `LogsTab.tsx`, `useTeams.ts`, `CsCxRegistryOffices.tsx`, `usePublicChecklist.ts`, `Deployment Template & Stage Forms`, `Toggle Component`, `cs-cx-nps-analytics.ts`, `Login`, `package.json`, `CopilotChat.tsx`, `TransicaoPlaceholder`, `PosPanorama.tsx`, `RolesManagement.tsx`, `sheet.tsx`, `useCsCxAccess.ts`, `v`, `formatLogDetails`, `CsCxNpsResponse`, `CsCxAdmin`, `Módulo Comercial — Documentação por Tela`, `usePosPanorama.ts`, `1. Gestão de Atividades — Fila de Conversão`, `usePosAiProjectSummary.ts`, `cs-cx-engagement-permissions.test.tsx`, `NpsAnalytics.tsx`, `CsCxReports`, `Checklist Público (Comercial)`, `useDeploymentForms.ts`, `sonner.tsx`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `Button` connect `usePublicChecklist.ts` to `Conversion Post Feed & Drawer`, `Project Stage Forms & Models`, `Charts, KPI & Reports`, `filterStore.ts`, `Calendar Grid & Drag-Drop`, `Adherence Form Renderer`, `Sidebar Components`, `chart.tsx`, `App Sidebar & Protected Route`, `useAuth`, `Deployment Form Fields`, `Project Transformers & Stages`, `cs-cx-admin-permissions.test.tsx`, `Main Layout & Theme Toggle`, `ProtectedRoute.tsx`, `Roadmap Page`, `TicketsAiAnalysis.tsx`, `Health Badge & Pipeline Status`, `PipelineStatus.tsx`, `LogsTab.tsx`, `CsCxRegistryOffices.tsx`, `project-transformers.ts`, `SolutionsSearch.tsx`, `usePosAiAdminAnalytics.ts`, `cs-cx-nps-analytics.ts`, `Agenda dos Analistas`, `FamiliesManager.tsx`, `Últimas Implantações`, `Login`, `package.json`, `CopilotChat.tsx`, `SolutionDetails.tsx`, `RolesManagement.tsx`, `sheet.tsx`, `Deployment Template & Stage Forms`, `Theme Provider`, `CsCxNpsResponse`, `usePosPanorama.ts`, `1. Gestão de Atividades — Fila de Conversão`, `cs-cx-engagement-permissions.test.tsx`, `NpsAnalytics.tsx`, `CsCxReports`, `cs-cx-routines-report.test.ts`, `Checklist Público (Comercial)`, `pos-chat-visitor-dialog.test.tsx`?**
