...
## Corpus Check
- 591 files · ~781,914 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4184 nodes · 8189 edges · 304 communities (232 shown, 72 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 96 edges (avg confidence: 0.67)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2d3467c2`
...
## Communities (304 total, 72 thin omitted)

### Community 0 - "Conversion Issues & Post Forms"
Cohesion: 0.13
Nodes (15): RequirePermission(), RequirePermissionProps, ACTION_LABELS, getActionLabel(), getResourceCategory(), getResourceLabel(), PERMISSION_CATEGORY_ORDER, PermissionAction (+7 more)

### Community 1 - "Conversion Post Feed & Drawer"
Cohesion: 0.25
Nodes (6): MenuItem, menuItems, PERMISSION_RESOURCES, catalogPairs, catalogResources, SRC
...
Cohesion: 0.05
Nodes (91): err(), buildPrompt(), classifyPendingChamados(), NATUREZAS_SEM_TEMA, parseResult(), PendingRow, cleanNomeCliente(), decodeDescricao() (+83 more)
...
Cohesion: 0.06
Nodes (40): EnvironmentScreenshotsProps, AdherenceStageFormProps, EnvironmentStageFormProps, ImplementationStageFormProps, PhaseFormProps, ProjectRow, useProjectsList(), userProjectsListTransform() (+32 more)

### Community 8 - "Charts, KPI & Reports"
Cohesion: 0.05
Nodes (72): ProjectStatusChart(), ProjectStatusChartProps, STATUS_LABELS, formatAction(), RecentActivity(), AdminSettings(), STAGE_LABELS, ChartEmptyState() (+64 more)
...
Cohesion: 0.06
Nodes (48): CalendarControls(), CalendarGrid(), CalendarGridProps, DayDroppableZone(), CalendarLegend(), DraggableTeamMember(), DraggableTeamMemberProps, CalendarEventPill() (+40 more)
...
Cohesion: 0.11
Nodes (16): DEFAULT_HEALTH_SETTINGS, ProjectHealthSettings, useStorageStats(), Client, Contact, Project, ConversionEngineItem, EngineKPIs (+8 more)
...
Cohesion: 0.08
Nodes (34): CompactQueueCard(), CompactQueueCardProps, STATUS_COLORS, STATUS_LABELS, ConversionPostDrawer(), ConversionPostDrawerProps, STATUS_LABELS, ConversionPostFeed() (+26 more)

### Community 17 - "Dashboard Table & Pagination"
Cohesion: 0.07
Nodes (33): DashboardTable(), DashboardTableProps, HealthBadge(), HealthBadgeProps, PipelineStatus(), PipelineStatusProps, ProjectDetailsModal(), Editor() (+25 more)
...
Cohesion: 0.08
Nodes (28): healthColors, healthLabels, ImplementerCharts(), ImplementerChartsProps, statusColors, statusLabels, ImplementerHeaderBanner(), ImplementerHeaderBannerProps (+20 more)
...
Cohesion: 0.14
Nodes (19): Props, ProtectedRoute(), FallbackChecklistFormProps, useAuth(), CommercialChecklistRecord, useCommercialChecklists(), useSingleCommercialChecklist(), DeploymentFormRecord (+11 more)
...
Cohesion: 0.09
Nodes (27): jszip, Alert, AlertDescription, AlertTitle, alertVariants, mapJob(), useDtcAiJobs(), useTeamMembers() (+19 more)
...
Cohesion: 0.07
Nodes (60): ConversionIssuesTab(), NewProjectDialog(), NOTIFICATION_TYPE_ICONS, AdvancedFilters(), AdvancedFiltersProps, DeploymentCard(), DeploymentCardProps, ProjectHeaderForm() (+52 more)

### Community 29 - "Commercial/Public Checklists"
Cohesion: 0.10
Nodes (38): ImplementerAllCartoriosTableProps, GLOBAL_STATUS_LABELS, GLOBAL_STATUS_VARIANTS, ImplementerOtherStagesProps, ImplementerProjectsListProps, AccordionContent, AccordionItem, AccordionTrigger (+30 more)
...
Cohesion: 0.13
Nodes (20): StageCardProps, ProjectCardV3(), StepsTab(), useDebounce(), AutoSaveConfig, SaveState, useAutoSave(), useProjectForm() (+12 more)
...
Cohesion: 0.10
Nodes (23): CopilotChat(), fmtDateTime(), linkifyProjects(), loadSaved(), clamp(), FloatingCopilot(), maxWidth(), AppSidebar() (+15 more)
...
Cohesion: 0.10
Nodes (40): STAGE_OPTIONS, CopilotChatProps, SUGESTOES, COLORS, FONT_SIZES, ProjectGrid(), ReportsFiltersProps, AutocompleteInputProps (+32 more)
...
Cohesion: 0.07
Nodes (33): DashboardKPI(), DashboardKPIProps, DashboardReport(), KPICard(), ProjectDistributionChart(), StatusChart(), getProjectTimelineDates(), TimelineChart() (+25 more)
...
Cohesion: 0.10
Nodes (33): ChecklistEditor(), ChecklistEditorProps, SYSTEM_TYPES, convertVisualToJSONSchema(), convertVisualToUISchema(), parseJSONSchemaToVisual(), VisualQuestion, VisualQuestionBuilder() (+25 more)
...
Cohesion: 0.06
Nodes (31): react, AdherenceImpactSummary(), AdherenceQuestionField(), AdherenceQuestionValue, ArrayFieldTemplateItem, checkHasAdherenceQuestions(), CustomArrayFieldTemplate(), CustomCheckboxWidget() (+23 more)
...
### Community 184 - "Login"
Cohesion: 0.06
Nodes (55): jspdf, Bloco, escapeHtml(), MarkdownLite(), markdownLiteToHtml(), parseBlocos(), renderInline(), Chamado0800DetailDialog() (+47 more)
...
Cohesion: 0.12
Nodes (29): CollapsibleFieldSection(), CollapsibleFieldSectionProps, getEditorContent(), ObservationsWithAI(), ObservationsWithAIProps, obsTextLen(), walkText(), StageCard() (+21 more)
...
Cohesion: 0.12
Nodes (30): ConversionIssuesTabProps, PRIORITIES, STATUSES, UserProfileDrawerProps, EnvironmentScreenshots(), sanitize(), SortableThumb(), CustomTheme (+22 more)
...
- **Why does `err()` connect `VM Worker Job Queue` to `Post Observations Editor`, `Checklist & Visual Question Builder`, `FormRenderer.tsx`, `ProtectedRoute.tsx`, `Health Badge & Pipeline Status`, `Sidebar Components`, `Improve-Text AI Jobs`, `Custom Widgets & Sheet`, `SimpleMarkdown.tsx`, `Distribution/Workload Charts`, `Login`, `Deployment Form Fields`, `use-toast Reducer`, `Project Modal & Kanban`, `Commercial Page & Hooks`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `cn()` connect `Project Modal & Kanban` to `FormRenderer.tsx`, `Checklist & Visual Question Builder`, `Charts, KPI & Reports`, `Calendar Grid & Drag-Drop`, `Sidebar Components`, `Custom Widgets & Sheet`, `Dashboard Table & Pagination`, `Distribution/Workload Charts`, `Deployment Form Fields`, `use-toast Reducer`, `Commercial/Public Checklists`, `Predictability & Bottlenecks`, `Post Observations Editor`, `ProtectedRoute.tsx`, `Deployment Template & Stage Forms`, `Theme Provider`, `LogsTab.tsx`, `Health Badge & Pipeline Status`, `Roadmap Page`, `usePublicChecklist.ts`, `Login`, `SimpleMarkdown.tsx`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `dependencies` connect `Auth Context` to `Main Layout & Theme Toggle`, `sonner.tsx`, `FormRenderer.tsx`, `Login`, `Deployment Form Fields`, `package.json`?**
