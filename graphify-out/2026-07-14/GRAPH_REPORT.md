...
## Corpus Check
- 513 files · ~713,600 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3786 nodes · 7100 edges · 299 communities (233 shown, 66 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 78 edges (avg confidence: 0.66)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `13d2f7f1`
...
## Communities (299 total, 66 thin omitted)

### Community 0 - "Conversion Issues & Post Forms"
Cohesion: 0.18
Nodes (18): ConversionStageForm(), ConversionStageFormProps, ImplementationStageForm(), StatusType, StatusType, AlertDialogAction, AlertDialogCancel, AlertDialogContent (+10 more)
...
Cohesion: 0.08
Nodes (60): config, CopilotJob, DtcJob, Job, ModelType, claimAndProcess(), claimOneCopilotJob(), claimOneDtcJob() (+52 more)
...
Cohesion: 0.06
Nodes (39): AdherenceStageFormProps, EnvironmentStageFormProps, ImplementationStageFormProps, PhaseFormProps, ModelosEditorWorkspaceProps, ProjectRow, useProjectsList(), userProjectsListTransform() (+31 more)

### Community 8 - "Charts, KPI & Reports"
Cohesion: 0.08
Nodes (44): ProjectStatusChartProps, STATUS_LABELS, STAGE_LABELS, ProjectDetailsModalProps, ProjectDistributionChart(), ProjectDistributionChartProps, StatusChart(), StatusChartProps (+36 more)
...
Cohesion: 0.14
Nodes (13): Client, Contact, Project, useCommercial(), getMarqueeStyle(), ClientOverview(), CommercialBlockers(), getBlockers() (+5 more)

### Community 12 - "Adherence Form Renderer"
Cohesion: 0.12
Nodes (15): DeploymentFormFields(), Props, RadioGroup, RadioGroupItem, DeploymentFormRecord, useDeploymentForms(), CopilotAccess(), DeploymentForms() (+7 more)
...
Cohesion: 0.26
Nodes (16): EditableCell(), EditableCellProps, InfraStageForm(), InfraStageFormProps, PublicInfraCollection(), InfraStageV2, ServerInfo, WorkstationInfo (+8 more)
...
Cohesion: 0.12
Nodes (21): DashboardTable(), DashboardTableProps, HealthBadge(), HealthBadgeProps, PipelineStatus(), PipelineStatusProps, ButtonProps, buttonVariants (+13 more)
...
Cohesion: 0.09
Nodes (55): ConversionIssuesTabProps, PRIORITIES, STATUSES, NewPostForm(), STAGE_OPTIONS, CopilotChatProps, SUGESTOES, VisualQuestionBuilderProps (+47 more)

### Community 23 - "Modelos Editor & Model Jobs"
Cohesion: 0.11
Nodes (24): AdminSettings(), formatStepTime(), ModelosEditorWorkspace(), ModelosMetrics(), normalizeModelName(), pairKeyFor(), ProgressBody(), DEFAULT_HEALTH_SETTINGS (+16 more)
...
Cohesion: 0.10
Nodes (24): jszip, Alert, AlertDescription, AlertTitle, alertVariants, mapJob(), useDtcAiJobs(), ALL_SYSTEMS (+16 more)
...
Cohesion: 0.15
Nodes (24): Switch, Table, TableBody, TableCaption, TableCell, TableFooter, TableHead, TableHeader (+16 more)

### Community 29 - "Commercial/Public Checklists"
Cohesion: 0.17
Nodes (14): Breadcrumbs(), useProjectDetails(), useProjectsV2(), useTimeline(), OrionTNDashboard(), OrionTNProjects(), NextDeployments(), ProjectDetails() (+6 more)

### Community 30 - "Commercial Page & Hooks"
Cohesion: 0.12
Nodes (21): data, OverviewChart(), ProjectStatusChart(), formatAction(), RecentActivity(), CompactQueueCard(), STATUS_COLORS, STATUS_LABELS (+13 more)
...
Cohesion: 0.11
Nodes (23): ProjectHeaderForm(), ProjectHeaderFormProps, ProjectModal(), ProjectModalProps, CustomTheme, RoadmapManager(), RoadmapManagerProps, RoadmapSettings (+15 more)
...
Cohesion: 0.10
Nodes (36): KPICard(), KPICardProps, TimelineChart(), COLORS, FONT_SIZES, NewProjectDialog(), DeploymentDetailsDialog(), TabProps (+28 more)
...
Cohesion: 0.21
Nodes (10): DashboardKPI(), DashboardKPIProps, DashboardReport(), DashboardReportProps, ProjectDetailsModal(), ScrollingText(), ScrollingTextProps, useKPIs() (+2 more)
...
Cohesion: 0.22
Nodes (9): 3. Dashboard — Modelos Editor, Componentes principais, Dados e Hooks, Fluxos e Interações, Módulo: Conversão e Modelos OrionTN, Objetivo, Pontos de Manutenção, Regras de Negócio e Estados (+1 more)
...
Cohesion: 0.18
Nodes (18): err(), react, CustomImageUploadWidget(), EnvironmentStageForm(), StepsTab(), AuthProvider(), useToast(), useCommercialChecklists() (+10 more)
...
Cohesion: 0.18
Nodes (13): UserProfileDrawer(), UserProfileDrawerProps, ProtectedRoute(), AuthContext, AuthContextType, Permission, UserRole, useAuth() (+5 more)
...
Cohesion: 0.25
Nodes (8): AccordionContent, AccordionItem, AccordionTrigger, Checkbox, actionTranslations, AppPermission, AppRole, resourceTranslations
...
Cohesion: 0.22
Nodes (8): mapPost(), RawPost, useConversionPosts(), HomologationEvent, mapEvent(), RawEvent, useHomologationEvents(), ImplantadoresHomologation()
...
Cohesion: 0.09
Nodes (33): ConversionIssuesTab(), ConversionPostDrawer(), ConversionPostDrawerProps, STATUS_LABELS, NOTIFICATION_TYPE_ICONS, ProjectCardV3Props, AdherenceGapCard(), GlobalMetrics() (+25 more)
...
## Knowledge Gaps
- **2078 isolated node(s):** `{ chromium, firefox, webkit }`, `name`, `version`, `description`, `author` (+2073 more)
...
- **Why does `cn()` connect `Deployment Template & Stage Forms` to `Conversion Issues & Post Forms`, `Conversion Post Feed & Drawer`, `Alerts & DTC AI/Team Hooks`, `FormRenderer.tsx`, `Charts, KPI & Reports`, `Notification Bell & Dropdown`, `Calendar Grid & Drag-Drop`, `Modal/Tab Prop Types`, `Adherence Form Renderer`, `Coleta Pública de Infraestrutura`, `Deployment Cards & Project Hooks`, `Sidebar Components`, `Dashboard Table & Pagination`, `App Sidebar & Protected Route`, `Commercial & Conversion Hooks`, `Distribution/Workload Charts`, `Modelos Editor & Model Jobs`, `Project Transformers & Stages`, `use-toast Reducer`, `Project Modal & Kanban`, `Commercial/Public Checklists`, `Commercial Page & Hooks`, `Predictability & Bottlenecks`, `Main Layout & Theme Toggle`, `Admin Stats & RBAC Hooks`, `useProjectForm.ts`, `Roadmap Page`, `CopilotChat`, `editor.tsx`, `usePublicChecklist.ts`, `RolesManagement.tsx`, `ProjectV2`, `useConversionPosts.ts`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `dependencies` connect `Auth Context` to `Project Transformers & Stages`, `Alerts & DTC AI/Team Hooks`, `lexical.ts`, `Coleta Pública de Infraestrutura`, `DeploymentFormFields.tsx`, `package.json`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `err()` connect `Coleta Pública de Infraestrutura` to `VM Worker Job Queue`, `Alerts & DTC AI/Team Hooks`, `useProjectForm.ts`, `Notification Bell & Dropdown`, `useImproveTextJobs.ts`, `Adherence Form Renderer`, `Deployment Cards & Project Hooks`, `Improve-Text AI Jobs`, `Modelos Editor & Model Jobs`, `ImplementationStageV2`, `Project Transformers & Stages`, `useConversionPosts.ts`?**
...
- **Should `Project Stage Forms & Models` be split into smaller, more focused modules?**
