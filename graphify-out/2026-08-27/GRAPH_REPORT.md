...
## Corpus Check
- 840 files · ~986,590 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5506 nodes · 12226 edges · 393 communities (303 shown, 90 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 169 edges (avg confidence: 0.72)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7bf8942b`
...
## Communities (393 total, 90 thin omitted)

### Community 0 - "Conversion Issues & Post Forms"
Cohesion: 0.12
Nodes (20): ACTION_ORDER, CsCxAccessPanel(), MenuItem, menuItems, ACTION_LABELS, getActionLabel(), getResourceCategory(), getResourceLabel() (+12 more)
...
Cohesion: 0.12
Nodes (22): text(), RoutineObservationsPreview(), CopilotJob, DtcJob, getCodexBin(), ModelType, resolveCodexBin(), buildVoicePrompt() (+14 more)
...
Cohesion: 0.11
Nodes (17): PosAiChatLinksManagerProps, AdminSettings(), PosAiAssistantSection(), DEFAULT_HEALTH_SETTINGS, ProjectHealthSettings, useAdminSettings(), mapJob(), useDtcAiJobs() (+9 more)

### Community 8 - "Charts, KPI & Reports"
Cohesion: 0.06
Nodes (58): data, OverviewChart(), ProjectStatusChart(), ProjectStatusChartProps, STATUS_LABELS, formatAction(), RecentActivity(), STAGE_LABELS (+50 more)
...
Cohesion: 0.08
Nodes (35): ProjectModal(), ProjectModalProps, RoadmapManager(), Chamado0800Tab(), EditProjectTab(), GeneralInfoTab(), TabProps, LogsTab() (+27 more)
...
Cohesion: 0.06
Nodes (42): DashboardReport(), DashboardReportProps, DashboardTable(), DashboardTableProps, HealthBadge(), HealthBadgeProps, PipelineStatus(), PipelineStatusProps (+34 more)
...
Cohesion: 0.06
Nodes (47): DashboardKPI(), DashboardKPIProps, KPICard(), Breadcrumbs(), EnvironmentScreenshotsProps, AdherenceStageFormProps, EnvironmentStageFormProps, ImplementationStageFormProps (+39 more)
...
Cohesion: 0.04
Nodes (96): EMPTY_PROFILE, BunnyVideoModal(), UnsavedChangesDialogProps, CollapsibleFieldSection(), CollapsibleFieldSectionProps, getEditorContent(), ObservationsWithAI(), ObservationsWithAIProps (+88 more)
...
Cohesion: 0.18
Nodes (16): formatStepTime(), ModelosEditorWorkspace(), ModelosEditorWorkspaceProps, ModelosMetrics(), normalizeModelName(), pairKeyFor(), ProgressBody(), mapHeartbeat() (+8 more)
...
Cohesion: 0.20
Nodes (16): StageCardProps, PosSaudeBadge(), ProjectCardV3(), ProjectCardV3Props, usePosSaude(), BottleneckIssue, getBottleneckColor(), getBottleneckIcon() (+8 more)
...
Cohesion: 0.15
Nodes (16): ImplementerAllCartoriosTableProps, ImplementerPhaseMetricsProps, PhaseCardProps, ImplementerStageAnalysisProps, daysBetween(), DetailedInvolvement, fmtDateShort(), generateProjectBullets() (+8 more)
...
Cohesion: 0.21
Nodes (9): PosChatThemeMenu(), initialState, Theme, ThemeProviderContext, ThemeProviderState, ThemeProvider(), ThemeProviderProps, DropdownMenuLabel (+1 more)
...
Cohesion: 0.24
Nodes (15): ArticleMetadataCardProps, ArticleNavigatorProps, CreateRoutineModal(), CreateRoutineModalProps, GeneratedRoutineMetadata, generateHeuristicMetadata(), generateRoutineMetadataWithAi(), BunnyVideoInfo (+7 more)
...
Cohesion: 0.12
Nodes (12): Documentação do Siplan Hub, Component Check, Design System Verification, Visual QA Checklist, 1. Pense Antes de Codar (Think Before Coding), 2.1. Padrão Estrito de Split Query (Projetos), 2.2. Estado e Cache (React Query v5 + Zustand), 2.3. Interface, Formulários e Componentização (+4 more)
...
Cohesion: 0.12
Nodes (20): createChamadosSearchQuery(), isProcessoVendaSyncSupersededError(), ProcessoVendaSyncFilters, useSolicitarSyncProcessoVenda(), CHAMADOS_CATALOG_CONFIG, CHAMADOS_LEGACY_PRODUCT_GROUPS, getCatalogSoftwarePattern(), isLegacyFamily() (+12 more)
...
Cohesion: 0.07
Nodes (52): copyText(), formatDate(), NpsInvitationsPanel(), NpsQuestionnairesPanel(), NpsThemePreview(), QUESTION_TYPES, questionTypeLabel(), CreateNpsInvitationInput (+44 more)
...
Cohesion: 0.09
Nodes (45): PosAiChatLinksManager(), dateFormatter, integerFormatter, usdFormatter, AttentionFilter, AttentionStatus, ContactAttentionDashboard(), filterForStatus() (+37 more)
...
### Community 184 - "Login"
Cohesion: 0.17
Nodes (11): ImplementerAllCartoriosTable(), ImplementerKPIs(), ImplementerKPIsProps, ImplementerPDFExport(), ImplementerPDFExportProps, ImplementerPhase1ConsolidatedTable(), ImplementerPhaseMetrics(), ImplementerSignaturesBlock() (+3 more)
...
Cohesion: 0.39
Nodes (7): lexical, LexicalNode, listItemNode(), listNode(), paragraphNode(), parseInline(), textNode()
...
Cohesion: 0.12
Nodes (23): CS_CX_APPOINTMENT_STATUSES, CS_CX_APPOINTMENT_TYPES, CsCxAppointmentInput, CsCxContactInput, CsCxProfileOption, currentUser(), db, emptyToNull() (+15 more)
...
Cohesion: 0.24
Nodes (9): CsCxOfficeRoutine, decodeRoutineObservations(), encodeRoutineObservations(), formatRoutineObservations(), normalizeRoutineObservations(), CsCxOfficeRoutineSummary, formatObservationHistory(), models (+1 more)
...
Cohesion: 0.11
Nodes (31): VersionHistoryDrawer(), DeploymentDetailsDialog(), EnvironmentStageForm(), FallbackChecklistFormProps, useToast(), CommercialChecklistRecord, useCommercialChecklists(), useSingleCommercialChecklist() (+23 more)
...
Cohesion: 0.10
Nodes (46): StatusFilter, ConversionPostDrawer(), NewPostForm(), STAGE_OPTIONS, COLORS, FONT_SIZES, UserProfileDrawerProps, AdvancedFiltersProps (+38 more)
...
Cohesion: 0.05
Nodes (40): useCsCxRegistryOffices(), useCsCxContacts(), useCsCxNps(), canAccessCsCxRecord(), CsCxOwnedResource, useCsCxRecordPermissions(), answerLabel(), ContactReadOnlyDetails() (+32 more)
...
Cohesion: 0.20
Nodes (15): TicketsAiAnalysisProps, TicketsSlaAnalysisProps, Chamado0800DetailDialogProps, ChamadosSearchFilters, ChamadosCatalog, getChamadosProductLabel(), ChamadosReportFilters, formatDate() (+7 more)
...
Cohesion: 0.14
Nodes (22): CsCxRequest, calculateCsCxReportRowLayout(), clean(), CsCxPdfOutputOptions, CsCxReportRowLayout, CsCxSummaryItem, formatDate(), formatDateTime() (+14 more)
...
Cohesion: 0.29
Nodes (8): ConversionIssuesTab(), ConversionIssuesTabProps, PRIORITIES, STATUSES, ConversionIssue, useConversionIssues(), useTeamAreas(), TeamAreasManagement()
...
Cohesion: 0.08
Nodes (24): DropdownMenuCheckboxItem, DropdownMenuContent, DropdownMenuItem, DropdownMenuSeparator, DropdownMenuShortcut(), DropdownMenuSubContent, DropdownMenuSubTrigger, Client (+16 more)

### Community 331 - "1. Gestão de Atividades — Fila de Conversão"
Cohesion: 0.25
...
### Community 333 - "ImplementerCharts.tsx"
Cohesion: 0.29
...
Cohesion: 0.11
Nodes (27): BenchmarkPos, Chamados0800Result, checkPosCriticosAbertos(), fetchUltimosTramites(), isNaturezaIgnorada(), mapChamado0800(), mapChamadoTramite(), NATUREZAS_IGNORADAS (+19 more)
...
Cohesion: 0.07
Nodes (52): CompactQueueCard(), STATUS_COLORS, STATUS_LABELS, CsCxMultiSelect(), CsCxMultiSelectOption, CsCxMultiSelectProps, KPICardProps, EnvironmentScreenshots() (+44 more)

### Community 338 - "usePosAiVisitorAnalytics.ts"
Cohesion: 0.12
Nodes (20): NewProjectDialog(), AdvancedFilters(), ProjectGrid(), ProjectTagsLegendDialog(), useConversionQueue(), useProjectsList(), userProjectsListTransform(), normalizeText() (+12 more)
...
### Community 340 - "3. Dashboard — Modelos Editor"
Cohesion: 0.29
...
Cohesion: 0.13
Nodes (44): formatDateTime(), matchesSlaCardFilter(), SLA_FILTER_LABELS, SlaCardFilter, SlaCheckpointCell(), TicketSlaRow(), TicketsSlaAnalysis(), ChamadoTramite (+36 more)

### Community 342 - "cs-cx-nps-public.test.ts"
Cohesion: 0.22
Nodes (18): BunnyVideoModalProps, SavePublishModalProps, SaveStep, useKnowledgeBase(), computeTextDiff(), formatBackupFilePath(), deleteArticleFromDocument(), insertNewArticleIntoDocument() (+10 more)
...
Cohesion: 0.16
Nodes (14): err(), mapPost(), RawPost, useConversionPosts(), HomologationEvent, mapEvent(), RawEvent, useHomologationEvents() (+6 more)
...
Cohesion: 0.33
Nodes (4): migration, slaInfoDialog, slaScreen, worker
...
Cohesion: 0.12
Nodes (20): ConversionPostDrawerProps, STATUS_LABELS, ConversionPostFeed(), ConversionPostFeedProps, formatPostDate(), getInitials(), groupPostsByDate(), POST_TYPE_CONFIG (+12 more)

### Community 357 - "usePosAiVisitorAnalytics.ts"
Cohesion: 0.09
Nodes (26): RequirePermission(), RequirePermissionProps, AppSidebar(), MainLayout(), MainLayoutProps, UserProfileDrawer(), ModeToggle(), NOTIFICATION_TYPE_ICONS (+18 more)
...
### Community 359 - "ImplementerProfile"
Cohesion: 0.40
...
### Community 364 - "Módulo Comercial — Documentação por Tela"
Cohesion: 0.40
...
### Community 366 - "🗄️ Configuração Local do Supabase (Ambiente de Desenvolvimento)"
Cohesion: 0.67
...
### Community 383 - "OverviewChart.tsx"
Cohesion: 0.24
Nodes (7): useAdminStats(), useStorageStats(), AdminDashboard(), SystemStorage(), AdminStats, AuditLog, Team
...
## Knowledge Gaps
- **2591 isolated node(s):** `{ chromium, firefox, webkit }`, `name`, `version`, `description`, `author` (+2586 more)
...
- **Why does `cn()` connect `CsCxNps` to `Conversion Post Feed & Drawer`, `FormRenderer.tsx`, `filterStore.ts`, `Charts, KPI & Reports`, `Calendar Grid & Drag-Drop`, `GEMINI.md`, `Adherence Form Renderer`, `Sidebar Components`, `Dashboard Table & Pagination`, `App Sidebar & Protected Route`, `Distribution/Workload Charts`, `Deployment Form Fields`, `Project Transformers & Stages`, `Commercial/Public Checklists`, `Predictability & Bottlenecks`, `5. Contatos & Clientes`, `sd-solutions.ts`, `ProtectedRoute.tsx`, `Roadmap Page`, `Theme Provider`, `LogsTab.tsx`, `PipelineStatus.tsx`, `CsCxRegistryOffices.tsx`, `AuthContext.tsx`, `useImproveTextJobs.ts`, `ProjectAdherenceForm.tsx`, `usePosAiAdminAnalytics.ts`, `PublicNpsResponse.tsx`, `copilot-language.ts`, `usePosAiVisitorAnalytics.ts`, `usePosPanorama.ts`, `Checklist Público (Comercial)`, `pos-chat-history-sidebar.test.tsx`, `usePosAiVisitorAnalytics.ts`, `cs-cx-user-matching.mjs`, `🗄️ Configuração Local do Supabase (Ambiente de Desenvolvimento)`, `useCsCxAccess.ts`, `useConversionEngines.ts`, `SimpleMarkdown.tsx`, `OverviewChart.tsx`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `err()` connect `Checklist Público (Comercial)` to `Conversion Post Feed & Drawer`, `VM Worker Job Queue`, `FormRenderer.tsx`, `Project Stage Forms & Models`, `Adherence Form Renderer`, `Deployment Form Fields`, `Commercial/Public Checklists`, `PipelineStatus.tsx`, `chamadosSync.ts`, `usePublicChecklist.ts`, `Improve-Text AI Jobs`, `Login`, `ProjectAdherenceForm.tsx`, `index.ts`, `usePosAiVisitorAnalytics.ts`, `cs-cx-nps-public.test.ts`, `usePosAiVisitorAnalytics.ts`, `🗄️ Configuração Local do Supabase (Ambiente de Desenvolvimento)`, `useConversionEngines.ts`, `pos-chat-visitor-dialog.test.tsx`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `supabase` connect `Project Stage Forms & Models` to `FormRenderer.tsx`, `filterStore.ts`, `Notification Bell & Dropdown`, `Charts, KPI & Reports`, `GEMINI.md`, `Adherence Form Renderer`, `Calendar Grid & Drag-Drop`, `Commercial & Conversion Hooks`, `Distribution/Workload Charts`, `Deployment Form Fields`, `Project Modal & Kanban`, `Commercial/Public Checklists`, `Commercial Page & Hooks`, `Main Layout & Theme Toggle`, `Post Observations Editor`, `sd-solutions.ts`, `ProtectedRoute.tsx`, `Roadmap Page`, `Theme Provider`, `TicketsAiAnalysis.tsx`, `usePublicChecklist.ts`, `ProtectedRoute.tsx`, `useCsCxCore.ts`, `CsCxReports.tsx`, `ProjectAdherenceForm.tsx`, `usePosAiAdminAnalytics.ts`, `useCsCxExperience.ts`, `PublicNpsResponse.tsx`, `chamados-catalog.ts`, `3. Dashboard — Modelos Editor`, `CsCxNps`, `Módulo Comercial — Documentação por Tela`, `cs-cx-nps-public.test.ts`, `Checklist Público (Comercial)`, `pos-chat-visitor-dialog.test.tsx`, `PublicNpsResponse.tsx`, `usePosAiVisitorAnalytics.ts`, `🗄️ Configuração Local do Supabase (Ambiente de Desenvolvimento)`, `useConversionEngines.ts`, `SimpleMarkdown.tsx`, `Página 404 (Not Found)`, `OverviewChart.tsx`?**
